...
- [GitHub](https://github.com/jupyter/notebook) (👨‍💻 670 · 🔀 5.7K · 📦 380K):
	...
	```
- [PyPi](https://pypi.org/project/notebook) (📥 35M / month · 📦 3.8K · ⏱️ 11.08.2026):
	```
	pip install notebook
	```
- [Conda](https://anaconda.org/conda-forge/jupyter) (📥 7.4M · ⏱️ 22.04.2025):
	```
...
- [GitHub](https://github.com/jupyterlab/jupyterlab) (👨‍💻 730 · 🔀 4.1K · 📦 22K):

	```
	git clone https://github.com/jupyterlab/jupyterlab
	```
- [PyPi](https://pypi.org/project/jupyterlab) (📥 35M / month · 📦 5.1K · ⏱️ 10.08.2026):
	```
	pip install jupyterlab
	```
- [Conda](https://anaconda.org/conda-forge/jupyterlab) (📥 25M · ⏱️ 10.08.2026):
	```
	conda install -c conda-forge jupyterlab
	```
- [npm](https://www.npmjs.com/package/@jupyterlab/ui-components) (📥 270K / month · 📦 530 · ⏱️ 10.08.2026):
	```
...
- [GitHub](https://github.com/jupyterhub/jupyterhub) (👨‍💻 400 · 🔀 2.1K · 📦 3.7K):
	...
	```
- [PyPi](https://pypi.org/project/jupyterhub) (📥 270K / month · 📦 260 · ⏱️ 14.09.2026):
	```
	pip install jupyterhub
	```
- [Conda](https://anaconda.org/conda-forge/jupyterhub) (📥 1.8M · ⏱️ 14.09.2026):
	```
	conda install -c conda-forge jupyterhub
	```
- [Docker Hub](https://hub.docker.com/r/jupyterhub/jupyterhub) (📥 7.1M · ⭐ 350 · ⏱️ 17.09.2026):
	```
	docker pull jupyterhub/jupyterhub
	```
</details>
<details><summary><b><a href="https://github.com/vatlab/SOS">sos</a></b> (🥈22 ·  ⭐ 290) - SoS workflow system for daily data analysis. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/vatlab/SOS) (👨‍💻 36 · 🔀 44 · 📦 7.8K):

	```
	git clone https://github.com/vatlab/SOS
	```
- [PyPi](https://pypi.org/project/sos-notebook) (📥 940 / month · 📦 33 · ⏱️ 26.03.2026):
	```
	pip install sos-notebook
	```
- [Conda](https://anaconda.org/conda-forge/sos) (📥 270K · ⏱️ 09.09.2026):
	```
...
- [GitHub](https://github.com/nteract/nteract) (👨‍💻 65 · 🔀 550):
...
- [PyPi](https://pypi.org/project/nteract_on_jupyter) (📥 610 / month · ⏱️ 16.07.2019):
	...
	```
- [npm](https://www.npmjs.com/package/@nteract/messaging) (📥 34K / month · 📦 31 · ⏱️ 22.10.2021):
	```
...
- [GitHub](https://github.com/microsoft/vscode-jupyter) (👨‍💻 290 · 🔀 350 · 📦 3):
	...
	```
- [Conda](https://anaconda.org/conda-forge/vscode-jupyter) (📥 200K · ⏱️ 22.04.2025):
	```
...
- [GitHub](https://github.com/nteract/hydrogen) (👨‍💻 90 · 🔀 340):
...
- <b><a href="https://github.com/jupyter/docker-stacks">Docker Stacks</a></b> (🥈23 ·  ⭐ 8.8K · 💀) - Ready-to-run Docker images containing Jupyter applications. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code>
...
- <b><a href="https://github.com/jupyter-server/jupyverse">jupyverse</a></b> (🥉17 ·  ⭐ 300) - Modern Jupyter server based on FastAPI. <code>❗Unlicensed</code>
...
- [GitHub](https://github.com/bokeh/bokeh) (👨‍💻 740 · 🔀 4.3K · 📦 110K):

	```
	git clone https://github.com/bokeh/bokeh
	```
- [PyPi](https://pypi.org/project/bokeh) (📥 5.9M / month · 📦 2.6K · ⏱️ 08.09.2026):
	```
	pip install bokeh
	```
- [Conda](https://anaconda.org/conda-forge/bokeh) (📥 21M · ⏱️ 19.08.2026):
	...
	```
- [npm](https://www.npmjs.com/package/@bokeh/bokehjs) (📥 38K / month · 📦 23 · ⏱️ 08.09.2026):
	```
...
- [GitHub](https://github.com/jupyter-widgets/ipywidgets) (👨‍💻 230 · 🔀 970 · 📦 3):
	...
	```
- [PyPi](https://pypi.org/project/ipywidgets) (📥 33M / month · 📦 7.7K · ⏱️ 18.08.2026):
	```
...
- [Conda](https://anaconda.org/conda-forge/ipywidgets) (📥 26M · ⏱️ 18.08.2026):
	...
	```
- [npm](https://www.npmjs.com/package/@jupyter-widgets/jupyterlab-manager) (📥 73K / month · 📦 130 · ⏱️ 18.08.2026):
	```
...
- [GitHub](https://github.com/evidentlyai/evidently) (👨‍💻 97 · 🔀 920 · 📦 7.1K):

	```
	git clone https://github.com/evidentlyai/evidently
	```
- [PyPi](https://pypi.org/project/evidently) (📥 940K / month · 📦 59 · ⏱️ 11.09.2026):
	```
	pip install evidently
	```
- [Conda](https://anaconda.org/conda-forge/evidently) (📥 190K · ⏱️ 10.03.2026):
	```
...
- [GitHub](https://github.com/nteract/papermill) (👨‍💻 130 · 🔀 450 · 📦 8.4K):

	```
	git clone https://github.com/nteract/papermill
	```
- [PyPi](https://pypi.org/project/papermill) (📥 14M / month · 📦 480 · ⏱️ 27.02.2026):
	```
...
<details><summary><b><a href="https://github.com/holoviz/panel">panel</a></b> (🥇27 ·  ⭐ 5.8K · 📉) - Panel: The powerful data exploration & web app framework for Python. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/holoviz/panel) (👨‍💻 270 · 🔀 620):
...
- [Conda](https://anaconda.org/conda-forge/panel) (📥 3M · ⏱️ 18.08.2026):
	...
	```
- [npm](https://www.npmjs.com/package/@holoviz/panel) (📥 8.6K / month · 📦 5 · ⏱️ 26.08.2026):
	```
...
- [GitHub](https://github.com/matplotlib/ipympl) (👨‍💻 38 · 🔀 230 · 📦 16K):

	```
	git clone https://github.com/matplotlib/ipympl
	```
- [PyPi](https://pypi.org/project/ipympl) (📥 900K / month · 📦 660 · ⏱️ 21.01.2026):
	```
	pip install ipympl
	```
- [Conda](https://anaconda.org/conda-forge/ipympl) (📥 2.9M · ⏱️ 24.01.2026):
	```
...
<details><summary><b><a href="https://github.com/bqplot/bqplot">bqplot</a></b> (🥈25 ·  ⭐ 3.7K) - Plotting library for IPython/Jupyter notebooks. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>
...
- [GitHub](https://github.com/bqplot/bqplot) (👨‍💻 71 · 🔀 480 · 📦 65):
	...
	```
- [PyPi](https://pypi.org/project/bqplot) (📥 230K / month · 📦 120 · ⏱️ 07.05.2026):
	```
	pip install bqplot
	```
- [Conda](https://anaconda.org/conda-forge/bqplot) (📥 3.5M · ⏱️ 07.05.2026):
	```
	conda install -c conda-forge bqplot
	```
- [npm](https://www.npmjs.com/package/bqplot) (📥 2.2K / month · 📦 23 · ⏱️ 15.07.2026):
	```
	npm install bqplot
	```
</details>
<details><summary><b><a href="https://github.com/timkpaine/ipydagred3">ipydagred3</a></b> (🥈23 ·  ⭐ 3.3K) - ipywidgets library for drawing directed acyclic graphs in.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/timkpaine/ipydagred3) (👨‍💻 4 · 🔀 970 · 📦 3):

	```
	git clone https://github.com/timkpaine/ipydagred3
	```
- [PyPi](https://pypi.org/project/ipydagred3) (📥 320K / month · 📦 6 · ⏱️ 31.10.2023):
	```
	pip install ipydagred3
	```
- [Conda](https://anaconda.org/conda-forge/ipydagred3) (📥 73K · ⏱️ 01.09.2026):
	```
...
- [GitHub]() (👨‍💻 7 · 🔀 970 · 📦 15):
	...
	```
- [PyPi](https://pypi.org/project/ipyregulartable) (📥 67 / month · 📦 2 · ⏱️ 08.01.2021):
	```
...
<details><summary><b><a href="https://github.com/mwouts/itables">itables</a></b> (🥈22 ·  ⭐ 980 · 📉) - Python DataFrames as Interactive DataTables. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/mwouts/itables) (👨‍💻 25 · 🔀 62 · 📦 1.6K):

	```
	git clone https://github.com/mwouts/itables
	```
- [PyPi](https://pypi.org/project/itables) (📦 140 · ⏱️ 22.07.2026):
	```
	pip install itables
	```
- [Conda](https://anaconda.org/conda-forge/itables) (📥 380K · ⏱️ 24.07.2026):
	```
	conda install -c conda-forge itables
	```
</details>
<details><summary><b><a href="https://github.com/widgetti/ipyvuetify">ipyvuetify</a></b> (🥈22 ·  ⭐ 360) - Jupyter widgets based on vuetify UI components. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub]() (👨‍💻 14 · 🔀 61 · 📦 1.9K):
	...
	```
- [PyPi](https://pypi.org/project/ipyvuetify) (📥 180K / month · 📦 120 · ⏱️ 12.08.2026):
	```
	pip install ipyvuetify
	```
- [Conda](https://anaconda.org/conda-forge/ipyvuetify) (📥 390K · ⏱️ 13.08.2026):
	```
	conda install -c conda-forge ipyvuetify
	```
- [npm](https://www.npmjs.com/package/jupyter-vuetify) (📥 4.2K / month · 📦 6 · ⏱️ 12.08.2026):
	```
...
- [GitHub]() (👨‍💻 45 · 🔀 230 · 📦 18):
	...
	```
- [PyPi](https://pypi.org/project/ipyvolume) (📥 27K / month · 📦 56 · ⏱️ 02.06.2023):
	```
...
- [Conda](https://anaconda.org/conda-forge/ipyvolume) (📥 1.2M · ⏱️ 24.11.2025):
	...
	```
- [npm](https://www.npmjs.com/package/ipyvolume) (📥 510 / month · 📦 6 · ⏱️ 02.06.2023):
	```
	npm install ipyvolume
	```
</details>
<details><summary><b><a href="https://github.com/nglviewer/nglview">nglview</a></b> (🥈20 ·  ⭐ 910 · 💤) - Jupyter widget to interactively view molecular structures and.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/nglviewer/nglview) (👨‍💻 40 · 🔀 140):
	...
	```
- [PyPi](https://pypi.org/project/nglview) (📥 57K / month · 📦 120 · ⏱️ 02.02.2026):
	```
	pip install nglview
	```
- [Conda](https://anaconda.org/conda-forge/nglview) (📥 1.9M · ⏱️ 06.02.2026):
	```
...
- [PyPi](https://pypi.org/project/ipycanvas) (📥 110K / month · 📦 92 · ⏱️ 11.12.2025):
	...
	```
- [Conda](https://anaconda.org/conda-forge/ipycanvas) (📥 310K · ⏱️ 01.07.2026):
	```
	conda install -c conda-forge ipycanvas
	```
- [npm](https://www.npmjs.com/package/ipycanvas) (📥 260 / month · 📦 7 · ⏱️ 11.12.2025):
	```
	npm install ipycanvas
	```
</details>
<details><summary><b><a href="https://github.com/nicolaskruchten/jupyter_pivottablejs">pivottablejs</a></b> (🥈20 ·  ⭐ 690) - Dragndrop Pivot Tables and Charts for Jupyter/IPython Notebook,.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/nicolaskruchten/jupyter_pivottablejs) (👨‍💻 3 · 🔀 88 · 📦 550):
	...
	```
- [PyPi](https://pypi.org/project/pivottablejs) (📥 19K / month · 📦 10 · ⏱️ 15.01.2018):
	```
...
- [GitHub](https://github.com/InsightSoftwareConsortium/itkwidgets) (👨‍💻 27 · 🔀 84 · 📦 400):
	...
	```
- [PyPi](https://pypi.org/project/itkwidgets) (📥 7.1K / month · 📦 32 · ⏱️ 07.02.2025):
	```
	pip install itkwidgets
	```
- [Conda](https://anaconda.org/conda-forge/itkwidgets) (📥 640K · ⏱️ 22.04.2025):
	```
	conda install -c conda-forge itkwidgets
	```
- [npm](https://www.npmjs.com/package/itkwidgets) (📥 48 / month · 📦 5 · ⏱️ 02.03.2023):
	```
...
- [GitHub]() (👨‍💻 7 · 🔀 18 · 📦 1.5K):
	...
	```
- [PyPi](https://pypi.org/project/ipyvue) (📥 200K / month · 📦 43 · ⏱️ 11.08.2026):
	```
	pip install ipyvue
	```
- [Conda](https://anaconda.org/conda-forge/ipyvue) (📥 330K · ⏱️ 13.08.2026):
	```
	conda install -c conda-forge ipyvue
	```
- [npm](https://www.npmjs.com/package/jupyter-vue) (📥 3.6K / month · 📦 16 · ⏱️ 11.08.2026):
	```
...
- [GitHub](https://github.com/microsoft/responsible-ai-toolbox) (👨‍💻 47 · 🔀 490):

	```
	git clone https://github.com/microsoft/responsible-ai-toolbox
	```
- [PyPi](https://pypi.org/project/raiwidgets) (📥 3.8K / month · 📦 6 · ⏱️ 08.07.2024):
	```
	pip install raiwidgets
	```
</details>
<details><summary><b><a href="https://github.com/timkpaine/tributary">tributary</a></b> (🥉18 ·  ⭐ 440) - Streaming reactive and dataflow graphs in Python. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/timkpaine/tributary) (👨‍💻 7 · 🔀 37 · 📦 71):
...
- [PyPi](https://pypi.org/project/tributary) (⏱️ 10.05.2023):
	...
	```
- [Conda](https://anaconda.org/conda-forge/tributary) (📥 100K · ⏱️ 01.09.2026):
	```
...
- [GitHub](https://github.com/vega/ipyvega) (👨‍💻 15 · 🔀 67):
...
- [PyPi](https://pypi.org/project/vega) (📥 53K / month · 📦 17 · ⏱️ 25.09.2024):
	...
	pip install vega
	```
- [Conda](https://anaconda.org/conda-forge/vega) (📥 1.7M · ⏱️ 04.10.2025):
	```
...
- [GitHub]() (👨‍💻 6 · 🔀 25 · 📦 92):
	...
	```
- [PyPi](https://pypi.org/project/ipysigma) (📥 76K / month · 📦 4 · ⏱️ 25.11.2025):
	```
...
<details><summary><b><a href="https://github.com/spacetelescope/jdaviz">jdaviz</a></b> (🥉17 ·  ⭐ 170 · 📉) - Interactive data visualization and analysis tools for astronomical.. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
- [GitHub](https://github.com/spacetelescope/jdaviz) (👨‍💻 45 · 🔀 91 · 📦 75):
	...
	```
- [PyPi](https://pypi.org/project/jdaviz) (📦 11 · ⏱️ 21.07.2026):
	```
	pip install jdaviz
	```
</details>
...
- <b><a href="https://github.com/man-group/dtale">D-Tale</a></b> (🥈24 ·  ⭐ 5.2K) - Visualizer for Pandas Data Structures. <code><a href="https://tldrlegal.com/search?q=LGPL-2.1">❗️LGPL-2.1</a></code>
...
- <b><a href="https://github.com/cytoscape/ipycytoscape">ipycytoscape</a></b> (🥈20 ·  ⭐ 280 · 💀) - A Cytoscape Jupyter widget. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code>
...
- <b><a href="https://github.com/jupyter-widgets/ipydatagrid">ipydatagrid</a></b> (🥉19 ·  ⭐ 600 · 💀) - Fast Datagrid widget for the Jupyter Notebook and JupyterLab. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code>
...
- <b><a href="https://github.com/mapbox/mapboxgl-jupyter">Mapbox GL</a></b> (🥉17 ·  ⭐ 680 · 💀) - Use Mapbox GL JS to visualize data in a Python Jupyter notebook. <code><a href="http://bit.ly/34MBwT8">MIT</a></code>
...
- <b><a href="https://github.com/nipy/niwidgets">niwidgets</a></b> (🥉13 ·  ⭐ 87 · 💀) - Neuroimaging widgets for jupyter notebooks. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code>
...
- <b><a href="https://github.com/OpenGeoscience/geonotebook">geonotebook</a></b> (🥉12 ·  ⭐ 1.1K · 💀) - A Jupyter notebook extension for geospatial visualization.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code>
...
- [GitHub](https://github.com/jupyterhub/jupyter-server-proxy) (👨‍💻 82 · 🔀 150 · 📦 5):
	...
	```
- [PyPi](https://pypi.org/project/jupyter-server-proxy) (📥 460K / month · 📦 240 · ⏱️ 01.04.2026):
	```
	pip install jupyter-server-proxy
	```
- [Conda](https://anaconda.org/conda-forge/jupyter-server-proxy) (📥 2.2M · ⏱️ 09.04.2026):
	```
	conda install -c conda-forge jupyter-server-proxy
	```
- [npm](https://www.npmjs.com/package/@jupyterlab/server-proxy) (📥 420 / month · 📦 9 · ⏱️ 11.06.2024):
	```
...
- [GitHub](https://github.com/jupyter-server/jupyter-resource-usage) (👨‍💻 38 · 🔀 110 · 📦 1K):
	...
	```
- [PyPi](https://pypi.org/project/jupyter-resource-usage) (📥 48K / month · 📦 28 · ⏱️ 11.08.2026):
	```
...
- [Conda](https://anaconda.org/conda-forge/nbresuse) (📥 590K · ⏱️ 22.04.2025):
	...
	```
- [npm](https://www.npmjs.com/package/@jupyter-server/resource-usage) (📥 2.3K / month · 📦 6 · ⏱️ 11.08.2026):
	```
...
- [GitHub](https://github.com/oschuett/appmode) (👨‍💻 11 · 🔀 70 · 📦 390):
	...
	```
- [PyPi](https://pypi.org/project/appmode) (📥 990 / month · 📦 8 · ⏱️ 27.07.2026):
	```
	pip install appmode
	```
- [Conda](https://anaconda.org/conda-forge/appmode) (📥 610K · ⏱️ 27.07.2026):
	```
	conda install -c conda-forge appmode
	```
</details>
<details><summary><b><a href="https://github.com/jupyterhub/nbgitpuller">nbgitpuller</a></b> (🥈20 ·  ⭐ 230) - Jupyter server extension to sync a git repository one-way to a.. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
- [GitHub](https://github.com/jupyterhub/nbgitpuller) (👨‍💻 36 · 🔀 84 · 📦 1K):
	...
	```
- [PyPi](https://pypi.org/project/nbgitpuller) (📦 10 · ⏱️ 31.03.2026):
	```
	pip install nbgitpuller
	```
- [Conda](https://anaconda.org/conda-forge/nbgitpuller) (📥 150K · ⏱️ 31.03.2026):
	```
	conda install -c conda-forge nbgitpuller
	```
</details>
<details><summary><b><a href="https://github.com/jupyterlab-contrib/jupyter-archive">jupyter-archive</a></b> (🥈20 ·  ⭐ 90) - A Jupyter/Jupyterlab extension to make, download and extract.. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/jupyterlab-contrib/jupyter-archive) (👨‍💻 13 · 🔀 17 · 📦 390):
...
- [PyPi](https://pypi.org/project/jupyter-archive) (📥 170K / month · 📦 7 · ⏱️ 30.07.2026):
	...
	```
- [Conda](https://anaconda.org/conda-forge/jupyter-archive) (📥 120K · ⏱️ 31.07.2026):
	```
	conda install -c conda-forge jupyter-archive
	```
- [npm](https://www.npmjs.com/package/@hadim/jupyter-archive) (📥 78 / month · 📦 5 · ⏱️ 30.07.2026):
	```
...
- [GitHub](https://github.com/jupyterhub/jupyter-rsession-proxy) (👨‍💻 32 · 🔀 85 · 📦 67):
	...
	```
- [PyPi](https://pypi.org/project/jupyter-rsession-proxy) (📥 6.1K / month · 📦 2 · ⏱️ 12.05.2026):
	```
	pip install jupyter-rsession-proxy
	```
- [Conda](https://anaconda.org/conda-forge/jupyter-rsession-proxy) (📥 51K · ⏱️ 13.05.2026):
	```
...
- [GitHub](https://github.com/mamba-org/gator) (👨‍💻 32 · 🔀 37 · 📦 5):

	```
	git clone https://github.com/mamba-org/gator
	```
- [PyPi](https://pypi.org/project/mamba-gator) (⏱️ 08.04.2026):
	```
	pip install mamba-gator
	```
- [Conda](https://anaconda.org/conda-forge/mamba_gator) (📥 78K · ⏱️ 12.04.2026):
	```
...
- <b><a href="https://github.com/ipython-contrib/jupyter_contrib_nbextensions">Contrib NBextensions</a></b> (🥇23 ·  ⭐ 5.3K · 💀) - A collection of various notebook extensions for.. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code>
...
- <b><a href="https://github.com/jupyter/nbgrader">nbgrader</a></b> (🥈19 ·  ⭐ 1.4K · 💀) - A system for assigning and grading notebooks. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code>
...
- <b><a href="https://github.com/jupyter-incubator/contentmanagement">Content Management</a></b> (🥉13 ·  ⭐ 78 · 💀) - Jupyter Content Management Extensions. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code>
...
- [GitHub](https://github.com/catherinedevlin/ipython-sql) (👨‍💻 55 · 🔀 370 · 📦 11K):

	```
	git clone https://github.com/catherinedevlin/ipython-sql
	```
- [PyPi](https://pypi.org/project/ipython-sql) (📥 280K / month · 📦 12 · ⏱️ 27.02.2023):
	```
	pip install ipython-sql
	```
- [Conda](https://anaconda.org/conda-forge/ipython-sql) (📥 590K · ⏱️ 12.09.2026):
	```
...
- [PyPi](https://pypi.org/project/watermark) (📥 80K / month · 📦 110 · ⏱️ 21.12.2025):
	...
	```
- [Conda](https://anaconda.org/conda-forge/watermark) (📥 790K · ⏱️ 25.01.2026):
	```
	conda install -c conda-forge watermark
	```
</details>
<details><summary><b><a href="https://github.com/jupyter-incubator/sparkmagic">sparkmagic</a></b> (🥈21 ·  ⭐ 1.4K · 💤) - Jupyter magics and kernels for working with remote Spark.. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/jupyter-incubator/sparkmagic) (👨‍💻 73 · 🔀 440 · 📦 400):
...
- [PyPi](https://pypi.org/project/sparkmagic) (📦 10 · ⏱️ 07.07.2025):
	...
	```
- [Conda](https://anaconda.org/conda-forge/sparkmagic) (📥 290K · ⏱️ 28.05.2025):
	```
	conda install -c conda-forge sparkmagic
	```
</details>
<details><summary><b><a href="https://github.com/nteract/pick">pick</a></b> (🥈20 ·  ⭐ 790 · 💤) - Customize your kernels on Launch!. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
- [GitHub](https://github.com/nteract/pick) (👨‍💻 5 · 🔀 63):
	...
	```
- [PyPi](https://pypi.org/project/pick) (📥 380K / month · 📦 250 · ⏱️ 28.02.2026):
	```
	pip install pick
	```
</details>
...
- <b><a href="https://github.com/csurfer/pyheatmagic">heat</a></b> (🥉16 ·  ⭐ 680 · 💀) - IPython magic command to profile and view your python code as a heat map. <code><a href="http://bit.ly/34MBwT8">MIT</a></code>
- <b><a href="https://github.com/csurfer/blackcellmagic">blackcellmagic</a></b> (🥉16 ·  ⭐ 270 · 💀) - IPython magic command to format python code in cell using.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code>
...
- [GitHub](https://github.com/ipython/ipykernel) (👨‍💻 200 · 🔀 400 · 📦 550K):
	...
	```
- [PyPi](https://pypi.org/project/ipykernel) (📥 56M / month · 📦 9.1K · ⏱️ 10.06.2026):
	```
	pip install ipykernel
	```
- [Conda](https://anaconda.org/anaconda/ipykernel) (📥 1.1M · 📦 83 · ⏱️ 14.09.2026):
	```
...
- [GitHub](https://github.com/Calysto/metakernel) (👨‍💻 38 · 🔀 92 · 📦 1.1K):

	```
	git clone https://github.com/Calysto/metakernel
	```
- [PyPi](https://pypi.org/project/metakernel) (📥 78K / month · 📦 65 · ⏱️ 17.08.2026):
	```
	pip install metakernel
	```
- [Conda](https://anaconda.org/conda-forge/metakernel) (📥 2.8M · ⏱️ 17.08.2026):
	```
	conda install -c conda-forge metakernel
	```
</details>
<details><summary><b><a href="https://github.com/dotnet/interactive">.NET Interactive</a></b> (🥇22 ·  ⭐ 3.2K) - .NET Interactive combines the power of .NET with many other.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/dotnet/interactive) (👨‍💻 150 · 🔀 460 · 📥 540 · 📋 1.8K - 31% open · ⏱️ 16.04.2026):
...
- [GitHub](https://github.com/calysto/octave_kernel) (👨‍💻 28 · 🔀 65 · 📦 120):

	```
	git clone https://github.com/calysto/octave_kernel
	```
- [PyPi](https://pypi.org/project/octave_kernel) (📥 60K / month · 📦 5 · ⏱️ 17.08.2026):
	```
	pip install octave_kernel
	```
- [Conda](https://anaconda.org/conda-forge/octave_kernel) (📥 2M · ⏱️ 18.08.2026):
	```
...
- [PyPi](https://pypi.org/project/lfortran) (📥 510 / month · ⏱️ 31.07.2020):
	...
	```
- [Conda](https://anaconda.org/conda-forge/lfortran) (📥 410K · ⏱️ 14.09.2026):
	```
...
- [GitHub](https://github.com/jupyter-xeus/xeus-python) (👨‍💻 27 · 🔀 79):
	...
	```
- [PyPi](https://pypi.org/project/xeus-python) (📥 2.5K / month · 📦 11 · ⏱️ 07.07.2026):
	```
	pip install xeus-python
	```
- [Conda](https://anaconda.org/conda-forge/xeus-python) (📥 2.6M · ⏱️ 14.08.2026):
	```
	conda install -c conda-forge xeus-python
	```
</details>
<details><summary><b><a href="https://github.com/gopherdata/gophernotes">gophernotes</a></b> (🥈18 ·  ⭐ 4K · 📈) - The Go kernel for Jupyter notebooks and nteract. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/gopherdata/gophernotes) (👨‍💻 29 · 🔀 260 · 📦 21):
...
- [Docker Hub](https://hub.docker.com/r/gopherdata/gophernotes) (📥 92K · ⭐ 7 · ⏱️ 22.12.2018):
	...
	```
- [Go](https://pkg.go.dev/github.com/gopherdata/gophernotes) (📦 4 · ⏱️ 09.09.2026):
	```
...
- [GitHub](https://github.com/almond-sh/almond) (👨‍💻 44 · 🔀 250):

	```
	git clone https://github.com/almond-sh/almond
	```
- [Docker Hub](https://hub.docker.com/r/almondsh/almond) (📥 30K · ⭐ 6 · ⏱️ 25.02.2025):
	```
...
- [GitHub](https://github.com/evcxr/evcxr) (👨‍💻 59 · 🔀 240 · 📦 180):
...
- [GitHub](https://github.com/SciRuby/iruby) (👨‍💻 55 · 🔀 34 · 📦 900):

	```
	git clone https://github.com/SciRuby/iruby
	```
- [Docker Hub](https://hub.docker.com/r/rubydata/datascience-notebook) (📥 4.3K · ⭐ 5 · ⏱️ 03.02.2023):
	```
...
- [GitHub](https://github.com/calysto/matlab_kernel) (👨‍💻 18 · 🔀 75):
	...
	```
- [PyPi](https://pypi.org/project/matlab_kernel) (📥 1.3K / month · 📦 5 · ⏱️ 20.04.2017):
	```
...
<details><summary><b><a href="https://github.com/sassoftware/sas_kernel">SAS Kernel</a></b> (🥉15 ·  ⭐ 200) - A Jupyter kernel for SAS. This opens up all the data manipulation.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/sassoftware/sas_kernel) (👨‍💻 12 · 🔀 82):

	```
	git clone https://github.com/sassoftware/sas_kernel
	```
- [PyPi](https://pypi.org/project/sas_kernel) (📥 5.8K / month · 📦 2 · ⏱️ 01.12.2022):
	```
	pip install sas_kernel
	```
- [Conda](https://anaconda.org/anaconda/sas_kernel) (📥 4.6K · ⏱️ 01.09.2026):
	```
...
- [GitHub](https://github.com/jupyter-xeus/xeus-sqlite) (👨‍💻 17 · 🔀 27):
	...
	```
- [Conda](https://anaconda.org/conda-forge/xeus-sqlite) (📥 99K · ⏱️ 09.03.2026):
	```
...
- [GitHub](https://github.com/hugetim/nbstata) (👨‍💻 2 · 🔀 7 · 📦 7):

	```
	git clone https://github.com/hugetim/nbstata
	```
- [PyPi](https://pypi.org/project/nbstata) (📥 510 / month · ⏱️ 22.01.2026):
	```
	pip install nbstata
	```
</details>
...
- <b><a href="https://github.com/xonsh/xonsh">xonsh</a></b> (🥇27 ·  ⭐ 9.6K) - Python-powered shell. Full-featured, cross-platform and AI-friendly. <code><a href="https://github.com/xonsh/xonsh/blob/main/license">❗️Custom</a></code>
...
- <b><a href="http://github.com/jupyter/enterprise_gateway">Enterprise Gateway</a></b> (🥉15 ·  ⭐ 670) - A web server for spawning and communicating with.. <code>❗Unlicensed</code>
...
- <b><a href="https://github.com/Cadair/jupyter_environment_kernels">Kernel Detection</a></b> (🥉14 ·  ⭐ 150 · 💀) - An Jupyter plugin to enable the automatic detection of.. <code><a href="http://bit.ly/3rqEWVr">BSD-2</a></code>
- <b><a href="https://github.com/gibiansky/IHaskell/">IHaskell</a></b> (🥉13 ·  ⭐ 2.6K · 💀) - adds ihaskell syntax highlighting to jupyterlab. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code>
...
- <b><a href="https://github.com/WolframResearch/WolframLanguageForJupyter">Wolfram Kernel</a></b> (🥉10 ·  ⭐ 1.2K · 💀) - Wolfram Language kernel for Jupyter notebooks. <code><a href="http://bit.ly/34MBwT8">MIT</a></code>
...
- <b><a href="https://github.com/nteract/kernel-relay">kernel-relay</a></b> (🥉5 ·  ⭐ 12 · 💀) - kernel-relay is a GraphQL service for interfacing with.. <code>❗Unlicensed</code>
</details>
<br>
...
- [GitHub](https://github.com/jupyter/nbconvert) (👨‍💻 290 · 🔀 610 · 📦 380K):
	...
	```
- [PyPi](https://pypi.org/project/nbconvert) (📥 51M / month · 📦 3.3K · ⏱️ 08.04.2026):
	```
	pip install nbconvert
	```
- [Conda](https://anaconda.org/conda-forge/nbconvert) (📥 25M · ⏱️ 08.04.2026):
	```
	conda install -c conda-forge nbconvert
	```
</details>
<details><summary><b><a href="https://github.com/jupytext/jupytext">Jupytext</a></b> (🥇27 ·  ⭐ 7.2K) - Jupyter notebooks as Markdown documents, Julia, Python or R scripts. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub]() (👨‍💻 110 · 🔀 420 · 📦 13K):
	...
	```
- [PyPi](https://pypi.org/project/jupytext) (📥 2.9M / month · 📦 1.1K · ⏱️ 21.07.2026):
	```
...
- [Conda](https://anaconda.org/conda-forge/jupytext) (📥 1.7M · ⏱️ 22.07.2026):
	...
	```
- [npm](https://www.npmjs.com/package/jupyterlab-jupytext) (📥 770 / month · 📦 5 · ⏱️ 05.05.2024):
	```
...
- [GitHub](https://github.com/voila-dashboards/voila) (👨‍💻 77 · 🔀 530 · 📦 13K):

	```
	git clone https://github.com/voila-dashboards/voila
	```
- [PyPi](https://pypi.org/project/voila) (📥 100K / month · 📦 180 · ⏱️ 04.09.2026):
	```
	pip install voila
	```
- [Conda](https://anaconda.org/conda-forge/voila) (📥 620K · ⏱️ 04.09.2026):
	```
	conda install -c conda-forge voila
	```
- [npm](https://www.npmjs.com/package/@jupyter-voila/jupyterlab-preview) (📥 41 / month · 📦 5 · ⏱️ 19.05.2020):
	```
...
- [GitHub]() (👨‍💻 26 · 🔀 730 · 📦 19K):
	...
	```
- [PyPi](https://pypi.org/project/jupyter-book) (📥 210K / month · 📦 650 · ⏱️ 05.07.2026):
	```
	pip install jupyter-book
	```
- [Conda](https://anaconda.org/conda-forge/jupyter-book) (📥 340K · ⏱️ 06.07.2026):
	```
...
- [GitHub](https://github.com/jupyter/nbdime) (👨‍💻 57 · 🔀 180 · 📦 13K):
	...
	```
- [PyPi](https://pypi.org/project/nbdime) (📥 190K / month · 📦 120 · ⏱️ 10.02.2026):
	```
	pip install nbdime
	```
- [Conda](https://anaconda.org/conda-forge/nbdime) (📥 2M · ⏱️ 10.02.2026):
	```
	conda install -c conda-forge nbdime
	```
- [npm](https://www.npmjs.com/package/nbdime-jupyterlab) (📥 6.7K / month · 📦 12 · ⏱️ 10.02.2026):
	```
...
- [GitHub](https://github.com/danielfrg/mkdocs-jupyter) (👨‍💻 39 · 🔀 65 · 📦 5.4K):

	```
	git clone https://github.com/danielfrg/mkdocs-jupyter
	```
- [PyPi](https://pypi.org/project/mkdocs-jupyter) (📥 340K / month · 📦 1.1K · ⏱️ 17.04.2026):
	```
	pip install mkdocs-jupyter
	```
- [Conda](https://anaconda.org/conda-forge/mkdocs-jupyter) (📥 190K · ⏱️ 10.09.2026):
	```
...
- [GitHub](https://github.com/damianavila/RISE) (👨‍💻 44 · 🔀 420 · 📦 3.1K):
	...
	```
- [PyPi](https://pypi.org/project/RISE) (📥 6.1K / month · 📦 31 · ⏱️ 03.11.2022):
	```
	pip install RISE
	```
- [Conda](https://anaconda.org/conda-forge/rise) (📥 530K · ⏱️ 27.10.2025):
	```
	conda install -c conda-forge rise
	```
- [npm](https://www.npmjs.com/package/rise-reveal) (📥 35 / month · 📦 3 · ⏱️ 03.07.2019):
	```
...
- [GitHub](https://github.com/jupyter/nbviewer) (👨‍💻 100 · 🔀 560 · 📦 28):

	```
	git clone https://github.com/jupyter/nbviewer
	```
- [Docker Hub](https://hub.docker.com/r/jupyter/nbviewer) (📥 2.8M · ⭐ 34 · ⏱️ 04.09.2026):
	```
...
- [GitHub](https://github.com/stencila/stencila) (👨‍💻 52 · 🔀 58 · 📦 20):
...
- [npm](https://www.npmjs.com/package/stencila) (📥 140 / month · 📦 9 · ⏱️ 06.11.2020):
	...
	```
- [Docker Hub](https://hub.docker.com/r/stencila/cloud) (📥 18K · ⏱️ 08.04.2019):
	```
...
- [GitHub](https://github.com/jupyterhub/binderhub) (👨‍💻 100 · 🔀 400 · 📦 12):
	...
	```
- [PyPi](https://pypi.org/project/binderhub) (📥 65 / month · ⏱️ 07.11.2018):
	```
	pip install binderhub
	```
</details>
<details><summary><b><a href="https://github.com/nteract/commuter">commuter</a></b> (🥉14 ·  ⭐ 500) - Notebook sharing hub. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
- [GitHub](https://github.com/nteract/commuter) (👨‍💻 29 · 🔀 66 · 📦 2):
	...
	```
- [npm](https://www.npmjs.com/package/@nteract/commuter) (📥 82 / month · 📦 5 · ⏱️ 27.10.2020):
	```
...
- <b><a href="https://github.com/getnikola/nikola">nikola</a></b> (🥈22 ·  ⭐ 2.7K · 💀) - A static website and blog generator. <code><a href="http://bit.ly/34MBwT8">MIT</a></code>
...
- <b><a href="https://github.com/nteract/bookstore">bookstore</a></b> (🥉11 ·  ⭐ 200 · 💀) - Notebook storage and publishing workflows for the masses. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code>
- <b><a href="https://github.com/line/jnotebook_reader">jnotebook-reader</a></b> (🥉7 ·  ⭐ 100 · 💀) - An awesome viewer to browse and render Jupyter.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code>
</details>
<br>
...
- [GitHub](https://github.com/jupyter/nbformat) (👨‍💻 85 · 🔀 170 · 📦 390K):

	```
	git clone https://github.com/jupyter/nbformat
	```
- [PyPi](https://pypi.org/project/nbformat) (📥 74M / month · 📦 4.1K · ⏱️ 17.08.2026):
	```
	pip install nbformat
	```
- [Conda](https://anaconda.org/conda-forge/nbformat) (📥 40M · ⏱️ 19.08.2026):
	```
	conda install -c conda-forge nbformat
	```
- [npm](https://www.npmjs.com/package/nbformat-schema) (📥 240 / month · 📦 5 · ⏱️ 04.04.2024):
	```
...
- [GitHub](https://github.com/jupyter/jupyter_client) (👨‍💻 140 · 🔀 320):

	```
	git clone https://github.com/jupyter/jupyter_client
	```
- [PyPi](https://pypi.org/project/jupyter-client) (📥 69M / month · 📦 2K · ⏱️ 28.08.2026):
	```
...
<details><summary><b><a href="https://github.com/jupyter/nbclient">nbclient</a></b> (🥇26 ·  ⭐ 180 · 📉) - A client library for executing notebooks. Formally nbconverts.. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/jupyter/nbclient) (👨‍💻 47 · 🔀 66):
...
- [PyPi](https://pypi.org/project/nbclient) (📥 51M / month · 📦 810 · ⏱️ 05.06.2026):
	...
	```
- [Conda](https://anaconda.org/conda-forge/nbclient) (📥 25M · ⏱️ 31.08.2026):
	```
...
- [GitHub]() (👨‍💻 69 · 🔀 510 · 📦 3K):
	...
	```
- [PyPi](https://pypi.org/project/nbdev) (📥 87K / month · 📦 550 · ⏱️ 15.09.2026):
	```
	pip install nbdev
	```
</details>
...
- [PyPi](https://pypi.org/project/nbqa) (📥 580K / month · 📦 110 · ⏱️ 10.11.2024):
	...
	pip install nbqa
	```
- [Conda](https://anaconda.org/conda-forge/nbqa) (📥 320K · ⏱️ 22.04.2025):
	```
...
- [GitHub](https://github.com/jupyterhub/repo2docker) (👨‍💻 140 · 🔀 380):
	...
	```
- [PyPi](https://pypi.org/project/jupyter-repo2docker) (📥 3.3K / month · 📦 33 · ⏱️ 23.04.2026):
	```
	pip install jupyter-repo2docker
	```
</details>
<details><summary><b><a href="https://github.com/mljar/mercury">mercury</a></b> (🥉17 ·  ⭐ 4.4K) - Impress your boss and turn a Jupyter notebook into a beautiful,.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/mljar/mercury) (👨‍💻 23 · 🔀 290 · 📦 180):
...
- <b><a href="https://github.com/jupyter/jupyter-sphinx">Jupyter Sphinx</a></b> (🥈22 ·  ⭐ 190 · 💀) - Sphinx extension for rendering of Jupyter interactive.. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code>
...
- <b><a href="https://github.com/QuantEcon/sphinxcontrib-jupyter">sphinxcontrib.jupyter</a></b> (🥉14 ·  ⭐ 77 · 💀) - A Sphinx Extension for Generating Jupyter Notebooks. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code>
- <b><a href="https://github.com/stas00/ipyexperiments">ipyexperiments</a></b> (🥉12 ·  ⭐ 230 · 💀) - Automatic GPU+CPU memory profiling, re-use and memory.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code>
...
- <b><a href="https://github.com/jupyter-naas/naas">naas</a></b> (🥉10 ·  ⭐ 10) - Schedule notebooks, run then by http call, get data, automate all your tasks. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code>
- <b><a href="https://github.com/takluyver/jupyter_kernel_mgmt">Kernel Management</a></b> (🥉10 · 💀) - Experimental. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code>
...
- [GitHub](https://github.com/jupyterlab/jupyterlab-latex) (👨‍💻 28 · 🔀 78 · 📦 8):
	...
	```
- [PyPi](https://pypi.org/project/jupyterlab_latex) (📥 2.4K / month · 📦 1 · ⏱️ 17.12.2025):
	```
...
<details><summary><b><a href="https://github.com/jupyterlab/jupyter-renderers">JupyterLab Renderers</a></b> (🥈17 ·  ⭐ 520) - Renderers and renderer extensions for JupyterLab. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
- [GitHub](https://github.com/jupyterlab/jupyter-renderers) (👨‍💻 32 · 🔀 81 · 📦 40):
	...
	```
- [PyPi](https://pypi.org/project/jupyterlab-katex) (📥 300 / month · 📦 2 · ⏱️ 23.05.2023):
	```
	pip install jupyterlab-katex
	```
- [Conda](https://anaconda.org/conda-forge/jupyterlab-vega3) (📥 10K · ⏱️ 22.04.2025):
	```
	conda install -c conda-forge jupyterlab-vega3
	```
- [npm](https://www.npmjs.com/package/@jupyterlab/geojson-extension) (📥 230 / month · 📦 10 · ⏱️ 01.08.2023):
	```
...
- <b><a href="https://github.com/QuantStack/jupyterlab-drawio">JupyterLab Drawio</a></b> (🥇18 ·  ⭐ 600 · 💀) - A standalone embedding of the FOSS drawio / mxgraph.. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code>
...
- [GitHub](https://github.com/oriolmirosa/jupyterlab_materialdarker) (👨‍💻 2 · 🔀 17):
	...
	```
- [PyPi](https://pypi.org/project/jupyterlab-materialdarker) (📥 560 / month · ⏱️ 04.01.2026):
	```
...
- <b><a href="https://github.com/telamonian/theme-darcula">Darcula Theme</a></b> (🥇18 ·  ⭐ 220 · 💀) - A handsome Darcula theme for Jupyterlab. The first jlab.. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code>
...
- [GitHub]() (👨‍💻 100 · 🔀 1.3K · 📦 220):
	...
	```
- [PyPi](https://pypi.org/project/perspective-python) (📥 39K / month · 📦 42 · ⏱️ 15.09.2026):
	```
	pip install perspective-python
	```
- [Conda](https://anaconda.org/conda-forge/perspective) (📥 3.1M · ⏱️ 10.09.2026):
	```
	conda install -c conda-forge perspective
	```
- [npm](https://www.npmjs.com/package/@finos/perspective-jupyterlab) (📥 93 / month · 📦 6 · ⏱️ 03.09.2025):
	```
...
- [GitHub](https://github.com/jupyterlab/jupyterlab-git) (👨‍💻 110 · 🔀 410 · 📦 3.4K):
	...
	```
- [PyPi](https://pypi.org/project/jupyterlab-git) (📥 120K / month · 📦 59 · ⏱️ 03.08.2026):
	```
	pip install jupyterlab-git
	```
- [Conda](https://anaconda.org/conda-forge/jupyterlab-git) (📥 910K · ⏱️ 03.08.2026):
	```
	conda install -c conda-forge jupyterlab-git
	```
- [npm](https://www.npmjs.com/package/@jupyterlab/git) (📥 1.7K / month · 📦 11 · ⏱️ 03.08.2026):
	```
...
- [GitHub](https://github.com/jupyter-lsp/jupyterlab-lsp) (👨‍💻 59 · 🔀 160 · 📦 2.8K):
	...
	```
- [PyPi](https://pypi.org/project/jupyterlab-lsp) (📥 73K / month · 📦 67 · ⏱️ 02.04.2026):
	```
	pip install jupyterlab-lsp
	```
- [Conda](https://anaconda.org/conda-forge/jupyter-lsp) (📥 9.1M · ⏱️ 02.04.2026):
	```
...
- [GitHub](https://github.com/jupyterlab/jupyterlab-toc) (👨‍💻 14 · 🔀 4.1K):

	```
	git clone https://github.com/jupyterlab/jupyterlab-toc
	```
- [npm](https://www.npmjs.com/package/@jupyterlab/toc) (📥 180K / month · 📦 29 · ⏱️ 10.08.2026):
	```
...
- [GitHub](https://github.com/elyra-ai/elyra) (👨‍💻 77 · 🔀 360 · 📦 75):
...
- [PyPi](https://pypi.org/project/elyra) (📥 1.1K / month · 📦 4 · ⏱️ 18.05.2026):
	...
	pip install elyra
	```
- [Conda](https://anaconda.org/conda-forge/elyra) (📥 97K · ⏱️ 30.04.2026):
	```
	conda install -c conda-forge elyra
	```
- [npm](https://www.npmjs.com/package/@elyra/services) (📥 35 / month · 📦 10 · ⏱️ 29.03.2023):
	```
	npm install @elyra/services
	```
</details>
<details><summary><b><a href="https://github.com/jupyterlab-contrib/jupyterlab_code_formatter">Code Formatter</a></b> (🥇21 ·  ⭐ 910) - A JupyterLab plugin to facilitate invocation of code formatters. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub]() (👨‍💻 51 · 🔀 70 · 📦 2):
	...
	```
- [PyPi](https://pypi.org/project/jupyterlab_code_formatter) (📥 130K / month · 📦 78 · ⏱️ 06.08.2026):
	```
	pip install jupyterlab_code_formatter
	```
- [Conda](https://anaconda.org/conda-forge/jupyterlab_code_formatter) (📥 920K · ⏱️ 07.08.2026):
	```
	conda install -c conda-forge jupyterlab_code_formatter
	```
- [npm](https://www.npmjs.com/package/@ryantam626/jupyterlab_code_formatter) (📥 71 / month · 📦 5 · ⏱️ 16.04.2023):
	```
...
- [Conda](https://anaconda.org/conda-forge/jupyter_bokeh) (📥 270K · ⏱️ 09.06.2026):
	...
	```
- [npm](https://www.npmjs.com/package/@bokeh/jupyter_bokeh) (📥 530 / month · 📦 5 · ⏱️ 09.06.2026):
	```
...
- [GitHub](https://github.com/jupyterlab-contrib/spellchecker) (👨‍💻 7 · 🔀 22 · 📦 340):

	```
	git clone https://github.com/jupyterlab-contrib/spellchecker
	```
- [PyPi](https://pypi.org/project/jupyterlab-spellchecker) (📥 18K / month · 📦 7 · ⏱️ 06.07.2026):
	```
...
- [Conda](https://anaconda.org/conda-forge/jupyterlab-spellchecker) (📥 190K · ⏱️ 09.07.2026):
	...
	```
- [npm](https://www.npmjs.com/package/@ijmbarr/jupyterlab_spellchecker) (📥 37 / month · 📦 5 · ⏱️ 08.10.2021):
	```
...
- [GitHub](https://github.com/rapidsai/jupyterlab-nvdashboard) (👨‍💻 27 · 🔀 86 · 📦 3):
	...
	```
- [PyPi](https://pypi.org/project/jupyterlab-nvdashboard) (📥 72K / month · 📦 3 · ⏱️ 25.06.2026):
	```
...
- [PyPi](https://pypi.org/project/jupyterlab-execute-time) (📥 60K / month · 📦 30 · ⏱️ 23.12.2025):
	...
	```
- [Conda](https://anaconda.org/conda-forge/jupyterlab_execute_time) (📥 170K · ⏱️ 22.04.2025):
	```
	conda install -c conda-forge jupyterlab_execute_time
	```
- [npm](https://www.npmjs.com/package/jupyterlab-execute-time) (📥 150 / month · 📦 5 · ⏱️ 18.01.2021):
	```
...
- [GitHub](https://github.com/jpmorganchase/jupyter-fs) (👨‍💻 22 · 🔀 48 · 📦 16):
	...
	```
- [PyPi](https://pypi.org/project/jupyter-fs) (📥 1.9K / month · 📦 7 · ⏱️ 21.05.2026):
	```
	pip install jupyter-fs
	```
- [Conda](https://anaconda.org/conda-forge/jupyter-fs) (📥 36K · ⏱️ 01.09.2026):
	```
...
- [Conda](https://anaconda.org/conda-forge/jupyterlab_templates) (📥 62K · ⏱️ 02.09.2026):
	...
	```
- [npm](https://www.npmjs.com/package/jupyterlab_templates) (📥 250 / month · 📦 5 · ⏱️ 12.02.2024):
	```
...
- [GitHub](https://github.com/jupyter-widgets/jupyterlab-sidecar) (👨‍💻 19 · 🔀 39 · 📦 7):
	...
	```
- [PyPi](https://pypi.org/project/sidecar) (📦 46 · ⏱️ 27.02.2026):
	```
	pip install sidecar
	```
- [Conda](https://anaconda.org/conda-forge/sidecar) (📥 49K · ⏱️ 27.02.2026):
	...
	```
- [npm](https://www.npmjs.com/package/@jupyter-widgets/jupyterlab-sidecar) (📥 72 / month · 📦 5 · ⏱️ 27.02.2026):
	```
	npm install @jupyter-widgets/jupyterlab-sidecar
	```
</details>
<details><summary><b><a href="https://github.com/aquirdTurtle/Collapsible_Headings">Collapsible Headings</a></b> (🥈16 ·  ⭐ 190) - Implements Collapsible Headers for Jupyter Lab Notebooks. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/aquirdTurtle/Collapsible_Headings) (👨‍💻 6 · 🔀 8 · 📦 3 · 📋 60 - 45% open · ⏱️ 07.09.2026):

	```
	git clone https://github.com/aquirdTurtle/Collapsible_Headings
	```
- [PyPi](https://pypi.org/project/aquirdturtle-collapsible-headings) (📥 440 / month · 📦 5 · ⏱️ 22.05.2021):
	```
	pip install aquirdturtle-collapsible-headings
	```
- [npm](https://www.npmjs.com/package/@aquirdturtle/collapsible_headings) (📥 66 / month · 📦 5 · ⏱️ 11.01.2021):
	```
...
- [GitHub](https://github.com/timkpaine/jupyterlab_iframe) (👨‍💻 6 · 🔀 17 · 📦 70):
...
- [PyPi](https://pypi.org/project/jupyterlab_iframe) (📥 1.8K / month · ⏱️ 16.07.2023):
	...
	```
- [Conda](https://anaconda.org/conda-forge/jupyterlab_iframe) (📥 60K · ⏱️ 01.09.2026):
	```
...
- [GitHub](https://github.com/timkpaine/jupyterlab_autoversion) (👨‍💻 7 · 🔀 10 · 📦 19):

	```
	git clone https://github.com/timkpaine/jupyterlab_autoversion
	```
- [PyPi](https://pypi.org/project/jupyterlab_autoversion) (📥 58 / month · ⏱️ 19.06.2024):
	```
...
- [GitHub](https://github.com/timkpaine/jupyterlab_commands) (👨‍💻 5 · 🔀 5 · 📦 12):
...
- [PyPi](https://pypi.org/project/jupyterlab-commands) (📥 52 / month · ⏱️ 12.07.2023):
	...
	```
- [Conda](https://anaconda.org/conda-forge/jupyterlab_commands) (📥 25K · ⏱️ 01.09.2026):
	```
	conda install -c conda-forge jupyterlab_commands
	```
</details>
<details><summary><b><a href="https://github.com/jupyterlab-contrib/jupyterlab-kernelspy">JupyterLab Kernelspy</a></b> (🥉13 ·  ⭐ 85 · 💤) - A Jupyter Lab extension for inspecting messages.. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
- [GitHub](https://github.com/jupyterlab-contrib/jupyterlab-kernelspy) (👨‍💻 6 · 🔀 12 · 📦 7):
	...
	```
- [PyPi](https://pypi.org/project/jupyterlab-kernelspy) (📥 430 / month · ⏱️ 30.08.2023):
	```
	pip install jupyterlab-kernelspy
	```
- [Conda](https://anaconda.org/conda-forge/jupyterlab-kernelspy) (📥 28K · ⏱️ 22.04.2025):
	```
	conda install -c conda-forge jupyterlab-kernelspy
	```
- [npm](https://www.npmjs.com/package/jupyterlab-kernelspy) (📥 43 / month · 📦 5 · ⏱️ 30.08.2023):
	```
...
- <b><a href="https://github.com/jupyterlab/jupyterlab-google-drive">JupyterLab Google Drive</a></b> (🥉14 ·  ⭐ 400 · 💀) - Cloud storage for JupyterLab using Google Drive. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code>
...
- <b><a href="https://github.com/chaoleili/jupyterlab_tensorboard">JupyterLab Tensorboard</a></b> (🥉13 ·  ⭐ 320 · 💀) - A JupyterLab extension for tensorboard. <code><a href="http://bit.ly/34MBwT8">MIT</a></code>
...
- <b><a href="https://github.com/jupyterlab/jupyterlab-hdf5">JupyterLab HDF5</a></b> (🥉12 ·  ⭐ 120 · 💀) - Open and explore HDF5 files in JupyterLab. Can handle very.. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code>
- <b><a href="https://github.com/timkpaine/jupyterlab_email">JupyterLab Flake8</a></b> (🥉12 ·  ⭐ 110 · 💀) - A jupyterlab extension to email notebooks directly.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code>
...
- <b><a href="https://github.com/jtpio/jupyterlab-topbar">JupyterLab Top Bar</a></b> (🥉12 ·  ⭐ 6 · 💀) - JupyterLab Top Bar extension. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code>
...
<details><summary><b><a href="https://github.com/jupyterhub/oauthenticator">OAuthenticator</a></b> (🥇20 ·  ⭐ 440) - OAuth + JupyterHub Authenticator = OAuthenticator. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
- [GitHub](https://github.com/jupyterhub/oauthenticator) (👨‍💻 130 · 🔀 370 · 📦 590):
	...
	```
- [PyPi](https://pypi.org/project/oauthenticator) (📦 32 · ⏱️ 26.03.2026):
	```
	pip install oauthenticator
	```
- [Conda](https://anaconda.org/conda-forge/oauthenticator) (📥 120K · ⏱️ 26.03.2026):
	```
...
- [GitHub](https://github.com/jupyterhub/ltiauthenticator) (👨‍💻 19 · 🔀 56):
	...
	```
- [PyPi](https://pypi.org/project/jupyterhub-ltiauthenticator) (📥 2.5K / month · ⏱️ 26.03.2026):
	```
	pip install jupyterhub-ltiauthenticator
	```
</details>
<details><summary><b><a href="https://github.com/jupyterhub/firstuseauthenticator">First Use Authenticator</a></b> (🥈13 ·  ⭐ 50 · 💤) - JupyterHub Authenticator that lets users set.. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/jupyterhub/firstuseauthenticator) (👨‍💻 15 · 🔀 33):

	```
	git clone https://github.com/jupyterhub/firstuseauthenticator
	```
- [PyPi](https://pypi.org/project/jupyterhub-firstuseauthenticator) (📥 3.8K / month · ⏱️ 28.03.2025):
	```
...
- <b><a href="https://github.com/jupyterhub/ldapauthenticator">LDAP Authenticator</a></b> (🥇20 ·  ⭐ 210 · 💀) - LDAP Authenticator Plugin for Jupyter. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code>
...
- <b><a href="https://github.com/jupyterhub/kerberosauthenticator">Keberos Authenticator</a></b> (🥉11 ·  ⭐ 12) - A JupyterHub authenticator using Kerberos. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code>
...
- <b><a href="https://github.com/mogthesprog/jwtauthenticator">JWT Authenticator</a></b> (🥉9 ·  ⭐ 9 · 💀) - A Token Authenticator for JupyterHub. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code>
...
- <b><a href="https://github.com/cwaldbieser/jhub_remote_user_authenticator">Remote User Auth</a></b> (🥉8 ·  ⭐ 12 · 💀) - REMOTE_USER authenticator for Jupyterhub. <code><a href="http://bit.ly/2M0xdwT">❗️GPL-3.0</a></code>
...
- [GitHub](https://github.com/jupyterhub/kubespawner) (👨‍💻 95 · 🔀 310):

	```
	git clone https://github.com/jupyterhub/kubespawner
	```
- [PyPi](https://pypi.org/project/jupyterhub-kubespawner) (📥 16K / month · 📦 14 · ⏱️ 16.07.2026):
	```
...
- [GitHub](https://github.com/jupyterhub/sudospawner) (👨‍💻 20 · 🔀 42 · 📦 89):

	```
	git clone https://github.com/jupyterhub/sudospawner
	```
- [PyPi](https://pypi.org/project/sudospawner) (📥 1.1K / month · 📦 2 · ⏱️ 17.10.2025):
	```
	pip install sudospawner
	```
</details>
<details><summary><b><a href="https://github.com/jupyterhub/systemdspawner">SystemdSpawner</a></b> (🥉14 ·  ⭐ 99 · 💤) - Spawn JupyterHub single-user notebook servers with systemd. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/jupyterhub/systemdspawner) (👨‍💻 22 · 🔀 44):

	```
	git clone https://github.com/jupyterhub/systemdspawner
	```
- [PyPi](https://pypi.org/project/jupyterhub-systemdspawner) (📥 3K / month · 📦 2 · ⏱️ 20.10.2024):
	```
	pip install jupyterhub-systemdspawner
	```
- [Conda](https://anaconda.org/conda-forge/jupyterhub-systemdspawner) (📥 99K · ⏱️ 03.11.2025):
	```
...
- <b><a href="https://github.com/jupyterhub/batchspawner">BatchSpawner</a></b> (🥈19 ·  ⭐ 180 · 💀) - Custom Spawner for Jupyterhub to start servers in batch.. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code>
...
- [GitHub](https://github.com/ipython/ipython) (👨‍💻 1.1K · 🔀 4.5K · 📦 760K):
	...
	```
- [PyPi](https://pypi.org/project/ipython) (📥 110M / month · 📦 17K · ⏱️ 01.09.2026):
	```
	pip install ipython
	```
- [Conda](https://anaconda.org/conda-forge/ipython) (📥 55M · ⏱️ 01.09.2026):
	```
...
- [GitHub](https://github.com/jupyter-server/jupyter_server) (👨‍💻 550 · 🔀 420):

	```
	git clone https://github.com/jupyter-server/jupyter_server
	```
- [PyPi](https://pypi.org/project/jupyter_server) (📥 37M / month · 📦 1.5K · ⏱️ 15.09.2026):
	```
	pip install jupyter_server
	```
- [Conda](https://anaconda.org/conda-forge/jupyter_server) (📥 22M · ⏱️ 15.09.2026):
	```
...
- [PyPi](https://pypi.org/project/jupyter-packaging) (📥 590K / month · 📦 130 · ⏱️ 25.08.2022):
	...
	```
- [Conda](https://anaconda.org/conda-forge/jupyter-packaging) (📥 760K · ⏱️ 02.09.2026):
	```
...
<details><summary><b><a href="http://jupyter.org">qtconsole</a></b> (🥈21) - Jupyter Qt console. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
- <b><a href="https://github.com/jupyter/jupyter_console">jupyter-console</a></b> (🥇24 ·  ⭐ 270 · 💀) - Jupyter Terminal Console. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code>
