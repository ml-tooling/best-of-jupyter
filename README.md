...
- [Conda](https://anaconda.org/conda-forge/jupyterlab) (📥 24M · ⏱️ 21.07.2026):
	...
	```
- [npm](https://www.npmjs.com/package/@jupyterlab/ui-components) (📥 400K / month · 📦 520 · ⏱️ 21.07.2026):
	```
...
- [GitHub](https://github.com/nteract/nteract) (👨‍💻 49 · 🔀 550):
	...
	```
- [PyPi](https://pypi.org/project/nteract_on_jupyter) (📥 840 / month · ⏱️ 16.07.2019):
	```
...
- [GitHub](https://github.com/jupyter-server/jupyverse) (👨‍💻 23 · 🔀 39 · 📦 21):
	...
	```
- [PyPi](https://pypi.org/project/jupyverse) (📥 3.1K / month · ⏱️ 25.06.2026):
	```
...
- [GitHub](https://github.com/vatlab/SOS) (👨‍💻 35 · 🔀 45):
	...
	```
- [PyPi](https://pypi.org/project/sos-notebook) (📥 650 / month · 📦 33 · ⏱️ 26.03.2026):
	```
...
- [GitHub](https://github.com/bokeh/bokeh) (👨‍💻 730 · 🔀 4.3K · 📦 110K):
	...
	```
- [PyPi](https://pypi.org/project/bokeh) (📥 8.1M / month · 📦 2.5K · ⏱️ 23.07.2026):
	```
	pip install bokeh
	```
- [Conda](https://anaconda.org/conda-forge/bokeh) (📥 20M · ⏱️ 09.06.2026):
	...
	```
- [npm](https://www.npmjs.com/package/@bokeh/bokehjs) (📥 37K / month · 📦 21 · ⏱️ 23.07.2026):
	```
...
- [Conda](https://anaconda.org/conda-forge/ipympl) (📥 2.8M · ⏱️ 24.01.2026):
	...
	```
- [npm](https://www.npmjs.com/package/jupyter-matplotlib) (📥 47K / month · 📦 7 · ⏱️ 21.01.2026):
	```
...
- [PyPi](https://pypi.org/project/bqplot) (📥 380K / month · 📦 120 · ⏱️ 07.05.2026):
	...
	pip install bqplot
	```
- [Conda](https://anaconda.org/conda-forge/bqplot) (📥 3.3M · ⏱️ 07.05.2026):
	```
...
- [PyPi](https://pypi.org/project/itables) (📥 1.5M / month · 📦 140 · ⏱️ 22.07.2026):
	...
	pip install itables
	```
- [Conda](https://anaconda.org/conda-forge/itables) (📥 340K · ⏱️ 20.07.2026):
	```
...
- [Conda](https://anaconda.org/conda-forge/ipyvolume) (📥 1.2M · ⏱️ 24.11.2025):
	...
	```
- [npm](https://www.npmjs.com/package/ipyvolume) (📥 410 / month · 📦 6 · ⏱️ 02.06.2023):
	```
...
- [GitHub](https://github.com/cytoscape/ipycytoscape) (👨‍💻 33 · 🔀 63 · 📦 350):

	```
	git clone https://github.com/cytoscape/ipycytoscape
	```
- [PyPi](https://pypi.org/project/ipycytoscape) (📥 39K / month · 📦 50 · ⏱️ 04.04.2022):
	```
	pip install ipycytoscape
	```
- [Conda](https://anaconda.org/conda-forge/ipycytoscape) (📥 780K · ⏱️ 22.04.2025):
	```
	conda install -c conda-forge ipycytoscape
	```
- [npm](https://www.npmjs.com/package/jupyter-cytoscape) (📥 19K / month · 📦 5 · ⏱️ 04.04.2022):
	```
...
- [GitHub](https://github.com/InsightSoftwareConsortium/itkwidgets) (👨‍💻 27 · 🔀 84 · 📦 400):
	...
	```
- [PyPi](https://pypi.org/project/itkwidgets) (📥 9.5K / month · 📦 32 · ⏱️ 07.02.2025):
	```
...
- [GitHub](https://github.com/spacetelescope/jdaviz) (👨‍💻 45 · 🔀 91 · 📦 72):

	```
	git clone https://github.com/spacetelescope/jdaviz
	```
- [PyPi](https://pypi.org/project/jdaviz) (📥 4.5K / month · 📦 11 · ⏱️ 21.07.2026):
	```
	pip install jdaviz
	```
</details>
...
- [GitHub]() (👨‍💻 7 · 🔀 18 · 📦 1.5K):
	...
	```
- [PyPi](https://pypi.org/project/ipyvue) (📥 340K / month · 📦 43 · ⏱️ 14.07.2026):
	```
	pip install ipyvue
	```
...
- [PyPi](https://pypi.org/project/ipydatagrid) (📥 27K / month · 📦 31 · ⏱️ 17.12.2024):
	...
	```
- [Conda](https://anaconda.org/conda-forge/ipydatagrid) (📥 580K · ⏱️ 23.08.2025):
	```
...
<details><summary><b><a href="https://github.com/nicolaskruchten/jupyter_pivottablejs">pivottablejs</a></b> (🥉17 ·  ⭐ 690 · 💤) - Dragndrop Pivot Tables and Charts for Jupyter/IPython Notebook,.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/nicolaskruchten/jupyter_pivottablejs) (👨‍💻 3 · 🔀 88):
...
- [GitHub]() (👨‍💻 6 · 🔀 25 · 📦 91):
	...
	```
- [PyPi](https://pypi.org/project/ipysigma) (📥 99K / month · 📦 4 · ⏱️ 25.11.2025):
	```
...
- [GitHub](https://github.com/jupyterhub/jupyter-server-proxy) (👨‍💻 82 · 🔀 150 · 📦 5):
	...
	```
- [PyPi](https://pypi.org/project/jupyter-server-proxy) (📥 600K / month · 📦 240 · ⏱️ 01.04.2026):
	```
...
- [Conda](https://anaconda.org/conda-forge/jupyter-server-proxy) (📥 2.1M · ⏱️ 09.04.2026):
	...
	```
- [npm](https://www.npmjs.com/package/@jupyterlab/server-proxy) (📥 390 / month · 📦 9 · ⏱️ 11.06.2024):
	```
...
- [GitHub](https://github.com/jupyter-server/jupyter-resource-usage) (👨‍💻 37 · 🔀 110 · 📦 1K):
...
<details><summary><b><a href="https://github.com/oschuett/appmode">Appmode</a></b> (🥈19 ·  ⭐ 460 · 💤) - A Jupyter extensions that turns notebooks into web applications. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/oschuett/appmode) (👨‍💻 10 · 🔀 69 · 📦 390):

	```
	git clone https://github.com/oschuett/appmode
	```
- [PyPi](https://pypi.org/project/appmode) (📥 960 / month · 📦 8 · ⏱️ 29.12.2025):
	```
	pip install appmode
	```
- [Conda](https://anaconda.org/conda-forge/appmode) (📥 600K · ⏱️ 29.12.2025):
	```
...
- [GitHub](https://github.com/jupyterhub/jupyter-rsession-proxy) (👨‍💻 32 · 🔀 85 · 📦 67):
	...
	```
- [PyPi](https://pypi.org/project/jupyter-rsession-proxy) (📥 4.8K / month · 📦 2 · ⏱️ 12.05.2026):
	```
...
<details><summary><b><a href="https://github.com/jupyterlab-contrib/jupyter-archive">jupyter-archive</a></b> (🥈18 ·  ⭐ 88) - A Jupyter/Jupyterlab extension to make, download and extract.. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/jupyterlab-contrib/jupyter-archive) (👨‍💻 11 · 🔀 16 · 📦 380):

	```
	git clone https://github.com/jupyterlab-contrib/jupyter-archive
	```
- [PyPi](https://pypi.org/project/jupyter-archive) (📥 170K / month · 📦 7 · ⏱️ 15.08.2023):
	```
	pip install jupyter-archive
	```
- [Conda](https://anaconda.org/conda-forge/jupyter-archive) (📥 120K · ⏱️ 22.04.2025):
	```
	conda install -c conda-forge jupyter-archive
	```
- [npm](https://www.npmjs.com/package/@hadim/jupyter-archive) (📥 170 / month · 📦 5 · ⏱️ 15.08.2023):
	```
...
- [PyPi](https://pypi.org/project/mamba-gator) (📥 110 / month · ⏱️ 08.04.2026):
	...
	```
- [Conda](https://anaconda.org/conda-forge/mamba_gator) (📥 73K · ⏱️ 12.04.2026):
	```
	conda install -c conda-forge mamba_gator
	```
- [npm](https://www.npmjs.com/package/@mamba-org/gator-lab) (📥 42 / month · 📦 5 · ⏱️ 03.09.2021):
	```
...
- [GitHub](https://github.com/krishnan-r/sparkmonitor) (👨‍💻 3 · 🔀 51):
	...
	```
- [PyPi](https://pypi.org/project/sparkmonitor) (📥 22K / month · ⏱️ 31.03.2026):
	```
	pip install sparkmonitor
	```
- [Docker Hub](https://hub.docker.com/r/krishnanr/sparkmonitor) (📥 1.7K · ⏱️ 04.10.2019):
	```
...
- <b><a href="https://github.com/mozilla/jupyter-spark">Jupyter Spark</a></b> (🥉13 ·  ⭐ 190 · 💀) - Jupyter Notebook extension for Apache Spark integration. <code><a href="http://bit.ly/3postzC">MPL-2.0</a></code>
...
- [GitHub](https://github.com/nteract/pick) (👨‍💻 5 · 🔀 63):
	...
	```
- [PyPi](https://pypi.org/project/pick) (📥 510K / month · 📦 250 · ⏱️ 28.02.2026):
	```
	pip install pick
	```
</details>
...
- [GitHub](https://github.com/Calysto/metakernel) (👨‍💻 38 · 🔀 91 · 📦 1.1K):
	...
	```
- [PyPi](https://pypi.org/project/metakernel) (📥 67K / month · 📦 64 · ⏱️ 24.03.2026):
	```
...
- [GitHub](https://github.com/calysto/octave_kernel) (👨‍💻 27 · 🔀 65 · 📦 120):
	...
	```
- [PyPi](https://pypi.org/project/octave_kernel) (📥 29K / month · 📦 5 · ⏱️ 30.06.2026):
	```
...
- [GitHub](https://github.com/lfortran/lfortran) (👨‍💻 160 · 🔀 210):
	...
	```
- [PyPi](https://pypi.org/project/lfortran) (📥 1.5K / month · ⏱️ 31.07.2020):
	```
...
- [GitHub](https://github.com/jupyter-xeus/xeus-python) (👨‍💻 27 · 🔀 79):
	...
	```
- [PyPi](https://pypi.org/project/xeus-python) (📥 4.6K / month · 📦 11 · ⏱️ 07.07.2026):
	```
...
- [GitHub](https://github.com/SciRuby/iruby) (👨‍💻 55 · 🔀 34 · 📦 870):

	```
	git clone https://github.com/SciRuby/iruby
	```
- [Docker Hub](https://hub.docker.com/r/rubydata/datascience-notebook) (📥 3.6K · ⭐ 5 · ⏱️ 03.02.2023):
	```
...
- [GitHub](https://github.com/calysto/matlab_kernel) (👨‍💻 18 · 🔀 75):
	...
	```
- [PyPi](https://pypi.org/project/matlab_kernel) (📥 2.7K / month · 📦 5 · ⏱️ 20.04.2017):
	```
...
- [GitHub](https://github.com/jupyter-xeus/xeus-sqlite) (👨‍💻 17 · 🔀 27):
	...
	```
- [Conda](https://anaconda.org/conda-forge/xeus-sqlite) (📥 94K · ⏱️ 09.03.2026):
	```
...
- [GitHub](https://github.com/hugetim/nbstata) (👨‍💻 2 · 🔀 7 · 📦 6):
	...
	```
- [PyPi](https://pypi.org/project/nbstata) (📥 870 / month · ⏱️ 22.01.2026):
	```
	pip install nbstata
	```
</details>
...
- <b><a href="https://github.com/pprzetacznik/IElixir">IElixir</a></b> (🥉11 ·  ⭐ 360 · 💀) - Jupyters kernel for Elixir programming language. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code>
...
- [GitHub]() (👨‍💻 100 · 🔀 420 · 📦 12K):
	...
	```
- [PyPi](https://pypi.org/project/jupytext) (📥 3.8M / month · 📦 1.1K · ⏱️ 21.07.2026):
	```
...
- [Conda](https://anaconda.org/conda-forge/rise) (📥 520K · ⏱️ 27.10.2025):
	...
	```
- [npm](https://www.npmjs.com/package/rise-reveal) (📥 20 / month · 📦 3 · ⏱️ 03.07.2019):
	```
...
- [GitHub](https://github.com/getnikola/nikola) (👨‍💻 250 · 🔀 470 · 📦 550):
	...
	```
- [PyPi](https://pypi.org/project/nikola) (📥 5.2K / month · 📦 2 · ⏱️ 17.05.2025):
	```
	pip install nikola
	```
</details>
...
- [GitHub](https://github.com/jupyter/nbformat) (👨‍💻 83 · 🔀 160 · 📦 390K):

	```
	git clone https://github.com/jupyter/nbformat
	```
- [PyPi](https://pypi.org/project/nbformat) (📥 79M / month · 📦 1.9K · ⏱️ 04.04.2024):
	```
...
- [GitHub](https://github.com/jupyter/jupyter_client) (👨‍💻 140 · 🔀 310):
	...
	```
- [PyPi](https://pypi.org/project/jupyter-client) (📥 87M / month · 📦 1.9K · ⏱️ 09.06.2026):
	```
...
- [GitHub]() (👨‍💻 68 · 🔀 520 · 📦 3K):
	...
	```
- [PyPi](https://pypi.org/project/nbdev) (📥 100K / month · 📦 530 · ⏱️ 22.07.2026):
	```
	pip install nbdev
	```
</details>
...
- [GitHub](https://github.com/jupyterhub/repo2docker) (👨‍💻 140 · 🔀 380):
	...
	```
- [PyPi](https://pypi.org/project/jupyter-repo2docker) (📥 5.1K / month · 📦 33 · ⏱️ 23.04.2026):
	```
...
- [Conda](https://anaconda.org/conda-forge/jupyterlab-vega3) (📥 9.6K · ⏱️ 22.04.2025):
	...
	```
- [npm](https://www.npmjs.com/package/@jupyterlab/geojson-extension) (📥 1.3K / month · 📦 10 · ⏱️ 01.08.2023):
	```
...
- [GitHub](https://github.com/oriolmirosa/jupyterlab_materialdarker) (👨‍💻 2 · 🔀 17):
	...
	```
- [PyPi](https://pypi.org/project/jupyterlab-materialdarker) (📥 590 / month · ⏱️ 04.01.2026):
	```
	pip install jupyterlab-materialdarker
	```
- [npm](https://www.npmjs.com/package/@oriolmirosa/jupyterlab_materialdarker) (📥 42 / month · 📦 5 · ⏱️ 16.12.2022):
	```
...
- [GitHub]() (👨‍💻 100 · 🔀 1.3K · 📦 210):
	...
	```
- [PyPi](https://pypi.org/project/perspective-python) (📥 31K / month · 📦 36 · ⏱️ 09.07.2026):
	```
...
- [Conda](https://anaconda.org/conda-forge/perspective) (📥 2.9M · ⏱️ 09.07.2026):
	...
	```
- [npm](https://www.npmjs.com/package/@finos/perspective-jupyterlab) (📥 450 / month · 📦 6 · ⏱️ 03.09.2025):
	```
...
- [Conda](https://anaconda.org/conda-forge/jupyterlab-git) (📥 880K · ⏱️ 17.06.2026):
	...
	```
- [npm](https://www.npmjs.com/package/@jupyterlab/git) (📥 2.3K / month · 📦 11 · ⏱️ 17.06.2026):
	```
...
- [GitHub](https://github.com/jupyter-lsp/jupyterlab-lsp) (👨‍💻 58 · 🔀 160 · 📦 2.8K):
...
- [PyPi](https://pypi.org/project/jupyterlab-lsp) (📥 130K / month · 📦 67 · ⏱️ 02.04.2026):
	...
	```
- [Conda](https://anaconda.org/conda-forge/jupyter-lsp) (📥 8.1M · ⏱️ 02.04.2026):
	```
	conda install -c conda-forge jupyter-lsp
	```
- [npm](https://www.npmjs.com/package/@krassowski/jupyterlab-lsp) (📥 640 / month · 📦 7 · ⏱️ 26.08.2022):
	```
...
- [GitHub](https://github.com/jupyterlab/debugger) (👨‍💻 11 · 🔀 4K):
	...
	```
- [npm](https://www.npmjs.com/package/@jupyterlab/debugger) (📥 83K / month · 📦 21 · ⏱️ 21.07.2026):
	```
...
- [GitHub](https://github.com/jupyterlab/jupyterlab-toc) (👨‍💻 14 · 🔀 4K):
	...
	```
- [npm](https://www.npmjs.com/package/@jupyterlab/toc) (📥 250K / month · 📦 29 · ⏱️ 21.07.2026):
	```
...
- [Conda](https://anaconda.org/conda-forge/elyra) (📥 93K · ⏱️ 30.04.2026):
	...
	```
- [npm](https://www.npmjs.com/package/@elyra/services) (📥 45 / month · 📦 10 · ⏱️ 29.03.2023):
	```
...
- [Conda](https://anaconda.org/conda-forge/jupyter_bokeh) (📥 250K · ⏱️ 09.06.2026):
	...
	```
- [npm](https://www.npmjs.com/package/@bokeh/jupyter_bokeh) (📥 1K / month · 📦 5 · ⏱️ 09.06.2026):
	```
...
- [Conda](https://anaconda.org/conda-forge/jupyterlab_code_formatter) (📥 900K · ⏱️ 11.02.2026):
	...
	```
- [npm](https://www.npmjs.com/package/@ryantam626/jupyterlab_code_formatter) (📥 200 / month · 📦 5 · ⏱️ 16.04.2023):
	```
...
- [GitHub](https://github.com/rapidsai/jupyterlab-nvdashboard) (👨‍💻 27 · 🔀 86 · 📦 3):
	...
	```
- [PyPi](https://pypi.org/project/jupyterlab-nvdashboard) (📥 49K / month · 📦 3 · ⏱️ 25.06.2026):
	```
...
- [GitHub](https://github.com/jpmorganchase/jupyter-fs) (👨‍💻 22 · 🔀 48 · 📦 16):
	...
	```
- [PyPi](https://pypi.org/project/jupyter-fs) (📥 3.4K / month · 📦 7 · ⏱️ 21.05.2026):
	```
...
- [Conda](https://anaconda.org/conda-forge/jupyterlab_templates) (📥 58K · ⏱️ 29.09.2025):
	...
	```
- [npm](https://www.npmjs.com/package/jupyterlab_templates) (📥 480 / month · 📦 5 · ⏱️ 12.02.2024):
	```
...
- [PyPi](https://pypi.org/project/jupyterlab-quickopen) (📥 1.3K / month · 📦 2 · ⏱️ 13.05.2026):
	...
	```
- [npm](https://www.npmjs.com/package/@parente/jupyterlab-quickopen) (📥 43 / month · 📦 5 · ⏱️ 20.03.2020):
	```
...
- [GitHub](https://github.com/jupyterlab-contrib/jupyterlab-kernelspy) (👨‍💻 6 · 🔀 12 · 📦 7):
	...
	```
- [PyPi](https://pypi.org/project/jupyterlab-kernelspy) (📥 640 / month · ⏱️ 30.08.2023):
	```
...
- [Conda](https://anaconda.org/conda-forge/jupyterlab-kernelspy) (📥 27K · ⏱️ 22.04.2025):
	...
	```
- [npm](https://www.npmjs.com/package/jupyterlab-kernelspy) (📥 78 / month · 📦 5 · ⏱️ 30.08.2023):
	```
...
- <b><a href="https://github.com/jupyterlab/jupyterlab-google-drive">JupyterLab Google Drive</a></b> (🥈16 ·  ⭐ 400 · 💀) - Cloud storage for JupyterLab using Google Drive. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code>
...
- [GitHub](https://github.com/jupyterhub/oauthenticator) (👨‍💻 130 · 🔀 370 · 📦 580):

	```
	git clone https://github.com/jupyterhub/oauthenticator
	```
- [PyPi](https://pypi.org/project/oauthenticator) (📥 77K / month · 📦 32 · ⏱️ 26.03.2026):
	```
...
- [GitHub](https://github.com/jupyterhub/ltiauthenticator) (👨‍💻 19 · 🔀 56):
	...
	```
- [PyPi](https://pypi.org/project/jupyterhub-ltiauthenticator) (📥 4.4K / month · ⏱️ 26.03.2026):
	```
...
- <b><a href="https://github.com/jupyterhub/nativeauthenticator">Native Authenticator</a></b> (🥈19 ·  ⭐ 72 · 💀) - JupyterHub-native User Authenticator. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code>
...
- [GitHub](https://github.com/jupyter/jupyter-packaging) (👨‍💻 31 · 🔀 47):
	...
	```
- [PyPi](https://pypi.org/project/jupyter-packaging) (📥 920K / month · 📦 130 · ⏱️ 25.08.2022):
	```
...
- [GitHub]() (👨‍💻 130 · 📦 200K):
	...
	```
- [PyPi](https://pypi.org/project/qtconsole) (📥 3.9M / month · 📦 460 · ⏱️ 25.03.2026):
	```
