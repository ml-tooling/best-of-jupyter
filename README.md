...
- [GitHub](https://github.com/jupyter/notebook) (👨‍💻 610 · 🔀 3.9K · 📥 9.1K · 📦 10 · 📋 4.5K - 45% open · ⏱️ 06.09.2022):

	```
	git clone https://github.com/jupyter/notebook
	```
- [PyPi](https://pypi.org/project/notebook) (📥 9.7M / month · 📦 8.7K · ⏱️ 14.06.2022):
	```
...
- [Conda](https://anaconda.org/conda-forge/jupyter) (📥 2.3M · ⏱️ 18.11.2021):
	...
	```
- [Docker Hub](https://hub.docker.com/r/jupyter/datascience-notebook) (📥 27M · ⭐ 940 · ⏱️ 12.09.2022):
	```
...
- [GitHub](https://github.com/jupyterhub/jupyterhub) (👨‍💻 280 · 🔀 1.8K · 📦 1.9K · 📋 2.2K - 6% open · ⏱️ 13.09.2022):
...
- [PyPi](https://pypi.org/project/jupyterhub) (📥 130K / month · 📦 370 · ⏱️ 06.06.2022):
	...
	```
- [Conda](https://anaconda.org/conda-forge/jupyterhub) (📥 680K · ⏱️ 12.09.2022):
	```
	conda install -c conda-forge jupyterhub
	```
- [Docker Hub](https://hub.docker.com/r/jupyterhub/jupyterhub) (📥 2.7M · ⭐ 310 · ⏱️ 13.09.2022):
	```
...
- [GitHub](https://github.com/nteract/nteract) (👨‍💻 180 · 🔀 560 · 📥 1.4M · 📋 1.7K - 9% open · ⏱️ 30.08.2022):
...
- [PyPi](https://pypi.org/project/jupyterlab) (📥 1.8M / month · 📦 1.9K · ⏱️ 09.06.2022):
	...
	```
- [Conda](https://anaconda.org/conda-forge/jupyterlab) (📥 6.2M · ⏱️ 13.09.2022):
	```
	conda install -c conda-forge jupyterlab
	```
- [npm](https://www.npmjs.com/package/@jupyterlab/ui-components) (📥 350K / month · 📦 290 · ⏱️ 05.09.2022):
	```
...
- [GitHub](https://github.com/jupyter/docker-stacks) (👨‍💻 220 · 🔀 2.8K · 📋 780 - 5% open · ⏱️ 13.09.2022):

	```
	git clone https://github.com/jupyter/docker-stacks
	```
- [Docker Hub](https://hub.docker.com/r/jupyter/scipy-notebook) (📥 86M · ⭐ 360 · ⏱️ 12.09.2022):
	```
	docker pull jupyter/scipy-notebook
	```
</details>
<details><summary><b><a href="https://github.com/microsoft/vscode-jupyter">VSCode Jupyter</a></b> (🥈28 ·  ⭐ 730) - VS Code Jupyter extension. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/microsoft/vscode-jupyter) (👨‍💻 250 · 🔀 150 · 📋 7.8K - 8% open · ⏱️ 15.09.2022):

	```
	git clone https://github.com/microsoft/vscode-jupyter
	```
- [Conda](https://anaconda.org/conda-forge/vscode-jupyter) (📥 35K · ⏱️ 12.04.2022):
	```
...
<details><summary><b><a href="https://github.com/vatlab/sos">sos</a></b> (🥉26 ·  ⭐ 230 · 📉) - SoS workflow system for daily data analysis. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/vatlab/sos) (👨‍💻 36 · 🔀 30 · 📦 2.8K · 📋 1.4K - 4% open · ⏱️ 21.06.2022):

	```
	git clone https://github.com/vatlab/SOS
	```
- [PyPi](https://pypi.org/project/sos-notebook) (📥 790 / month · 📦 33 · ⏱️ 09.04.2022):
	```
...
- [GitHub](https://github.com/Kaggle/docker-python) (👨‍💻 150 · 🔀 840 · 📋 310 - 8% open · ⏱️ 13.09.2022):
...
- [GitHub](https://github.com/ml-tooling/ml-workspace) (👨‍💻 11 · 🔀 340 · 📋 88 - 10% open · ⏱️ 22.11.2021):
...
- [GitHub](https://github.com/jupyterlab/retrolab) (👨‍💻 17 · 🔀 44 · 📥 790 · 📦 82 · 📋 110 - 4% open · ⏱️ 04.05.2022):
...
- [PyPi](https://pypi.org/project/retrolab) (📥 3K / month · 📦 3 · ⏱️ 04.05.2022):
	...
	```
- [Conda](https://anaconda.org/conda-forge/retrolab) (📥 22K · ⏱️ 04.05.2022):
	```
	conda install -c conda-forge retrolab
	```
- [npm](https://www.npmjs.com/package/@jupyterlab-classic/application) (📥 99 / month · 📦 4 · ⏱️ 19.04.2021):
	```
...
- [GitHub](https://github.com/ml-tooling/ml-hub) (👨‍💻 7 · 🔀 53 · 📥 1.9K · 📋 26 - 57% open · ⏱️ 23.12.2021):
...
<details><summary><b><a href="https://github.com/iot-salzburg/gpu-jupyter">gpu-jupyter</a></b> (🥉14 ·  ⭐ 400) - Leverage the flexibility of Jupyterlab through the power of your.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/iot-salzburg/gpu-jupyter) (👨‍💻 10 · 🔀 140 · 📋 57 - 22% open · ⏱️ 21.07.2022):

	```
	git clone https://github.com/iot-salzburg/gpu-jupyter
	```
</details>
<details><summary><b><a href="https://github.com/jtpio/jupyterlite">jupyterlite</a></b> (🥉14 ·  ⭐ 70) - Wasm powered Jupyter running in the browser. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/jtpio/jupyterlite) (👨‍💻 40 · 🔀 6 · ⏱️ 02.09.2022):
...
- [GitHub](https://github.com/bokeh/bokeh) (👨‍💻 610 · 🔀 4K · 📦 150 · 📋 7K - 10% open · ⏱️ 15.09.2022):

	```
	git clone https://github.com/bokeh/bokeh
	```
- [PyPi](https://pypi.org/project/bokeh) (📥 4.1M / month · 📦 3.6K · ⏱️ 05.07.2022):
	```
	pip install bokeh
	```
- [Conda](https://anaconda.org/conda-forge/bokeh) (📥 8.5M · ⏱️ 15.08.2022):
	...
	```
- [npm](https://www.npmjs.com/package/@bokeh/bokehjs) (📥 13K / month · 📦 5 · ⏱️ 03.09.2022):
	```
...
- [GitHub](https://github.com/jupyter-widgets/ipywidgets) (👨‍💻 200 · 🔀 860 · 📦 4.9K · 📋 1.9K - 33% open · ⏱️ 13.09.2022):
...
- [PyPi](https://pypi.org/project/ipywidgets) (📥 7.6M / month · 📦 8.7K · ⏱️ 06.07.2022):
	...
	```
- [Conda](https://anaconda.org/conda-forge/ipywidgets) (📥 6.1M · ⏱️ 06.09.2022):
	```
	conda install -c conda-forge ipywidgets
	```
- [npm](https://www.npmjs.com/package/@jupyter-widgets/jupyterlab-manager) (📥 85K / month · 📦 82 · ⏱️ 02.09.2022):
	```
	npm install @jupyter-widgets/jupyterlab-manager
	```
</details>
<details><summary><b><a href="https://github.com/ydataai/pandas-profiling">pandas-profiling</a></b> (🥇38 ·  ⭐ 9.5K) - Create HTML profiling reports from pandas DataFrame objects. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/ydataai/pandas-profiling) (👨‍💻 95 · 🔀 1.4K · 📦 9K · 📋 590 - 19% open · ⏱️ 09.09.2022):
...
- [PyPi](https://pypi.org/project/pandas-profiling) (📥 1.2M / month · 📦 160 · ⏱️ 27.09.2021):
	...
	```
- [Conda](https://anaconda.org/conda-forge/pandas-profiling) (📥 280K · ⏱️ 13.09.2022):
	```
	conda install -c conda-forge pandas-profiling
	```
</details>
<details><summary><b><a href="https://github.com/holoviz/panel">panel</a></b> (🥇37 ·  ⭐ 2.1K) - A high-level app and dashboarding solution for Python. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/holoviz/panel) (👨‍💻 100 · 🔀 280 · 📦 4.1K · 📋 1.9K - 29% open · ⏱️ 15.09.2022):

	```
	git clone https://github.com/holoviz/panel
	```
- [PyPi](https://pypi.org/project/panel) (📥 420K / month · 📦 110 · ⏱️ 05.07.2022):
	```
	pip install panel
	```
- [Conda](https://anaconda.org/conda-forge/panel) (📥 620K · ⏱️ 24.05.2022):
	```
	conda install -c conda-forge panel
	```
- [npm](https://www.npmjs.com/package/@holoviz/panel) (📥 110K / month · ⏱️ 31.08.2022):
	```
...
- [GitHub](https://github.com/jupyter-widgets/ipyleaflet) (👨‍💻 80 · 🔀 340 · 📦 2.8K · 📋 520 - 39% open · ⏱️ 03.09.2022):

	```
	git clone https://github.com/jupyter-widgets/ipyleaflet
	```
- [PyPi](https://pypi.org/project/ipyleaflet) (📥 120K / month · 📦 110 · ⏱️ 07.07.2022):
	```
...
- [GitHub](https://github.com/nteract/papermill) (👨‍💻 100 · 🔀 370 · 📦 2.4K · 📋 350 - 30% open · ⏱️ 15.08.2022):

	```
	git clone https://github.com/nteract/papermill
	```
- [PyPi](https://pypi.org/project/papermill) (📥 820K / month · 📦 190 · ⏱️ 22.01.2022):
	```
...
- [GitHub](https://github.com/bqplot/bqplot) (👨‍💻 59 · 🔀 470 · 📦 35 · 📋 600 - 40% open · ⏱️ 02.09.2022):

	```
	git clone https://github.com/bqplot/bqplot
	```
- [PyPi](https://pypi.org/project/bqplot) (📥 89K / month · 📦 97 · ⏱️ 11.02.2022):
	```
	pip install bqplot
	```
- [Conda](https://anaconda.org/conda-forge/bqplot) (📥 1M · ⏱️ 02.09.2022):
	...
	```
- [npm](https://www.npmjs.com/package/bqplot) (📥 8.7K / month · 📦 11 · ⏱️ 02.09.2022):
	```
	npm install bqplot
	```
</details>
...
- [GitHub](https://github.com/evidentlyai/evidently) (👨‍💻 25 · 🔀 280 · 📦 660 · 📋 120 - 25% open · ⏱️ 15.09.2022):

	```
	git clone https://github.com/evidentlyai/evidently
	```
- [PyPi](https://pypi.org/project/evidently) (📥 210K / month · 📦 3 · ⏱️ 07.07.2022):
	```
...
- [GitHub](https://github.com/matplotlib/ipympl) (👨‍💻 28 · 🔀 190 · 📦 3.8K · 📋 260 - 45% open · ⏱️ 22.08.2022):

	```
	git clone https://github.com/matplotlib/ipympl
	```
- [PyPi](https://pypi.org/project/ipympl) (📥 210K / month · 📦 91 · ⏱️ 25.04.2022):
	```
	pip install ipympl
	```
- [Conda](https://anaconda.org/conda-forge/ipympl) (📥 1.1M · ⏱️ 22.08.2022):
	...
	```
- [npm](https://www.npmjs.com/package/jupyter-matplotlib) (📥 33K / month · ⏱️ 22.08.2022):
	```
...
- [GitHub](https://github.com/jupyter-widgets/pythreejs) (👨‍💻 30 · 🔀 180 · 📦 21 · 📋 220 - 25% open · ⏱️ 25.08.2022):
	...
	```
- [PyPi](https://pypi.org/project/pythreejs) (📥 73K / month · 📦 42 · ⏱️ 26.02.2021):
	```
	pip install pythreejs
	```
- [Conda](https://anaconda.org/conda-forge/pythreejs) (📥 410K · ⏱️ 06.09.2022):
	```
	conda install -c conda-forge pythreejs
	```
- [npm](https://www.npmjs.com/package/jupyter-threejs) (📥 5.5K / month · 📦 7 · ⏱️ 24.08.2022):
	```
...
- [GitHub](https://github.com/widgetti/ipyvolume) (👨‍💻 41 · 🔀 220 · 📦 850 · 📋 300 - 57% open · ⏱️ 26.07.2022):

	```
	git clone https://github.com/maartenbreddels/ipyvolume
	```
- [PyPi](https://pypi.org/project/ipyvolume) (📥 61K / month · 📦 50 · ⏱️ 29.10.2021):
	```
...
<details><summary><b><a href="https://github.com/microsoft/responsible-ai-toolbox">responsible-ai-widgets</a></b> (🥈28 ·  ⭐ 560) - This project provides responsible AI user interfaces.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/microsoft/responsible-ai-toolbox) (👨‍💻 29 · 🔀 140 · 📦 36 · 📋 270 - 19% open · ⏱️ 15.09.2022):
...
- [GitHub](https://github.com/plotly/jupyter-dash) (👨‍💻 10 · 🔀 210 · 📥 77 · 📦 1.9K · 📋 65 - 64% open · ⏱️ 28.06.2022):

	```
	git clone https://github.com/plotly/jupyter-dash
	```
- [PyPi](https://pypi.org/project/jupyter-dash) (📥 360K / month · 📦 39 · ⏱️ 01.04.2022):
	```
	pip install jupyter-dash
	```
- [Conda](https://anaconda.org/conda-forge/jupyter-dash) (📥 200K · ⏱️ 02.04.2022):
	```
...
- [GitHub](https://github.com/lux-org/lux) (👨‍💻 20 · 🔀 320 · 📦 110 · 📋 220 - 29% open · ⏱️ 21.05.2022):
	...
	```
- [PyPi](https://pypi.org/project/lux-api) (📥 26K / month · ⏱️ 19.02.2022):
	```
	pip install lux-api
	```
- [Conda](https://anaconda.org/conda-forge/lux-api) (📥 8.7K · ⏱️ 22.02.2022):
	```
...
<details><summary><b><a href="https://github.com/martinRenou/ipycanvas">ipycanvas</a></b> (🥈26 ·  ⭐ 630) - Interactive Canvas in Jupyter. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/martinRenou/ipycanvas) (👨‍💻 21 · 🔀 54 · 📦 830 · 📋 110 - 37% open · ⏱️ 29.08.2022):

	```
	git clone https://github.com/martinRenou/ipycanvas
	```
- [PyPi](https://pypi.org/project/ipycanvas) (📥 33K / month · 📦 21 · ⏱️ 03.05.2022):
	```
	pip install ipycanvas
	```
- [Conda](https://anaconda.org/conda-forge/ipycanvas) (📥 86K · ⏱️ 29.08.2022):
	```
...
- [GitHub](https://github.com/jpmorganchase/ipyregulartable) (👨‍💻 5 · 🔀 860 · 📦 10 · 📋 25 - 40% open · ⏱️ 25.08.2022):
...
- [PyPi](https://pypi.org/project/ipyregulartable) (📥 170 / month · ⏱️ 08.01.2021):
	...
	```
- [Conda](https://anaconda.org/conda-forge/ipyregulartable) (📥 2.9K · ⏱️ 08.01.2021):
	```
...
- [GitHub](https://github.com/timkpaine/ipydagred3) (👨‍💻 3 · 🔀 860 · 📦 12 · 📋 19 - 15% open · ⏱️ 21.07.2022):

	```
	git clone https://github.com/timkpaine/ipydagred3
	```
- [PyPi](https://pypi.org/project/ipydagred3) (📥 630 / month · 📦 1 · ⏱️ 06.05.2022):
	```
	pip install ipydagred3
	```
- [Conda](https://anaconda.org/conda-forge/ipydagred3) (📥 11K · ⏱️ 07.05.2022):
	```
...
- [GitHub](https://github.com/nglviewer/nglview) (👨‍💻 34 · 🔀 110 · 📥 240 · 📦 2 · 📋 440 - 7% open · ⏱️ 12.09.2022):
	...
	```
- [PyPi](https://pypi.org/project/nglview) (📥 4.8K / month · 📦 37 · ⏱️ 11.06.2021):
	```
	pip install nglview
	```
- [Conda](https://anaconda.org/conda-forge/nglview) (📥 480K · ⏱️ 11.06.2021):
	```
	conda install -c conda-forge nglview
	```
- [npm](https://www.npmjs.com/package/nglview-js-widgets) (📥 5.6K / month · 📦 2 · ⏱️ 16.04.2021):
	```
	npm install nglview-js-widgets
	```
</details>
<details><summary><b><a href="https://github.com/InsightSoftwareConsortium/itkwidgets">itkwidgets</a></b> (🥈25 ·  ⭐ 460) - Interactive Jupyter widgets to visualize images, point sets, and.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/InsightSoftwareConsortium/itkwidgets) (👨‍💻 21 · 🔀 63 · 📥 66 · 📋 200 - 44% open · ⏱️ 06.09.2022):

	```
	git clone https://github.com/InsightSoftwareConsortium/itkwidgets
	```
- [PyPi](https://pypi.org/project/itkwidgets) (📥 16K / month · 📦 14 · ⏱️ 16.06.2022):
	```
...
- [Conda](https://anaconda.org/conda-forge/itkwidgets) (📥 290K · ⏱️ 10.08.2020):
	...
	```
- [npm](https://www.npmjs.com/package/itkwidgets) (📥 1.3K / month · ⏱️ 11.07.2022):
	```
...
- [GitHub](https://github.com/cytoscape/ipycytoscape) (👨‍💻 32 · 🔀 55 · 📥 3 · 📦 79 · 📋 160 - 37% open · ⏱️ 12.09.2022):

	```
	git clone https://github.com/cytoscape/ipycytoscape
	```
- [PyPi](https://pypi.org/project/ipycytoscape) (📥 17K / month · 📦 10 · ⏱️ 04.04.2022):
	```
	pip install ipycytoscape
	```
- [Conda](https://anaconda.org/conda-forge/ipycytoscape) (📥 80K · ⏱️ 12.09.2022):
	```
...
- [GitHub](https://github.com/vega/ipyvega) (👨‍💻 11 · 🔀 59 · 📋 95 - 13% open · ⏱️ 01.09.2022):
	...
	```
- [PyPi](https://pypi.org/project/vega) (📥 7.5K / month · 📦 84 · ⏱️ 10.02.2022):
	```
	pip install vega
	```
...
<details><summary><b><a href="https://github.com/spacetelescope/jdaviz">jdaviz</a></b> (🥉24 ·  ⭐ 76) - JWST astronomical data analysis tools in the Jupyter platform. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/spacetelescope/jdaviz) (👨‍💻 29 · 🔀 36 · 📋 710 - 39% open · ⏱️ 15.09.2022):

	```
	git clone https://github.com/spacetelescope/jdaviz
	```
- [PyPi](https://pypi.org/project/jdaviz) (📥 2.6K / month · ⏱️ 06.07.2022):
	```
	pip install jdaviz
	```
</details>
<details><summary><b><a href="https://github.com/mwouts/itables">itables</a></b> (🥉23 ·  ⭐ 330) - Pandas DataFrames as Interactive DataTables. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/mwouts/itables) (👨‍💻 4 · 🔀 29 · 📦 140 · 📋 57 - 17% open · ⏱️ 06.09.2022):

	```
	git clone https://github.com/mwouts/itables
	```
- [PyPi](https://pypi.org/project/itables) (📥 14K / month · 📦 7 · ⏱️ 02.07.2022):
	```
	pip install itables
	```
- [Conda](https://anaconda.org/conda-forge/itables) (📥 3.8K · ⏱️ 04.09.2022):
	```
...
- [GitHub](https://github.com/widgetti/ipyvuetify) (👨‍💻 10 · 🔀 44 · 📦 4 · 📋 170 - 27% open · ⏱️ 02.09.2022):

	```
	git clone https://github.com/mariobuikhuizen/ipyvuetify
	```
- [PyPi](https://pypi.org/project/ipyvuetify) (📥 76K / month · 📦 26 · ⏱️ 07.02.2022):
	```
	pip install ipyvuetify
	```
- [Conda](https://anaconda.org/conda-forge/ipyvuetify) (📥 87K · ⏱️ 02.09.2022):
	```
	conda install -c conda-forge ipyvuetify
	```
- [npm](https://www.npmjs.com/package/jupyter-vuetify) (📥 8.2K / month · 📦 1 · ⏱️ 02.09.2022):
	```
...
- [GitHub](https://github.com/lgpage/nbtutor) (👨‍💻 3 · 🔀 38 · 📦 29 · 📋 43 - 44% open · ⏱️ 04.04.2022):
...
- [GitHub](https://github.com/QuantStack/ipysheet) (👨‍💻 11 · 🔀 62 · 📦 3 · 📋 120 - 51% open · ⏱️ 09.09.2022):

	```
	git clone https://github.com/QuantStack/ipysheet
	```
- [PyPi](https://pypi.org/project/ipysheet) (📥 51K / month · 📦 13 · ⏱️ 11.08.2021):
	```
	pip install ipysheet
	```
- [Conda](https://anaconda.org/conda-forge/ipysheet) (📥 57K · ⏱️ 11.08.2021):
	```
...
<details><summary><b><a href="https://github.com/vizzuhq/ipyvizzu">ipyvizzu</a></b> (🥉20 ·  ⭐ 490) - Build animated charts in Jupyter notebook with a simple Python.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/vizzuhq/ipyvizzu) (👨‍💻 8 · 🔀 36 · 📥 30 · 📦 2 · 📋 66 - 30% open · ⏱️ 12.08.2022):

	```
	git clone https://github.com/vizzuhq/ipyvizzu
	```
- [PyPi](https://pypi.org/project/ipyvizzu) (📥 230 / month · ⏱️ 30.06.2022):
	```
	pip install ipyvizzu
	```
</details>
<details><summary><b><a href="https://github.com/bloomberg/ipydatagrid">ipydatagrid</a></b> (🥉20 ·  ⭐ 250) - Fast Datagrid widget for the Jupyter Notebook and JupyterLab. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/bloomberg/ipydatagrid) (👨‍💻 12 · 🔀 31 · 📋 83 - 38% open · ⏱️ 03.08.2022):

	```
	git clone https://github.com/bloomberg/ipydatagrid
	```
- [PyPi](https://pypi.org/project/ipydatagrid) (📥 1.8K / month · 📦 3 · ⏱️ 20.04.2022):
	```
	pip install ipydatagrid
	```
- [Conda](https://anaconda.org/conda-forge/ipydatagrid) (📥 26K · ⏱️ 20.04.2022):
	```
	conda install -c conda-forge ipydatagrid
	```
- [npm](https://www.npmjs.com/package/ipydatagrid) (📥 410 / month · ⏱️ 20.04.2022):
	```
...
- [GitHub](https://github.com/timkpaine/tributary) (👨‍💻 7 · 🔀 32 · ⏱️ 05.07.2022):
	...
	```
- [PyPi](https://pypi.org/project/tributary) (📥 52 / month · ⏱️ 11.05.2022):
	```
...
- [GitHub](https://github.com/QuantStack/ipytree) (👨‍💻 8 · 🔀 26 · 📋 32 - 50% open · ⏱️ 23.08.2022):
	...
	```
- [PyPi](https://pypi.org/project/ipytree) (📥 34K / month · 📦 8 · ⏱️ 03.03.2021):
	```
	pip install ipytree
	```
- [Conda](https://anaconda.org/conda-forge/ipytree) (📥 47K · ⏱️ 23.08.2022):
	```
	conda install -c conda-forge ipytree
	```
- [npm](https://www.npmjs.com/package/ipytree) (📥 520 / month · ⏱️ 23.08.2022):
	```
	npm install ipytree
	```
</details>
...
- [PyPi](https://pypi.org/project/altair_viewer) (📥 680K / month · 📦 12 · ⏱️ 06.11.2021):
	...
	```
- [Conda](https://anaconda.org/conda-forge/altair_viewer) (📥 43K · ⏱️ 06.11.2021):
	```
...
<details><summary><b><a href="https://github.com/widgetti/ipyvue">ipyvue</a></b> (🥉17 ·  ⭐ 41 · 💤) - Jupyter widgets base for Vue libraries. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/widgetti/ipyvue) (👨‍💻 3 · 🔀 11 · 📦 20 · 📋 7 - 28% open · ⏱️ 10.12.2021):
	...
	```
- [PyPi](https://pypi.org/project/ipyvue) (📥 73K / month · 📦 12 · ⏱️ 28.10.2021):
	```
	pip install ipyvue
	```
- [Conda](https://anaconda.org/conda-forge/ipyvue) (📥 57K · ⏱️ 28.10.2021):
	```
...
<details><summary><b><a href="https://github.com/medialab/ipysigma">ipysigma</a></b> (🥉15 ·  ⭐ 40) - A Jupyter widget using sigma.js to render interactive networks. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/medialab/ipysigma) (👨‍💻 3 · 🔀 6 · 📋 110 - 46% open · ⏱️ 01.09.2022):

	```
	git clone https://github.com/Yomguithereal/ipysigma
	```
- [PyPi](https://pypi.org/project/ipysigma) (📥 150 / month · 📦 1 · ⏱️ 08.06.2022):
	```
	pip install ipysigma
	```
- [npm](https://www.npmjs.com/package/ipysigma) (📥 150 / month · ⏱️ 01.09.2022):
	```
...
- [GitHub](https://github.com/ipython-contrib/jupyter_contrib_nbextensions) (👨‍💻 130 · 🔀 770 · 📋 780 - 42% open · ⏱️ 17.07.2022):
	...
	```
- [PyPi](https://pypi.org/project/jupyter_contrib_nbextensions) (📥 350K / month · 📦 190 · ⏱️ 02.01.2019):
	```
...
- [GitHub](https://github.com/jupyter/nbgrader) (👨‍💻 97 · 🔀 310 · 📥 40 · 📋 820 - 25% open · ⏱️ 22.08.2022):

	```
	git clone https://github.com/jupyter/nbgrader
	```
- [PyPi](https://pypi.org/project/nbgrader) (📥 4.5K / month · 📦 17 · ⏱️ 06.07.2022):
	```
...
- [PyPi](https://pypi.org/project/jupyter-server-proxy) (📥 110K / month · 📦 100 · ⏱️ 24.01.2022):
	...
	```
- [Conda](https://anaconda.org/conda-forge/jupyter-server-proxy) (📥 870K · ⏱️ 08.09.2022):
	```
	conda install -c conda-forge jupyter-server-proxy
	```
- [npm](https://www.npmjs.com/package/@jupyterlab/server-proxy) (📥 9.3K / month · ⏱️ 08.09.2022):
	```
...
- [GitHub](https://github.com/jupyter-server/jupyter-resource-usage) (👨‍💻 24 · 🔀 76 · 📥 75 · 📋 64 - 57% open · ⏱️ 06.09.2022):

	```
	git clone https://github.com/jupyter-server/jupyter-resource-usage
	```
- [PyPi](https://pypi.org/project/jupyter-resource-usage) (📥 31K / month · 📦 3 · ⏱️ 06.12.2021):
	```
...
- [Conda](https://anaconda.org/conda-forge/nbresuse) (📥 510K · ⏱️ 23.11.2020):
	...
	```
- [npm](https://www.npmjs.com/package/@jupyter-server/resource-usage) (📥 600 / month · ⏱️ 24.08.2022):
	```
...
- [GitHub](https://github.com/jupyterhub/nbgitpuller) (👨‍💻 25 · 🔀 61 · 📦 520 · 📋 140 - 41% open · ⏱️ 22.06.2022):
	...
	```
- [PyPi](https://pypi.org/project/nbgitpuller) (📥 9.3K / month · 📦 18 · ⏱️ 19.03.2022):
	```
	pip install nbgitpuller
	```
- [Conda](https://anaconda.org/conda-forge/nbgitpuller) (📥 42K · ⏱️ 20.03.2022):
	```
	conda install -c conda-forge nbgitpuller
	```
</details>
<details><summary><b><a href="https://github.com/jupyterhub/jupyter-rsession-proxy">Rsession Proxy</a></b> (🥈20 ·  ⭐ 95) - Jupyter extensions for running an RStudio rsession proxy. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/jupyterhub/jupyter-rsession-proxy) (👨‍💻 21 · 🔀 79 · 📦 41 · 📋 75 - 38% open · ⏱️ 07.09.2022):

	```
	git clone https://github.com/jupyterhub/jupyter-rsession-proxy
	```
- [PyPi](https://pypi.org/project/jupyter-rsession-proxy) (📥 3K / month · 📦 1 · ⏱️ 01.12.2021):
	```
	pip install jupyter-rsession-proxy
	```
- [Conda](https://anaconda.org/conda-forge/jupyter-rsession-proxy) (📥 12K · ⏱️ 08.09.2022):
	```
...
- [GitHub](https://github.com/mamba-org/gator) (👨‍💻 25 · 🔀 26 · 📥 2 · 📦 1 · 📋 62 - 37% open · ⏱️ 25.07.2022):
	...
	```
- [PyPi](https://pypi.org/project/mamba-gator) (📥 78 / month · ⏱️ 03.09.2021):
	```
	pip install mamba-gator
	```
- [Conda](https://anaconda.org/conda-forge/mamba_gator) (📥 19K · ⏱️ 26.07.2022):
	```
	conda install -c conda-forge mamba_gator
	```
- [npm](https://www.npmjs.com/package/@mamba-org/gator-lab) (📥 110 / month · ⏱️ 03.09.2021):
	```
	npm install @mamba-org/gator-lab
	```
</details>
<details><summary><b><a href="https://github.com/jupyterlab-contrib/jupyter-archive">jupyter-archive</a></b> (🥉18 ·  ⭐ 57) - A Jupyter/Jupyterlab extension to make, download and extract.. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
- [GitHub](https://github.com/jupyterlab-contrib/jupyter-archive) (👨‍💻 9 · 🔀 10 · 📥 3.3K · 📋 33 - 3% open · ⏱️ 20.07.2022):
	...
	```
- [PyPi](https://pypi.org/project/jupyter-archive) (📥 2.6K / month · ⏱️ 08.04.2022):
	```
	pip install jupyter-archive
	```
- [Conda](https://anaconda.org/conda-forge/jupyter-archive) (📥 29K · ⏱️ 08.04.2022):
	```
	conda install -c conda-forge jupyter-archive
	```
- [npm](https://www.npmjs.com/package/@hadim/jupyter-archive) (📥 4.7K / month · ⏱️ 08.04.2022):
	```
...
- <b><a href="https://github.com/codota/jupyter-tabnine">jupyter-tabnine</a></b> (🥉16 ·  ⭐ 750 · 💀) - Autocompletion with Deep Learning on Jupyter Notebook. <code><a href="http://bit.ly/34MBwT8">MIT</a></code>
- <b><a href="https://github.com/data-8/nbzip">nbzip</a></b> (🥉16 ·  ⭐ 79 · 💀) - Zips and downloads all the contents of a jupyter notebook. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code>
...
- [GitHub](https://github.com/catherinedevlin/ipython-sql) (👨‍💻 53 · 🔀 260 · 📦 3.4K · 📋 140 - 72% open · ⏱️ 12.06.2022):
...
- [PyPi](https://pypi.org/project/sparkmagic) (📥 32K / month · 📦 20 · ⏱️ 02.05.2022):
	...
	```
- [Conda](https://anaconda.org/conda-forge/sparkmagic) (📥 53K · ⏱️ 09.05.2022):
	```
...
- [GitHub](https://github.com/rasbt/watermark) (👨‍💻 19 · 🔀 81 · 📦 1.6K · 📋 45 - 37% open · ⏱️ 13.09.2022):
	...
	```
- [PyPi](https://pypi.org/project/watermark) (📥 39K / month · 📦 79 · ⏱️ 27.05.2022):
	```
...
- [GitHub](https://github.com/rossant/ipycache) (👨‍💻 10 · 🔀 24 · 📦 23 · 📋 39 - 43% open · ⏱️ 22.08.2022):
	...
	```
- [PyPi](https://pypi.org/project/ipycache) (📥 180 / month · 📦 6 · ⏱️ 13.10.2013):
	```
...
- [PyPi](https://pypi.org/project/blackcellmagic) (📥 2.9K / month · 📦 3 · ⏱️ 18.09.2021):
	...
	```
- [Conda](https://anaconda.org/conda-forge/blackcellmagic) (📥 1.8K · ⏱️ 07.08.2020):
	```
...
- [GitHub](https://github.com/ResidentMario/py_d3) (👨‍💻 4 · 🔀 39 · 📋 16 - 6% open · ⏱️ 20.02.2022):
	...
	```
- [PyPi](https://pypi.org/project/py_d3) (📥 110 / month · ⏱️ 28.03.2018):
	```
	pip install py_d3
	```
</details>
...
<details><summary><b><a href="https://github.com/ipython/ipykernel">IPython Kernel</a></b> (🥇36 ·  ⭐ 500) - IPython Kernel for Jupyter. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/ipython/ipykernel) (👨‍💻 160 · 🔀 320 · 📥 550 · 📋 440 - 53% open · ⏱️ 13.09.2022):
...
- [PyPi](https://pypi.org/project/ipykernel) (📥 10M / month · 📦 9.6K · ⏱️ 15.06.2022):
	...
	```
- [Conda](https://anaconda.org/anaconda/ipykernel) (📥 410K · 📦 33 · ⏱️ 06.09.2022):
	```
...
- [GitHub](https://github.com/Calysto/metakernel) (👨‍💻 31 · 🔀 79 · 📥 45 · 📋 140 - 20% open · ⏱️ 09.08.2022):

	```
	git clone https://github.com/Calysto/metakernel
	```
- [PyPi](https://pypi.org/project/metakernel) (📥 78K / month · 📦 75 · ⏱️ 29.03.2022):
	```
	pip install metakernel
	```
- [Conda](https://anaconda.org/conda-forge/metakernel) (📥 610K · ⏱️ 09.08.2022):
	```
	conda install -c conda-forge metakernel
	```
</details>
<details><summary><b><a href="https://github.com/jupyter-server/enterprise_gateway">Enterprise Gateway</a></b> (🥇25 ·  ⭐ 530) - A lightweight, multi-tenant, scalable and secure gateway.. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/jupyter-server/enterprise_gateway) (👨‍💻 100 · 🔀 190 · 📥 21K · 📋 520 - 9% open · ⏱️ 09.09.2022):
...
<details><summary><b><a href="https://github.com/lfortran/lfortran">LFortran</a></b> (🥇25 ·  ⭐ 380) - Official main repository for LFortran. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/lfortran/lfortran) (👨‍💻 39 · 🔀 41 · 📋 490 - 92% open · ⏱️ 14.09.2022):
...
- [PyPi](https://pypi.org/project/lfortran) (📥 84 / month · ⏱️ 31.07.2020):
	...
	```
- [Conda](https://anaconda.org/conda-forge/lfortran) (📥 41K · ⏱️ 23.09.2021):
	```
...
- [GitHub](https://github.com/n-riesco/ijavascript) (👨‍💻 15 · 🔀 180 · 📦 63 · 📋 230 - 23% open · ⏱️ 24.01.2022):
...
- [GitHub](https://github.com/almond-sh/almond) (👨‍💻 36 · 🔀 230 · 📥 1.3K · 📋 310 - 35% open · ⏱️ 13.09.2022):
...
- [GitHub](https://github.com/IHaskell/IHaskell) (👨‍💻 110 · 🔀 250 · 📋 740 - 4% open · ⏱️ 12.09.2022):

	```
	git clone https://github.com/gibiansky/IHaskell
	```
- [npm](https://www.npmjs.com/package/ihaskell_jupyterlab) (📥 17 / month · ⏱️ 01.08.2018):
	```
...
- [GitHub](https://github.com/IRkernel/IRkernel) (👨‍💻 42 · 🔀 290 · 📋 570 - 10% open · ⏱️ 03.09.2022):

	```
	git clone https://github.com/IRkernel/IRkernel
	```
- [Conda](https://anaconda.org/r/r-irkernel) (📥 86K · ⏱️ 31.05.2022):
	```
	conda install -c r r-irkernel
	```
- [Docker Hub](https://hub.docker.com/r/jupyter/r-notebook) (📥 1.4M · ⭐ 45 · ⏱️ 12.09.2022):
	```
...
- [GitHub](https://github.com/apache/incubator-toree) (👨‍💻 100 · 🔀 210 · ⏱️ 15.03.2022):
	...
	```
- [PyPi](https://pypi.org/project/toree) (📥 13K / month · 📦 9 · ⏱️ 21.04.2022):
	```
	pip install toree
	```
</details>
...
- [GitHub](https://github.com/takluyver/bash_kernel) (👨‍💻 15 · 🔀 120 · 📋 100 - 41% open · ⏱️ 26.08.2022):
	...
	```
- [PyPi](https://pypi.org/project/bash_kernel) (📥 6.9K / month · 📦 28 · ⏱️ 22.07.2019):
	```
	pip install bash_kernel
	```
- [Conda](https://anaconda.org/conda-forge/bash_kernel) (📥 73K · ⏱️ 24.08.2022):
	```
...
- [GitHub](https://github.com/jupyter-server/kernel_gateway) (👨‍💻 44 · 🔀 120 · 📥 100 · 📋 180 - 7% open · ⏱️ 12.03.2022):
	...
	```
- [PyPi](https://pypi.org/project/jupyter-kernel-gateway) (📥 14K / month · 📦 6 · ⏱️ 24.08.2021):
	```
...
- [GitHub](https://github.com/jupyter-xeus/xeus-python) (👨‍💻 20 · 🔀 62 · 📋 180 - 32% open · ⏱️ 07.09.2022):

	```
	git clone https://github.com/jupyter-xeus/xeus-python
	```
- [PyPi](https://pypi.org/project/xeus-python) (📥 8.8K / month · 📦 3 · ⏱️ 15.06.2022):
	```
...
- [GitHub](https://github.com/Calysto/octave_kernel) (👨‍💻 18 · 🔀 61 · 📥 50 · 📋 170 - 17% open · ⏱️ 21.08.2022):
	...
	```
- [PyPi](https://pypi.org/project/octave_kernel) (📥 13K / month · 📦 7 · ⏱️ 31.03.2022):
	```
...
- [GitHub](https://github.com/Calysto/matlab_kernel) (👨‍💻 18 · 🔀 73 · 📋 130 - 20% open · ⏱️ 09.05.2022):
	...
	```
- [PyPi](https://pypi.org/project/matlab_kernel) (📥 3.8K / month · 📦 5 · ⏱️ 09.05.2022):
	```
	pip install matlab_kernel
	```
- [Conda](https://anaconda.org/conda-forge/matlab_kernel) (📥 20K · ⏱️ 09.05.2022):
	```
...
- [GitHub](https://github.com/akabe/ocaml-jupyter) (👨‍💻 18 · 🔀 30 · 📥 71K · 📋 73 - 6% open · ⏱️ 10.04.2022):
...
- [GitHub](https://github.com/sassoftware/sas_kernel) (👨‍💻 9 · 🔀 74 · 📋 57 - 5% open · ⏱️ 01.06.2022):
	...
	```
- [PyPi](https://pypi.org/project/sas_kernel) (📥 1.8K / month · 📦 1 · ⏱️ 14.07.2021):
	```
...
- [GitHub](https://github.com/scijava/scijava-jupyter-kernel) (👨‍💻 9 · 🔀 42 · 📥 86 · 📋 94 - 14% open · ⏱️ 03.02.2022):
	...
	```
- [Conda](https://anaconda.org/conda-forge/scijava-jupyter-kernel) (📥 82K · ⏱️ 03.03.2018):
	```
	conda install -c conda-forge scijava-jupyter-kernel
	```
</details>
<details><summary><b><a href="https://github.com/WolframResearch/WolframLanguageForJupyter">Wolfram Kernel</a></b> (🥉16 ·  ⭐ 760 · 💤) - Wolfram Language kernel for Jupyter notebooks. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/WolframResearch/WolframLanguageForJupyter) (👨‍💻 7 · 🔀 94 · 📥 6.3K · 📋 97 - 31% open · ⏱️ 19.02.2022):
...
<details><summary><b><a href="https://github.com/minrk/allthekernels">allthekernels</a></b> (🥉16 ·  ⭐ 68) - A multiplexer kernel for Jupyter. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [PyPi](https://pypi.org/project/allthekernels) (📥 140 / month · ⏱️ 10.12.2019):
	...
	```
- [Conda](https://anaconda.org/conda-forge/allthekernels) (📥 4.2K · ⏱️ 22.08.2022):
	```
...
- [GitHub](https://github.com/jupyter-xeus/xeus-sqlite) (👨‍💻 12 · 🔀 22 · 📋 43 - 30% open · ⏱️ 15.03.2022):
	...
	```
- [Conda](https://anaconda.org/conda-forge/xeus-sqlite) (📥 17K · ⏱️ 06.10.2021):
	```
...
- [GitHub](https://github.com/NII-cloud-operation/sshkernel) (👨‍💻 4 · 🔀 12 · 📦 6 · 📋 8 - 25% open · ⏱️ 04.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/sshkernel) (📥 75 / month · ⏱️ 04.11.2021):
	```
...
- <b><a href="https://github.com/SpencerPark/IJava">IJava</a></b> (🥉18 ·  ⭐ 820 · 💀) - A Jupyter kernel for executing Java code. <code><a href="http://bit.ly/34MBwT8">MIT</a></code>
- <b><a href="https://github.com/Anaconda-Platform/nb_conda_kernels">nb_conda_kernels</a></b> (🥉18 ·  ⭐ 470 · 💀) - Package for managing conda environment-based kernels.. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code>
...
- <b><a href="https://github.com/tdaff/remote_ikernel">remote_ikernel</a></b> (🥉10 ·  ⭐ 12 · 💀) - All your Jupyter kernels, on all your machines, in one place. <code><a href="http://bit.ly/3rqEWVr">BSD-2</a></code>
...
<details><summary><b><a href="https://github.com/voila-dashboards/voila">Voila</a></b> (🥇34 ·  ⭐ 4.3K) - Voil turns Jupyter notebooks into standalone web applications. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/voila-dashboards/voila) (👨‍💻 62 · 🔀 420 · 📥 300 · 📦 7.3K · 📋 630 - 42% open · ⏱️ 08.09.2022):

	```
	git clone https://github.com/voila-dashboards/voila
	```
- [PyPi](https://pypi.org/project/voila) (📥 76K / month · 📦 62 · ⏱️ 29.03.2022):
	```
	pip install voila
	```
- [Conda](https://anaconda.org/conda-forge/voila) (📥 210K · ⏱️ 18.07.2022):
	...
	```
- [npm](https://www.npmjs.com/package/@jupyter-voila/jupyterlab-preview) (📥 2.1K / month · ⏱️ 19.05.2020):
	```
...
- [GitHub](https://github.com/mwouts/jupytext) (👨‍💻 72 · 🔀 360 · 📦 3.3K · 📋 540 - 13% open · ⏱️ 29.07.2022):
...
- [PyPi](https://pypi.org/project/jupytext) (📥 270K / month · 📦 160 · ⏱️ 03.07.2022):
	...
	```
- [Conda](https://anaconda.org/conda-forge/jupytext) (📥 390K · ⏱️ 03.07.2022):
	```
	conda install -c conda-forge jupytext
	```
- [npm](https://www.npmjs.com/package/jupyterlab-jupytext) (📥 6.4K / month · ⏱️ 04.12.2021):
	```
	npm install jupyterlab-jupytext
	```
</details>
<details><summary><b><a href="https://github.com/executablebooks/jupyter-book">Jupyter Book</a></b> (🥈31 ·  ⭐ 3K) - Create beautiful, publication-quality books and documents from.. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/executablebooks/jupyter-book) (👨‍💻 110 · 🔀 540 · 📋 1.1K - 41% open · ⏱️ 21.08.2022):

	```
	git clone https://github.com/executablebooks/jupyter-book
	```
- [PyPi](https://pypi.org/project/jupyter-book) (📥 59K / month · 📦 65 · ⏱️ 03.06.2022):
	```
	pip install jupyter-book
	```
- [Conda](https://anaconda.org/conda-forge/jupyter-book) (📥 32K · ⏱️ 22.08.2022):
	```
	conda install -c conda-forge jupyter-book
	```
</details>
<details><summary><b><a href="https://github.com/jupyter/nbdime">nbdime</a></b> (🥈30 ·  ⭐ 2.3K) - Tools for diffing and merging of Jupyter notebooks. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/jupyter/nbdime) (👨‍💻 40 · 🔀 130 · 📦 81 · 📋 290 - 23% open · ⏱️ 05.07.2022):
...
- [PyPi](https://pypi.org/project/nbdime) (📥 240K / month · 📦 140 · ⏱️ 25.10.2021):
	...
	pip install nbdime
	```
- [Conda](https://anaconda.org/conda-forge/nbdime) (📥 630K · ⏱️ 26.10.2021):
	```
	conda install -c conda-forge nbdime
	```
- [npm](https://www.npmjs.com/package/nbdime-jupyterlab) (📥 240K / month · ⏱️ 26.10.2021):
	```
...
- [Conda](https://anaconda.org/conda-forge/rise) (📥 220K · ⏱️ 16.11.2021):
	...
	```
- [npm](https://www.npmjs.com/package/rise-reveal) (📥 6 / month · ⏱️ 03.07.2019):
	```
...
- [GitHub](https://github.com/airbnb/knowledge-repo) (👨‍💻 68 · 🔀 690 · 📋 290 - 42% open · ⏱️ 17.08.2022):

	```
	git clone https://github.com/airbnb/knowledge-repo
	```
- [PyPi](https://pypi.org/project/knowledge-repo) (📥 210 / month · 📦 1 · ⏱️ 20.04.2022):
	```
...
<details><summary><b><a href="https://github.com/jupyterhub/binderhub">BinderHub</a></b> (🥉23 ·  ⭐ 2.2K) - Run your code in the cloud, with technology so advanced, it feels.. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/jupyterhub/binderhub) (👨‍💻 84 · 🔀 320 · 📦 6 · 📋 720 - 37% open · ⏱️ 04.09.2022):
...
- [GitHub](https://github.com/greenape/mknotebooks) (👨‍💻 13 · 🔀 20 · 📦 220 · 📋 36 - 30% open · ⏱️ 12.09.2022):
...
- [GitHub](https://github.com/nteract/scrapbook) (👨‍💻 11 · 🔀 26 · 📦 150 · 📋 49 - 48% open · ⏱️ 13.04.2022):
	...
	```
- [PyPi](https://pypi.org/project/nteract-scrapbook) (📥 84K / month · 📦 17 · ⏱️ 06.01.2021):
	```
	pip install nteract-scrapbook
	```
- [Conda](https://anaconda.org/conda-forge/nteract-scrapbook) (📥 10K · ⏱️ 27.02.2021):
	```
	conda install -c conda-forge nteract-scrapbook
	```
</details>
<details><summary><b><a href="https://github.com/danielfrg/mkdocs-jupyter">mkdocs-jupyter</a></b> (🥉22 ·  ⭐ 160) - Use Jupyter Notebook in mkdocs. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/danielfrg/mkdocs-jupyter) (👨‍💻 13 · 🔀 24 · 📋 59 - 25% open · ⏱️ 04.05.2022):
...
- [PyPi](https://pypi.org/project/mkdocs-jupyter) (📥 22K / month · 📦 18 · ⏱️ 09.05.2022):
	...
	```
- [Conda](https://anaconda.org/conda-forge/mkdocs-jupyter) (📥 22K · ⏱️ 02.08.2022):
	```
...
- [GitHub](https://github.com/executablebooks/thebe) (👨‍💻 26 · 🔀 57 · 📦 5 · 📋 150 - 42% open · ⏱️ 19.11.2021):
	...
	```
- [npm](https://www.npmjs.com/package/thebe) (📥 7.4K / month · ⏱️ 05.08.2022):
	```
	npm install thebe
	```
</details>
...
- [GitHub](https://github.com/ideonate/cdsdashboards) (👨‍💻 14 · 🔀 35 · 📋 89 - 34% open · ⏱️ 12.09.2022):

	```
	git clone https://github.com/ideonate/cdsdashboards
	```
- [PyPi](https://pypi.org/project/cdsdashboards) (📥 340 / month · ⏱️ 29.04.2022):
	```
	pip install cdsdashboards
	```
- [Conda](https://anaconda.org/conda-forge/cdsdashboards) (📥 32K · ⏱️ 12.09.2022):
	```
...
<details><summary><b><a href="https://github.com/danielfrg/jupyter-flex">jupyter-flex</a></b> (🥉17 ·  ⭐ 260) - Build dashboards using Jupyter Notebooks. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/danielfrg/jupyter-flex) (👨‍💻 4 · 🔀 47 · 📦 1 · 📋 56 - 21% open · ⏱️ 22.06.2022):
...
- [PyPi](https://pypi.org/project/jupyter-flex) (📥 930 / month · ⏱️ 29.09.2021):
	...
	```
- [Conda](https://anaconda.org/conda-forge/jupyter-flex) (📥 8.7K · ⏱️ 01.10.2021):
	```
	conda install -c conda-forge jupyter-flex
	```
- [npm](https://www.npmjs.com/package/@danielfrg/jupyter-flex) (📥 210 / month · ⏱️ 02.10.2021):
	```
...
- [GitHub](https://github.com/jupyter/jupyter_client) (👨‍💻 120 · 🔀 240 · 📥 340 · 📋 340 - 45% open · ⏱️ 13.09.2022):
...
- [PyPi](https://pypi.org/project/jupyter-client) (📥 12M / month · 📦 2.2K · ⏱️ 08.06.2022):
	...
	```
- [Conda](https://anaconda.org/conda-forge/jupyter_client) (📥 9.7M · ⏱️ 26.08.2022):
	```
	conda install -c conda-forge jupyter_client
	```
</details>
<details><summary><b><a href="https://github.com/fastai/nbdev">nbdev</a></b> (🥇34 ·  ⭐ 3.7K) - Create delightful software with Jupyter Notebooks. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/fastai/nbdev) (👨‍💻 58 · 🔀 370 · 📋 640 - 6% open · ⏱️ 15.09.2022):

	```
	git clone https://github.com/fastai/nbdev
	```
- [PyPi](https://pypi.org/project/nbdev) (📥 110K / month · 📦 77 · ⏱️ 17.06.2022):
	```
	pip install nbdev
	```
</details>
...
- [GitHub](https://github.com/jupyter/nbformat) (👨‍💻 67 · 🔀 140 · 📋 120 - 39% open · ⏱️ 13.09.2022):

	```
	git clone https://github.com/jupyter/nbformat
	```
- [PyPi](https://pypi.org/project/nbformat) (📥 8.6M / month · 📦 8.6K · ⏱️ 03.05.2022):
	```
	pip install nbformat
	```
- [Conda](https://anaconda.org/conda-forge/nbformat) (📥 10M · ⏱️ 13.09.2022):
	```
	conda install -c conda-forge nbformat
	```
- [npm](https://www.npmjs.com/package/nbformat-schema) (📥 250 / month · ⏱️ 17.08.2022):
	```
...
- [GitHub](https://github.com/jupyter/nbclient) (👨‍💻 33 · 🔀 48 · 📥 92 · 📦 69K · 📋 100 - 39% open · ⏱️ 09.09.2022):

	```
	git clone https://github.com/jupyter/nbclient
	```
- [PyPi](https://pypi.org/project/nbclient) (📥 8.3M / month · 📦 86 · ⏱️ 01.07.2022):
	```
	pip install nbclient
	```
- [Conda](https://anaconda.org/conda-forge/nbclient) (📥 5.4M · ⏱️ 09.09.2022):
	```
...
- [GitHub](https://github.com/jupyterhub/repo2docker) (👨‍💻 110 · 🔀 300 · 📦 160 · 📋 500 - 34% open · ⏱️ 08.09.2022):
	...
	```
- [PyPi](https://pypi.org/project/jupyter-repo2docker) (📥 5.5K / month · 📦 25 · ⏱️ 06.02.2022):
	```
...
- [GitHub](https://github.com/computationalmodelling/nbval) (👨‍💻 31 · 🔀 43 · 📦 1.7K · 📋 99 - 36% open · ⏱️ 12.09.2022):
...
- [GitHub](https://github.com/fastai/fastpages) (👨‍💻 55 · 🔀 780 · 📦 140 · 📋 330 - 7% open · ⏱️ 15.05.2022):

	```
	git clone https://github.com/fastai/fastpages
	```
</details>
<details><summary><b><a href="https://github.com/nbQA-dev/nbQA">nbQA</a></b> (🥈24 ·  ⭐ 580) - Run isort, pyupgrade, mypy, pylint, flake8, and more on Jupyter Notebooks. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/nbQA-dev/nbQA) (👨‍💻 26 · 🔀 32 · 📋 260 - 0% open · ⏱️ 13.09.2022):

	```
	git clone https://github.com/nbQA-dev/nbQA
	```
- [PyPi](https://pypi.org/project/nbqa) (📥 37K / month · 📦 4 · ⏱️ 09.03.2022):
	```
	pip install nbqa
	```
- [Conda](https://anaconda.org/conda-forge/nbqa) (📥 48K · ⏱️ 17.07.2022):
	```
...
- [GitHub](https://github.com/chmp/ipytest) (👨‍💻 4 · 🔀 19 · 📦 200 · 📋 51 - 5% open · ⏱️ 20.02.2022):

	```
	git clone https://github.com/chmp/ipytest
	```
- [PyPi](https://pypi.org/project/ipytest) (📥 38K / month · 📦 13 · ⏱️ 12.02.2022):
	```
	pip install ipytest
	```
</details>
...
- [GitHub](https://github.com/ReviewNB/treon) (👨‍💻 5 · 🔀 25 · 📦 55 · 📋 14 - 28% open · ⏱️ 04.08.2022):
	...
	```
- [PyPi](https://pypi.org/project/treon) (📥 9.4K / month · 📦 5 · ⏱️ 28.11.2019):
	```
	pip install treon
	```
- [Conda](https://anaconda.org/conda-forge/treon) (📥 1.3K · ⏱️ 05.08.2022):
	```
...
- [GitHub](https://github.com/jupyter-naas/naas) (👨‍💻 18 · 🔀 20 · 📦 3 · 📋 140 - 20% open · ⏱️ 13.09.2022):

	```
	git clone https://github.com/jupyter-naas/naas
	```
- [PyPi](https://pypi.org/project/naas) (📥 4.3K / month · ⏱️ 07.07.2022):
	```
	pip install naas
	```
</details>
...
- [PyPi](https://pypi.org/project/nteract-testbook) (📥 12 / month · ⏱️ 11.08.2020):
	...
	```
- [Conda](https://anaconda.org/conda-forge/testbook) (📥 31K · ⏱️ 02.06.2021):
	```
	conda install -c conda-forge testbook
	```
</details>
<details><summary><b><a href="https://github.com/tweag/jupyterWith">JupyterWith</a></b> (🥉16 ·  ⭐ 360) - Declarative and reproducible Jupyter environments - powered by Nix. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/tweag/jupyterWith) (👨‍💻 31 · 🔀 81 · 📋 140 - 27% open · ⏱️ 29.08.2022):
...
- [GitHub](https://github.com/stas00/ipyexperiments) (👨‍💻 3 · 🔀 11 · 📦 6 · 📋 6 - 16% open · ⏱️ 07.12.2021):
	...
	```
- [PyPi](https://pypi.org/project/ipyexperiments) (📥 230 / month · 📦 2 · ⏱️ 07.12.2021):
	```
...
- <b><a href="https://github.com/mljar/mercury">mercury</a></b> (🥉23 ·  ⭐ 1.9K) - Convert Python notebook to web app and share with non-technical.. <code>❗Unlicensed</code>
- <b><a href="https://github.com/takluyver/nbopen">nbopen</a></b> (🥉17 ·  ⭐ 280 · 💀) - Open a Jupyter notebook in the best available server. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code>
...
- [PyPi](https://pypi.org/project/jupyterlab_latex) (📥 3.3K / month · 📦 1 · ⏱️ 15.09.2021):
	...
	```
- [Conda](https://anaconda.org/conda-forge/jupyterlab-latex) (📥 5.1K · ⏱️ 15.09.2021):
	```
	conda install -c conda-forge jupyterlab-latex
	```
- [npm](https://www.npmjs.com/package/@jupyterlab/latex) (📥 990 / month · ⏱️ 06.07.2021):
	```
...
- [GitHub](https://github.com/jupyterlab/jupyter-renderers) (👨‍💻 27 · 🔀 67 · 📦 1 · 📋 100 - 31% open · ⏱️ 08.07.2022):
	...
	```
- [PyPi](https://pypi.org/project/jupyterlab-katex) (📥 230 / month · ⏱️ 17.01.2022):
	```
	pip install jupyterlab-katex
	```
- [Conda](https://anaconda.org/conda-forge/jupyterlab-vega3) (📥 1.6K · ⏱️ 18.01.2022):
	```
...
- [GitHub](https://github.com/telamonian/theme-darcula) (👨‍💻 7 · 🔀 35 · 📦 560 · 📋 34 - 52% open · ⏱️ 20.07.2022):
...
- [PyPi](https://pypi.org/project/theme-darcula) (📥 1.4K / month · ⏱️ 26.08.2021):
	...
	```
- [Conda](https://anaconda.org/conda-forge/theme-darcula) (📥 8.2K · ⏱️ 20.07.2022):
	```
	conda install -c conda-forge theme-darcula
	```
- [npm](https://www.npmjs.com/package/@telamonian/theme-darcula) (📥 1.4K / month · ⏱️ 20.07.2022):
	```
	npm install @telamonian/theme-darcula
	```
</details>
<details><summary><b><a href="https://github.com/AllanChain/jupyterlab-theme-solarized-dark">jupyterlab-theme-solarized-dark</a></b> (🥈14 ·  ⭐ 67) - JupyterLab 2/3 Solarized Dark extension. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
- [GitHub](https://github.com/AllanChain/jupyterlab-theme-solarized-dark) (👨‍💻 2 · 🔀 9 · 📋 3 - 33% open · ⏱️ 21.07.2022):
	...
	```
- [PyPi](https://pypi.org/project/jupyterlab_theme_solarized_dark) (📥 7.1K / month · ⏱️ 22.06.2022):
	```
	pip install jupyterlab_theme_solarized_dark
	```
- [npm](https://www.npmjs.com/package/jupyterlab-theme-solarized-dark) (📥 3.4K / month · ⏱️ 22.06.2022):
	```
...
- [GitHub](https://github.com/yeebc/jupyterlab-neon-theme) (👨‍💻 4 · 🔀 9 · 📦 1 · 📋 12 - 8% open · ⏱️ 28.08.2022):
	...
	```
- [npm](https://www.npmjs.com/package/@yeebc/jupyterlab_neon_theme) (📥 820 / month · ⏱️ 07.03.2021):
	```
	npm install @yeebc/jupyterlab_neon_theme
	```
</details>
<details><summary><b><a href="https://github.com/dunovank/jupyterlab_darkside_ui">jupyterlab_darkside_ui</a></b> (🥈12 ·  ⭐ 92) - Darkside ui and syntax theme for jupyterlab. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
- [GitHub](https://github.com/elyra-ai/elyra) (👨‍💻 55 · 🔀 260 · 📦 36 · 📋 1.5K - 15% open · ⏱️ 13.09.2022):

	```
	git clone https://github.com/elyra-ai/elyra
	```
- [PyPi](https://pypi.org/project/elyra) (📥 3.3K / month · 📦 3 · ⏱️ 06.07.2022):
	```
	pip install elyra
	```
- [Conda](https://anaconda.org/conda-forge/elyra) (📥 19K · ⏱️ 02.09.2022):
	```
	conda install -c conda-forge elyra
	```
- [npm](https://www.npmjs.com/package/@elyra/services) (📥 3.2K / month · 📦 4 · ⏱️ 01.09.2022):
	```
...
- [GitHub](https://github.com/finos/perspective) (👨‍💻 72 · 🔀 510 · 📦 4 · 📋 560 - 16% open · ⏱️ 30.08.2022):

	```
	git clone https://github.com/finos/perspective
	```
- [PyPi](https://pypi.org/project/perspective-python) (📥 3.7K / month · 📦 9 · ⏱️ 06.06.2022):
	```
...
- [Conda](https://anaconda.org/conda-forge/perspective) (📥 140K · ⏱️ 10.09.2022):
	...
	```
- [npm](https://www.npmjs.com/package/@finos/perspective-jupyterlab) (📥 1.5K / month · ⏱️ 26.08.2022):
	```
...
- [GitHub](https://github.com/jupyter-lsp/jupyterlab-lsp) (👨‍💻 44 · 🔀 110 · 📦 220 · 📋 440 - 38% open · ⏱️ 03.09.2022):

	```
	git clone https://github.com/jupyter-lsp/jupyterlab-lsp
	```
- [PyPi](https://pypi.org/project/jupyterlab-lsp) (📥 27K / month · 📦 7 · ⏱️ 21.03.2022):
	```
	pip install jupyterlab-lsp
	```
- [Conda](https://anaconda.org/conda-forge/jupyter-lsp) (📥 54K · ⏱️ 12.12.2021):
	```
	conda install -c conda-forge jupyter-lsp
	```
- [npm](https://www.npmjs.com/package/@krassowski/jupyterlab-lsp) (📥 5.4K / month · 📦 2 · ⏱️ 26.08.2022):
	```
...
- [GitHub](https://github.com/jupyterlab/jupyterlab-git) (👨‍💻 77 · 🔀 250 · 📦 16 · 📋 530 - 15% open · ⏱️ 07.09.2022):
...
- [PyPi](https://pypi.org/project/jupyterlab-git) (📥 140K / month · 📦 20 · ⏱️ 26.04.2022):
	...
	```
- [Conda](https://anaconda.org/conda-forge/jupyterlab-git) (📥 250K · ⏱️ 06.09.2022):
	```
	conda install -c conda-forge jupyterlab-git
	```
- [npm](https://www.npmjs.com/package/@jupyterlab/git) (📥 31K / month · 📦 4 · ⏱️ 06.09.2022):
	```
	npm install @jupyterlab/git
	```
</details>
<details><summary><b><a href="https://github.com/ryantam626/jupyterlab_code_formatter">Code Formatter</a></b> (🥈24 ·  ⭐ 600) - A JupyterLab plugin to facilitate invocation of code formatters. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/ryantam626/jupyterlab_code_formatter) (👨‍💻 37 · 🔀 50 · 📋 160 - 14% open · ⏱️ 11.08.2022):
	...
	```
- [PyPi](https://pypi.org/project/jupyterlab_code_formatter) (📥 33K / month · 📦 7 · ⏱️ 01.05.2022):
	```
	pip install jupyterlab_code_formatter
	```
- [Conda](https://anaconda.org/conda-forge/jupyterlab_code_formatter) (📥 550K · ⏱️ 11.08.2022):
	```
	conda install -c conda-forge jupyterlab_code_formatter
	```
- [npm](https://www.npmjs.com/package/@ryantam626/jupyterlab_code_formatter) (📥 3.7K / month · ⏱️ 10.08.2022):
	```
...
- [GitHub](https://github.com/jtpio/jupyterlab-system-monitor) (👨‍💻 7 · 🔀 29 · 📦 52 · 📋 48 - 56% open · ⏱️ 15.02.2022):
...
- [PyPi](https://pypi.org/project/jupyterlab-system-monitor) (📥 11K / month · 📦 2 · ⏱️ 04.02.2021):
	...
	```
- [Conda](https://anaconda.org/conda-forge/jupyterlab-system-monitor) (📥 13K · ⏱️ 02.09.2022):
	```
...
- [GitHub](https://github.com/dask/dask-labextension) (👨‍💻 19 · 🔀 51 · 📋 130 - 29% open · ⏱️ 21.06.2022):

	```
	git clone https://github.com/dask/dask-labextension
	```
- [PyPi](https://pypi.org/project/dask-labextension) (📥 13K / month · 📦 4 · ⏱️ 21.06.2022):
	```
	pip install dask-labextension
	```
- [Conda](https://anaconda.org/conda-forge/dask-labextension) (📥 650K · ⏱️ 22.06.2022):
	```
...
- [GitHub](https://github.com/lckr/jupyterlab-variableInspector) (👨‍💻 18 · 🔀 84 · 📦 3 · 📋 160 - 27% open · ⏱️ 01.08.2022):
	...
	```
- [PyPi](https://pypi.org/project/lckr-jupyterlab-variableinspector) (📥 8.4K / month · ⏱️ 10.04.2021):
	```
	pip install lckr-jupyterlab-variableinspector
	```
- [Conda](https://anaconda.org/conda-forge/jupyterlab-variableinspector) (📥 7.4K · ⏱️ 10.04.2021):
	```
	conda install -c conda-forge jupyterlab-variableinspector
	```
- [npm](https://www.npmjs.com/package/@lckr/jupyterlab_variableinspector) (📥 5.6K / month · ⏱️ 10.04.2021):
	```
...
- [GitHub](https://github.com/jpmorganchase/jupyterlab_templates) (👨‍💻 14 · 🔀 51 · 📦 4 · 📋 78 - 8% open · ⏱️ 25.08.2022):
	...
	```
- [PyPi](https://pypi.org/project/jupyterlab_templates) (📥 6.7K / month · ⏱️ 30.06.2019):
	```
	pip install jupyterlab_templates
	```
- [Conda](https://anaconda.org/conda-forge/jupyterlab_templates) (📥 7K · ⏱️ 28.03.2021):
	```
...
- [Conda](https://anaconda.org/conda-forge/jupyterlab_iframe) (📥 13K · ⏱️ 12.04.2022):
	...
	```
- [npm](https://www.npmjs.com/package/jupyterlab_iframe) (📥 1K / month · ⏱️ 11.04.2022):
	```
...
- [GitHub](https://github.com/rapidsai/jupyterlab-nvdashboard) (👨‍💻 17 · 🔀 60 · 📋 56 - 42% open · ⏱️ 23.06.2022):

	```
	git clone https://github.com/rapidsai/jupyterlab-nvdashboard
	```
- [PyPi](https://pypi.org/project/jupyterlab-nvdashboard) (📥 1.7K / month · ⏱️ 23.06.2022):
	```
	pip install jupyterlab-nvdashboard
	```
- [Conda](https://anaconda.org/conda-forge/jupyterlab-nvdashboard) (📥 23K · ⏱️ 11.05.2022):
	```
	conda install -c conda-forge jupyterlab-nvdashboard
	```
- [npm](https://www.npmjs.com/package/jupyterlab-nvdashboard) (📥 900 / month · ⏱️ 27.04.2021):
	```
...
- [GitHub](https://github.com/bokeh/jupyter_bokeh) (👨‍💻 17 · 🔀 41 · 📋 90 - 13% open · ⏱️ 12.08.2022):

	```
	git clone https://github.com/bokeh/jupyter_bokeh
	```
- [PyPi](https://pypi.org/project/jupyter-bokeh) (📥 40K / month · 📦 5 · ⏱️ 30.09.2021):
	```
	pip install jupyter-bokeh
	```
- [Conda](https://anaconda.org/conda-forge/jupyter_bokeh) (📥 30K · ⏱️ 30.11.2021):
	```
	conda install -c conda-forge jupyter_bokeh
	```
- [npm](https://www.npmjs.com/package/@bokeh/jupyter_bokeh) (📥 7.6K / month · ⏱️ 30.09.2021):
	```
...
- [GitHub](https://github.com/timkpaine/lantern) (👨‍💻 3 · 🔀 20 · 📦 17 · 📋 200 - 5% open · ⏱️ 13.06.2022):
	...
	```
- [PyPi](https://pypi.org/project/pylantern) (📥 200 / month · 📦 1 · ⏱️ 02.02.2020):
	```
...
- [GitHub](https://github.com/deshaw/jupyterlab-execute-time) (👨‍💻 11 · 🔀 34 · 📋 35 - 14% open · ⏱️ 12.08.2022):
...
- [Conda](https://anaconda.org/conda-forge/jupyterlab_execute_time) (📥 20K · ⏱️ 02.10.2021):
	...
	```
- [npm](https://www.npmjs.com/package/jupyterlab-execute-time) (📥 2.5K / month · ⏱️ 18.01.2021):
	```
...
- [GitHub](https://github.com/jupyterlab-contrib/spellchecker) (👨‍💻 6 · 🔀 18 · 📦 1 · 📋 49 - 32% open · ⏱️ 22.02.2022):
	...
	```
- [PyPi](https://pypi.org/project/jupyterlab-spellchecker) (📥 1.8K / month · ⏱️ 08.10.2021):
	```
	pip install jupyterlab-spellchecker
	```
- [Conda](https://anaconda.org/conda-forge/jupyterlab-spellchecker) (📥 49K · ⏱️ 08.10.2021):
	```
	conda install -c conda-forge jupyterlab-spellchecker
	```
- [npm](https://www.npmjs.com/package/@ijmbarr/jupyterlab_spellchecker) (📥 1.6K / month · ⏱️ 08.10.2021):
	```
...
- [GitHub](https://github.com/jtpio/ipylab) (👨‍💻 6 · 🔀 7 · 📥 38 · 📋 32 - 40% open · ⏱️ 28.08.2022):

	```
	git clone https://github.com/jtpio/ipylab
	```
- [PyPi](https://pypi.org/project/ipylab) (📥 6.5K / month · 📦 3 · ⏱️ 13.11.2021):
	```
	pip install ipylab
	```
- [Conda](https://anaconda.org/conda-forge/ipylab) (📥 14K · ⏱️ 25.08.2022):
	...
	```
- [npm](https://www.npmjs.com/package/ipylab) (📥 290 / month · ⏱️ 25.08.2022):
	```
	npm install ipylab
	```
</details>
...
- [GitHub](https://github.com/jupytercalpoly/jupyterlab-interactive-dashboard-editor) (👨‍💻 11 · 🔀 27 · 📋 44 - 72% open · ⏱️ 13.04.2022):
	...
	```
- [PyPi](https://pypi.org/project/jupyterlab-interactive-dashboard-editor) (📥 90 / month · ⏱️ 01.04.2021):
	```
	pip install jupyterlab-interactive-dashboard-editor
	```
- [Conda](https://anaconda.org/conda-forge/jupyterlab-interactive-dashboard-editor) (📥 870 · ⏱️ 13.05.2021):
	```
	conda install -c conda-forge jupyterlab-interactive-dashboard-editor
	```
- [npm](https://www.npmjs.com/package/jupyterlab-interactive-dashboard-editor) (📥 46 / month · ⏱️ 27.01.2021):
	```
...
- [GitHub](https://github.com/jpmorganchase/jupyter-fs) (👨‍💻 9 · 🔀 24 · 📋 55 - 23% open · ⏱️ 29.04.2022):
	...
	```
- [PyPi](https://pypi.org/project/jupyter-fs) (📥 240 / month · ⏱️ 04.06.2021):
	```
	pip install jupyter-fs
	```
- [Conda](https://anaconda.org/conda-forge/jupyter-fs) (📥 4.2K · ⏱️ 04.06.2021):
	```
	conda install -c conda-forge jupyter-fs
	```
</details>
<details><summary><b><a href="https://github.com/jupyterlab/jupyterlab-hdf5">JupyterLab HDF5</a></b> (🥉16 ·  ⭐ 98 · 💤) - Open and explore HDF5 files in JupyterLab. Can handle very.. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
- [PyPi](https://pypi.org/project/jupyterlab_hdf) (📥 1K / month · 📦 1 · ⏱️ 21.02.2022):
	...
	```
- [npm](https://www.npmjs.com/package/@jupyterlab/hdf5) (📥 730 / month · ⏱️ 21.02.2022):
	```
...
- [GitHub](https://github.com/timkpaine/jupyterlab_autoversion) (👨‍💻 5 · 🔀 9 · 📋 32 - 9% open · ⏱️ 21.07.2022):
	...
	```
- [PyPi](https://pypi.org/project/jupyterlab_autoversion) (📥 88 / month · ⏱️ 29.06.2019):
	```
	pip install jupyterlab_autoversion
	```
- [Conda](https://anaconda.org/conda-forge/jupyterlab_autoversion) (📥 8.7K · ⏱️ 11.04.2022):
	```
	conda install -c conda-forge jupyterlab_autoversion
	```
- [npm](https://www.npmjs.com/package/jupyterlab_autoversion) (📥 49 / month · ⏱️ 11.04.2022):
	```
...
- [GitHub](https://github.com/timkpaine/jupyterlab_commands) (👨‍💻 2 · 🔀 6 · 📦 3 · 📋 24 - 8% open · ⏱️ 21.07.2022):
	...
	```
- [PyPi](https://pypi.org/project/jupyterlab-commands) (📥 55 / month · ⏱️ 11.04.2022):
	```
	pip install jupyterlab-commands
	```
- [Conda](https://anaconda.org/conda-forge/jupyterlab_commands) (📥 7K · ⏱️ 11.04.2022):
	```
...
- [GitHub](https://github.com/mlshapiro/jupyterlab-flake8) (👨‍💻 5 · 🔀 10 · 📋 39 - 15% open · ⏱️ 16.09.2021):
	...
	```
- [PyPi](https://pypi.org/project/jupyterlab-flake8) (📥 54K / month · 📦 1 · ⏱️ 16.09.2021):
	```
...
<details><summary><b><a href="https://github.com/jupyterlab-contrib/jupyterlab-kernelspy">JupyterLab Kernelspy</a></b> (🥉15 ·  ⭐ 69) - A Jupyter Lab extension for inspecting messages to/from.. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
- [GitHub](https://github.com/jupyterlab-contrib/jupyterlab-kernelspy) (👨‍💻 4 · 🔀 9 · 📦 3 · 📋 13 - 15% open · ⏱️ 20.07.2022):
	...
	```
- [PyPi](https://pypi.org/project/jupyterlab-kernelspy) (📥 130 / month · ⏱️ 19.04.2022):
	```
	pip install jupyterlab-kernelspy
	```
- [Conda](https://anaconda.org/conda-forge/jupyterlab-kernelspy) (📥 4.5K · ⏱️ 19.04.2022):
	```
...
- [GitHub](https://github.com/jpmorganchase/nbcelltests) (👨‍💻 7 · 🔀 16 · 📋 110 - 27% open · ⏱️ 25.08.2022):
	...
	```
- [PyPi](https://pypi.org/project/nbcelltests) (📥 23 / month · ⏱️ 05.10.2020):
	```
	pip install nbcelltests
	```
- [Conda](https://anaconda.org/conda-forge/nbcelltests) (📥 5.7K · ⏱️ 05.10.2020):
	```
...
- [GitHub](https://github.com/xiaohk/stickyland) (👨‍💻 2 · 🔀 15 · 📥 11 · 📦 1 · ⏱️ 30.05.2022):
	...
	```
- [PyPi](https://pypi.org/project/jupyterlab-stickyland) (📥 280 / month · 📦 1 · ⏱️ 30.05.2022):
	```
	pip install jupyterlab-stickyland
	```
- [npm](https://www.npmjs.com/package/jupyterlab-stickyland) (📥 36 / month · ⏱️ 23.11.2021):
	```
...
- [GitHub](https://github.com/jtpio/jupyterlab-topbar) (👨‍💻 4 · 🔀 10 · ⏱️ 07.12.2021):
	...
	```
- [npm](https://www.npmjs.com/package/jupyterlab-topbar-extension) (📥 3.7K / month · ⏱️ 30.10.2020):
	```
	npm install jupyterlab-topbar-extension
	```
</details>
<details><summary><b><a href="https://github.com/itsjafer/jupyterlab-sparkmonitor">jupyterlab-sparkmonitor</a></b> (🥉14 ·  ⭐ 81) - JupyterLab extension that enables monitoring launched.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>
...
- [GitHub](https://github.com/itsjafer/jupyterlab-sparkmonitor) (👨‍💻 10 · 🔀 20 · 📋 16 - 50% open · ⏱️ 01.04.2022):
	...
	```
- [PyPi](https://pypi.org/project/jupyterlab-sparkmonitor) (📥 3.4K / month · ⏱️ 04.08.2021):
	```
...
- [GitHub](https://github.com/timkpaine/jupyterlab_email) (👨‍💻 2 · 🔀 10 · 📋 36 - 11% open · ⏱️ 21.07.2022):
	...
	```
- [PyPi](https://pypi.org/project/jupyterlab-email) (📥 40 / month · ⏱️ 15.03.2022):
	```
...
- [GitHub](https://github.com/parente/jupyterlab-quickopen) (👨‍💻 5 · 🔀 8 · ⏱️ 12.12.2021):
	...
	```
- [PyPi](https://pypi.org/project/jupyterlab-quickopen) (📥 400 / month · 📦 1 · ⏱️ 12.12.2021):
	```
...
- [PyPi](https://pypi.org/project/jupyterlab_email) (📥 40 / month · ⏱️ 30.06.2019):
	...
	```
- [npm](https://www.npmjs.com/package/jupyterlab_email) (📥 62 / month · ⏱️ 15.03.2022):
	```
...
- <b><a href="https://github.com/ReviewNB/jupyterlab-gitplus">jupyterlab-gitplus</a></b> (🥉10 ·  ⭐ 94 · 💀) - JupyterLab extension to create GitHub commits & pull.. <code><a href="http://bit.ly/3pwmjO5">❗️AGPL-3.0</a></code>
...
- [GitHub](https://github.com/jupyterhub/oauthenticator) (👨‍💻 110 · 🔀 340 · 📦 290 · 📋 240 - 17% open · ⏱️ 08.09.2022):

	```
	git clone https://github.com/jupyterhub/oauthenticator
	```
- [PyPi](https://pypi.org/project/oauthenticator) (📥 43K / month · 📦 44 · ⏱️ 09.06.2022):
	```
...
<details><summary><b><a href="https://github.com/jupyterhub/nativeauthenticator">Native Authenticator</a></b> (🥈22 ·  ⭐ 54 · 📈) - JupyterHub-native User Authenticator https://native-.. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/jupyterhub/nativeauthenticator) (👨‍💻 21 · 🔀 56 · 📦 41 · 📋 96 - 27% open · ⏱️ 09.09.2022):
...
- [GitHub](https://github.com/jupyterhub/ltiauthenticator) (👨‍💻 15 · 🔀 43 · 📦 79 · 📋 39 - 12% open · ⏱️ 22.08.2022):
...
- [GitHub](https://github.com/jupyterhub/firstuseauthenticator) (👨‍💻 12 · 🔀 21 · 📦 67 · 📋 23 - 26% open · ⏱️ 28.10.2021):

	```
	git clone https://github.com/jupyterhub/firstuseauthenticator
	```
- [PyPi](https://pypi.org/project/jupyterhub-firstuseauthenticator) (📥 4.9K / month · 📦 3 · ⏱️ 28.10.2021):
	```
...
- [GitHub](https://github.com/jupyterhub/kubespawner) (👨‍💻 73 · 🔀 270 · 📦 110 · 📋 300 - 20% open · ⏱️ 29.08.2022):
...
- [PyPi](https://pypi.org/project/jupyterhub-kubespawner) (📥 34K / month · 📦 14 · ⏱️ 19.05.2022):
	...
	```
- [Conda](https://anaconda.org/conda-forge/jupyterhub-kubespawner) (📥 8.1K · ⏱️ 13.09.2022):
	```
...
- [GitHub](https://github.com/jupyterhub/batchspawner) (👨‍💻 42 · 🔀 100 · 📦 21 · 📋 140 - 45% open · ⏱️ 07.09.2022):
	...
	```
- [PyPi](https://pypi.org/project/batchspawner) (📥 4.4K / month · 📦 3 · ⏱️ 07.04.2021):
	```
	pip install batchspawner
	```
</details>
<details><summary><b><a href="https://github.com/jupyterhub/systemdspawner">SystemdSpawner</a></b> (🥉19 ·  ⭐ 79) - Spawn JupyterHub single-user notebook servers with systemd. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/jupyterhub/systemdspawner) (👨‍💻 17 · 🔀 40 · 📦 21 · 📋 67 - 52% open · ⏱️ 22.04.2022):

	```
	git clone https://github.com/jupyterhub/systemdspawner
	```
- [PyPi](https://pypi.org/project/jupyterhub-systemdspawner) (📥 1.6K / month · 📦 1 · ⏱️ 22.04.2022):
	```
...
- [GitHub](https://github.com/jupyterhub/sudospawner) (👨‍💻 14 · 🔀 36 · 📦 42 · 📋 37 - 45% open · ⏱️ 10.09.2021):
	...
	```
- [PyPi](https://pypi.org/project/sudospawner) (📥 720 / month · 📦 3 · ⏱️ 19.06.2018):
	```
...
- <b><a href="https://github.com/uktrade/fargatespawner">FargateSpawner</a></b> (🥉12 ·  ⭐ 36 · 💀) - Spawns JupyterHub single user servers in Docker containers.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code>
...
- [GitHub](https://github.com/ipython/ipython) (👨‍💻 910 · 🔀 4.4K · 📥 320K · 📦 300K · 📋 7K - 21% open · ⏱️ 09.09.2022):

	```
	git clone https://github.com/ipython/ipython
	```
- [PyPi](https://pypi.org/project/ipython) (📥 16M / month · 📦 35K · ⏱️ 06.09.2022):
	```
	pip install ipython
	```
...
<details><summary><b><a href="https://github.com/jupyter-server/jupyter_server">jupyter_server</a></b> (🥉34 ·  ⭐ 330) - The backendi.e. core services, APIs, and REST endpointsto.. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/jupyter-server/jupyter_server) (👨‍💻 480 · 🔀 190 · 📥 440 · 📋 320 - 38% open · ⏱️ 13.09.2022):

	```
	git clone https://github.com/jupyter-server/jupyter_server
	```
- [PyPi](https://pypi.org/project/jupyter_server) (📥 1.7M / month · 📦 150 · ⏱️ 05.07.2022):
	```
	pip install jupyter_server
	```
- [Conda](https://anaconda.org/conda-forge/jupyter_server) (📥 2.1M · ⏱️ 06.07.2022):
	```
...
- [GitHub](https://github.com/jupyter/jupyter-packaging) (👨‍💻 30 · 🔀 49 · 📥 33 · 📋 42 - 28% open · ⏱️ 06.09.2022):

	```
	git clone https://github.com/jupyter/jupyter-packaging
	```
- [PyPi](https://pypi.org/project/jupyter-packaging) (📥 360K / month · 📦 51 · ⏱️ 20.06.2022):
	```
	pip install jupyter-packaging
	```
- [Conda](https://anaconda.org/conda-forge/jupyter-packaging) (📥 310K · ⏱️ 25.08.2022):
	```
...
- [PyPi](https://pypi.org/project/qtconsole) (📥 3.1M / month · 📦 6.3K · ⏱️ 05.06.2022):
	...
	```
- [Conda](https://anaconda.org/conda-forge/qtconsole) (📥 2.9M · ⏱️ 28.08.2022):
	```
...
- [PyPi](https://pypi.org/project/jupyter-console) (📥 3.2M / month · 📦 77 · ⏱️ 22.06.2022):
	...
	```
- [Conda](https://anaconda.org/conda-forge/jupyter_console) (📥 2.6M · ⏱️ 23.06.2022):
	```
	conda install -c conda-forge jupyter_console
	```
</details>
<details><summary><b><a href="https://github.com/datapane/datapane">datapane</a></b> (🥉24 ·  ⭐ 650) - Datapane is the easiest way to create data science reports from.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/datapane/datapane) (👨‍💻 15 · 🔀 56 · 📋 91 - 12% open · ⏱️ 15.09.2022):

	```
	git clone https://github.com/datapane/datapane
	```
- [PyPi](https://pypi.org/project/datapane) (📥 20K / month · 📦 7 · ⏱️ 09.04.2022):
	```
	pip install datapane
	```
- [Conda](https://anaconda.org/conda-forge/datapane) (📥 38K · ⏱️ 31.08.2022):
	```
