...
- [GitHub](https://github.com/jupyter/notebook) (👨‍💻 610 · 🔀 3.8K · 📥 8.1K · 📦 9 · 📋 4.5K - 47% open · ⏱️ 14.06.2022):

	```
	git clone https://github.com/jupyter/notebook
	```
- [PyPi](https://pypi.org/project/notebook) (📥 12M / month · 📦 8.7K · ⏱️ 14.06.2022):
	```
...
- [Conda](https://anaconda.org/conda-forge/jupyter) (📥 2.1M · ⏱️ 18.11.2021):
	...
	```
- [Docker Hub](https://hub.docker.com/r/jupyter/datascience-notebook) (📥 27M · ⭐ 920 · ⏱️ 13.06.2022):
	```
...
- [GitHub](https://github.com/jupyterhub/jupyterhub) (👨‍💻 280 · 🔀 1.7K · 📦 1.8K · 📋 2.1K - 6% open · ⏱️ 16.06.2022):

	```
	git clone https://github.com/jupyterhub/jupyterhub
	```
- [PyPi](https://pypi.org/project/jupyterhub) (📥 2.5M / month · 📦 370 · ⏱️ 06.06.2022):
	```
	pip install jupyterhub
	```
- [Conda](https://anaconda.org/conda-forge/jupyterhub) (📥 580K · ⏱️ 06.06.2022):
	```
	conda install -c conda-forge jupyterhub
	```
- [Docker Hub](https://hub.docker.com/r/jupyterhub/jupyterhub) (📥 2.6M · ⭐ 310 · ⏱️ 16.06.2022):
	```
...
- [GitHub](https://github.com/jupyterlab/jupyterlab) (👨‍💻 400 · 🔀 2.4K):
	...
	```
- [PyPi](https://pypi.org/project/jupyterlab) (📥 4.1M / month · 📦 1.9K · ⏱️ 09.06.2022):
	```
...
- [Conda](https://anaconda.org/conda-forge/jupyterlab) (📥 5.6M · ⏱️ 07.06.2022):
	...
	```
- [npm](https://www.npmjs.com/package/@jupyterlab/ui-components) (📥 180K / month · 📦 240 · ⏱️ 09.06.2022):
	```
...
- [GitHub](https://github.com/jupyter/docker-stacks) (👨‍💻 220 · 🔀 2.7K · 📋 750 - 6% open · ⏱️ 14.06.2022):

	```
	git clone https://github.com/jupyter/docker-stacks
	```
- [Docker Hub](https://hub.docker.com/r/jupyter/scipy-notebook) (📥 86M · ⭐ 350 · ⏱️ 13.06.2022):
	```
...
- [GitHub](https://github.com/vatlab/sos) (👨‍💻 36 · 🔀 30 · 📦 2.3K · 📋 1.4K - 4% open · ⏱️ 09.06.2022):

	```
	git clone https://github.com/vatlab/SOS
	```
- [PyPi](https://pypi.org/project/sos-notebook) (📥 2.4K / month · 📦 33 · ⏱️ 09.04.2022):
	```
	pip install sos-notebook
	```
- [Conda](https://anaconda.org/conda-forge/sos) (📥 110K · ⏱️ 10.06.2022):
	```
...
- [GitHub](https://github.com/microsoft/vscode-jupyter) (👨‍💻 250 · 🔀 130 · 📋 7.4K - 9% open · ⏱️ 15.06.2022):

	```
	git clone https://github.com/microsoft/vscode-jupyter
	```
- [Conda](https://anaconda.org/conda-forge/vscode-jupyter) (📥 28K · ⏱️ 12.04.2022):
	```
...
- [GitHub](https://github.com/googledatalab/datalab) (👨‍💻 52 · 🔀 260 · 📋 900 - 25% open · ⏱️ 16.08.2021):
	...
	```
- [PyPi](https://pypi.org/project/datalab) (📥 63K / month · 📦 12 · ⏱️ 25.03.2020):
	```
	pip install datalab
	```
</details>
...
- [GitHub](https://github.com/Kaggle/docker-python) (👨‍💻 150 · 🔀 840 · 📋 310 - 8% open · ⏱️ 15.06.2022):
...
- [GitHub](https://github.com/jupyterlab/retrolab) (👨‍💻 17 · 🔀 43 · 📥 780 · 📦 72 · 📋 110 - 4% open · ⏱️ 04.05.2022):
...
- [PyPi](https://pypi.org/project/retrolab) (📥 2.7K / month · 📦 3 · ⏱️ 04.05.2022):
	...
	```
- [Conda](https://anaconda.org/conda-forge/retrolab) (📥 11K · ⏱️ 04.05.2022):
	```
	conda install -c conda-forge retrolab
	```
- [npm](https://www.npmjs.com/package/@jupyterlab-classic/application) (📥 53 / month · 📦 4 · ⏱️ 19.04.2021):
	```
...
- [GitHub](https://github.com/jtpio/jupyterlite) (👨‍💻 28 · 🔀 6 · ⏱️ 16.06.2022):
...
- [GitHub](https://github.com/iot-salzburg/gpu-jupyter) (👨‍💻 10 · 🔀 130 · 📋 54 - 20% open · ⏱️ 23.02.2022):
...
- [GitHub](https://github.com/bokeh/bokeh) (👨‍💻 610 · 🔀 3.9K · 📦 52K · 📋 6.9K - 10% open · ⏱️ 15.06.2022):

	```
	git clone https://github.com/bokeh/bokeh
	```
- [PyPi](https://pypi.org/project/bokeh) (📥 2.8M / month · 📦 3.5K · ⏱️ 13.06.2022):
	```
	pip install bokeh
	```
- [Conda](https://anaconda.org/conda-forge/bokeh) (📥 7.6M · ⏱️ 19.05.2022):
	```
	conda install -c conda-forge bokeh
	```
- [npm](https://www.npmjs.com/package/@bokeh/bokehjs) (📥 13K / month · 📦 4 · ⏱️ 13.06.2022):
	```
...
- [GitHub](https://github.com/jupyter-widgets/ipywidgets) (👨‍💻 200 · 🔀 810 · 📦 4.2K · 📋 1.8K - 32% open · ⏱️ 14.06.2022):

	```
	git clone https://github.com/jupyter-widgets/ipywidgets
	```
- [PyPi](https://pypi.org/project/ipywidgets) (📥 9.5M / month · 📦 8.6K · ⏱️ 16.03.2022):
	```
	pip install ipywidgets
	```
- [Conda](https://anaconda.org/conda-forge/ipywidgets) (📥 5.2M · ⏱️ 05.04.2022):
	```
...
- [GitHub](https://github.com/ydataai/pandas-profiling) (👨‍💻 88 · 🔀 1.3K · 📦 8.2K · 📋 570 - 18% open · ⏱️ 03.06.2022):
...
- [GitHub](https://github.com/holoviz/panel) (👨‍💻 96 · 🔀 260 · 📦 3.5K · 📋 1.8K - 29% open · ⏱️ 16.06.2022):

	```
	git clone https://github.com/holoviz/panel
	```
- [PyPi](https://pypi.org/project/panel) (📥 390K / month · 📦 110 · ⏱️ 13.06.2022):
	```
	pip install panel
	```
- [Conda](https://anaconda.org/conda-forge/panel) (📥 490K · ⏱️ 24.05.2022):
	```
...
- [GitHub](https://github.com/jupyter-widgets/ipyleaflet) (👨‍💻 79 · 🔀 330 · 📦 1.8K · 📋 490 - 38% open · ⏱️ 16.06.2022):

	```
	git clone https://github.com/jupyter-widgets/ipyleaflet
	```
- [PyPi](https://pypi.org/project/ipyleaflet) (📥 86K / month · 📦 110 · ⏱️ 14.04.2022):
	```
...
- [GitHub](https://github.com/nteract/papermill) (👨‍💻 100 · 🔀 350 · 📦 2.2K · 📋 340 - 30% open · ⏱️ 09.06.2022):
...
- [GitHub](https://github.com/bqplot/bqplot) (👨‍💻 58 · 🔀 460 · 📦 32 · 📋 590 - 38% open · ⏱️ 31.05.2022):
	...
	```
- [PyPi](https://pypi.org/project/bqplot) (📥 94K / month · 📦 92 · ⏱️ 11.02.2022):
	```
	pip install bqplot
	```
...
- [GitHub](https://github.com/matplotlib/ipympl) (👨‍💻 28 · 🔀 180 · 📦 3.3K · 📋 250 - 44% open · ⏱️ 02.06.2022):

	```
	git clone https://github.com/matplotlib/ipympl
	```
- [PyPi](https://pypi.org/project/ipympl) (📥 170K / month · 📦 81 · ⏱️ 25.04.2022):
	```
	pip install ipympl
	```
- [Conda](https://anaconda.org/conda-forge/ipympl) (📥 960K · ⏱️ 25.04.2022):
	...
	```
- [npm](https://www.npmjs.com/package/jupyter-matplotlib) (📥 32K / month · ⏱️ 25.04.2022):
	```
	npm install jupyter-matplotlib
	```
</details>
<details><summary><b><a href="https://github.com/plotly/jupyter-dash">jupyter-dash</a></b> (🥈29 ·  ⭐ 760) - Develop Dash apps in the Jupyter Notebook and JupyterLab. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/plotly/jupyter-dash) (👨‍💻 10 · 🔀 200 · 📥 76 · 📦 1.6K · 📋 62 - 64% open · ⏱️ 08.06.2022):

	```
	git clone https://github.com/plotly/jupyter-dash
	```
- [PyPi](https://pypi.org/project/jupyter-dash) (📥 220K / month · 📦 33 · ⏱️ 01.04.2022):
	```
...
- [GitHub](https://github.com/lux-org/lux) (👨‍💻 20 · 🔀 300 · 📦 99 · 📋 220 - 29% open · ⏱️ 21.05.2022):
...
- [PyPi](https://pypi.org/project/lux-api) (📥 32K / month · ⏱️ 19.02.2022):
	...
	pip install lux-api
	```
- [Conda](https://anaconda.org/conda-forge/lux-api) (📥 5.2K · ⏱️ 22.02.2022):
	```
	conda install -c conda-forge lux-api
	```
- [npm](https://www.npmjs.com/package/luxwidget) (📥 800 / month · ⏱️ 17.02.2022):
	```
...
- [GitHub](https://github.com/widgetti/ipyvolume) (👨‍💻 40 · 🔀 220 · 📦 790 · 📋 300 - 56% open · ⏱️ 08.06.2022):

	```
	git clone https://github.com/maartenbreddels/ipyvolume
	```
- [PyPi](https://pypi.org/project/ipyvolume) (📥 53K / month · 📦 50 · ⏱️ 29.10.2021):
	```
...
- [GitHub](https://github.com/jupyter-widgets/pythreejs) (👨‍💻 29 · 🔀 180 · 📦 20 · 📋 220 - 33% open · ⏱️ 06.12.2021):
	...
	```
- [PyPi](https://pypi.org/project/pythreejs) (📥 63K / month · 📦 38 · ⏱️ 26.02.2021):
	```
...
- [GitHub](https://github.com/timkpaine/ipydagred3) (👨‍💻 3 · 🔀 810 · 📦 11 · 📋 19 - 15% open · ⏱️ 14.06.2022):

	```
	git clone https://github.com/timkpaine/ipydagred3
	```
- [PyPi](https://pypi.org/project/ipydagred3) (📥 210 / month · 📦 1 · ⏱️ 06.05.2022):
	```
	pip install ipydagred3
	```
- [Conda](https://anaconda.org/conda-forge/ipydagred3) (📥 5.3K · ⏱️ 07.05.2022):
	```
...
<details><summary><b><a href="https://github.com/evidentlyai/evidently">evidently</a></b> (🥈26 ·  ⭐ 2.4K) - Evaluate and monitor ML models from validation to production... <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/evidentlyai/evidently) (👨‍💻 21 · 🔀 240 · 📋 100 - 38% open · ⏱️ 15.06.2022):

	```
	git clone https://github.com/evidentlyai/evidently
	```
- [PyPi](https://pypi.org/project/evidently) (📥 79K / month · 📦 3 · ⏱️ 31.05.2022):
	```
	pip install evidently
	```
- [Conda](https://anaconda.org/conda-forge/evidently) (📥 1K · ⏱️ 06.09.2021):
	```
...
- [GitHub](https://github.com/microsoft/responsible-ai-toolbox) (👨‍💻 25 · 🔀 120 · 📦 31 · 📋 270 - 20% open · ⏱️ 16.06.2022):
...
- [GitHub](https://github.com/cytoscape/ipycytoscape) (👨‍💻 32 · 🔀 52 · 📥 3 · 📦 70 · 📋 150 - 35% open · ⏱️ 20.05.2022):

	```
	git clone https://github.com/cytoscape/ipycytoscape
	```
- [PyPi](https://pypi.org/project/ipycytoscape) (📥 8.4K / month · 📦 10 · ⏱️ 04.04.2022):
	```
	pip install ipycytoscape
	```
- [Conda](https://anaconda.org/conda-forge/ipycytoscape) (📥 34K · ⏱️ 05.04.2022):
	```
	conda install -c conda-forge ipycytoscape
	```
- [npm](https://www.npmjs.com/package/jupyter-cytoscape) (📥 620 / month · ⏱️ 04.04.2022):
	```
...
- [PyPi](https://pypi.org/project/ipyregulartable) (📥 130 / month · ⏱️ 08.01.2021):
	...
	```
- [Conda](https://anaconda.org/conda-forge/ipyregulartable) (📥 2.3K · ⏱️ 08.01.2021):
	```
...
- [GitHub](https://github.com/martinRenou/ipycanvas) (👨‍💻 17 · 🔀 50 · 📦 570 · 📋 110 - 38% open · ⏱️ 25.05.2022):
...
- [PyPi](https://pypi.org/project/ipycanvas) (📥 12K / month · 📦 20 · ⏱️ 03.05.2022):
	...
	```
- [Conda](https://anaconda.org/conda-forge/ipycanvas) (📥 61K · ⏱️ 16.05.2022):
	```
...
- [GitHub](https://github.com/nglviewer/nglview) (👨‍💻 33 · 🔀 110 · 📥 210 · 📦 2 · 📋 430 - 6% open · ⏱️ 15.06.2022):
...
- [GitHub](https://github.com/spacetelescope/jdaviz) (👨‍💻 26 · 🔀 31 · 📋 620 - 39% open · ⏱️ 15.06.2022):
...
- [GitHub](https://github.com/InsightSoftwareConsortium/itkwidgets) (👨‍💻 21 · 🔀 57 · 📥 64 · 📋 180 - 43% open · ⏱️ 12.03.2022):
	...
	```
- [PyPi](https://pypi.org/project/itkwidgets) (📥 11K / month · 📦 12 · ⏱️ 23.05.2022):
	```
...
- [Conda](https://anaconda.org/conda-forge/itkwidgets) (📥 270K · ⏱️ 10.08.2020):
	...
	```
- [npm](https://www.npmjs.com/package/itkwidgets) (📥 790 / month · ⏱️ 14.05.2021):
	```
...
- [GitHub](https://github.com/lgpage/nbtutor) (👨‍💻 3 · 🔀 38 · 📦 26 · 📋 43 - 44% open · ⏱️ 04.04.2022):
	...
	```
- [PyPi](https://pypi.org/project/nbtutor) (📥 120 / month · 📦 3 · ⏱️ 19.04.2022):
	```
	pip install nbtutor
	```
...
- [GitHub](https://github.com/widgetti/ipyvuetify) (👨‍💻 10 · 🔀 43 · 📦 4 · 📋 160 - 26% open · ⏱️ 07.02.2022):
	...
	```
- [PyPi](https://pypi.org/project/ipyvuetify) (📥 57K / month · 📦 25 · ⏱️ 07.02.2022):
	```
	pip install ipyvuetify
	```
- [Conda](https://anaconda.org/conda-forge/ipyvuetify) (📥 77K · ⏱️ 07.02.2022):
	```
...
- [GitHub](https://github.com/vidartf/ipydatawidgets) (👨‍💻 5 · 🔀 7 · 📦 520 · 📋 9 - 33% open · ⏱️ 19.05.2022):

	```
	git clone https://github.com/vidartf/ipydatawidgets
	```
- [PyPi](https://pypi.org/project/ipydatawidgets) (📥 74K / month · 📦 26 · ⏱️ 19.05.2022):
	```
...
- [GitHub](https://github.com/PAIR-code/what-if-tool) (👨‍💻 20 · 🔀 130 · 📋 110 - 53% open · ⏱️ 05.01.2022):
	...
	```
- [PyPi](https://pypi.org/project/witwidget) (📥 8.5K / month · 📦 3 · ⏱️ 12.10.2021):
	```
...
- [GitHub](https://github.com/QuantStack/ipysheet) (👨‍💻 10 · 🔀 61 · 📦 3 · 📋 120 - 51% open · ⏱️ 14.12.2021):
	...
	```
- [PyPi](https://pypi.org/project/ipysheet) (📥 45K / month · 📦 13 · ⏱️ 11.08.2021):
	```
	pip install ipysheet
	```
- [Conda](https://anaconda.org/conda-forge/ipysheet) (📥 48K · ⏱️ 11.08.2021):
	```
...
- [GitHub](https://github.com/timkpaine/tributary) (👨‍💻 7 · 🔀 33 · 📦 22 · 📋 82 - 10% open · ⏱️ 14.06.2022):

	```
	git clone https://github.com/timkpaine/tributary
	```
- [PyPi](https://pypi.org/project/tributary) (📥 160 / month · ⏱️ 11.05.2022):
	```
...
- [PyPi](https://pypi.org/project/itables) (📥 7.5K / month · 📦 7 · ⏱️ 13.04.2022):
	...
	pip install itables
	```
- [Conda](https://anaconda.org/conda-forge/itables) (📥 940 · ⏱️ 13.04.2022):
	```
...
- [GitHub](https://github.com/bloomberg/ipydatagrid) (👨‍💻 12 · 🔀 30 · 📋 78 - 35% open · ⏱️ 20.04.2022):
	...
	```
- [PyPi](https://pypi.org/project/ipydatagrid) (📥 1.1K / month · 📦 3 · ⏱️ 20.04.2022):
	```
	pip install ipydatagrid
	```
- [Conda](https://anaconda.org/conda-forge/ipydatagrid) (📥 17K · ⏱️ 20.04.2022):
	```
	conda install -c conda-forge ipydatagrid
	```
- [npm](https://www.npmjs.com/package/ipydatagrid) (📥 160 / month · ⏱️ 20.04.2022):
	```
...
- [GitHub](https://github.com/altair-viz/altair_viewer) (👨‍💻 3 · 🔀 8 · 📋 7 - 42% open · ⏱️ 14.01.2022):
	...
	```
- [PyPi](https://pypi.org/project/altair_viewer) (📥 760K / month · 📦 12 · ⏱️ 06.11.2021):
	```
...
- [GitHub](https://github.com/widgetti/ipyvue) (👨‍💻 3 · 🔀 11 · 📦 17 · 📋 7 - 42% open · ⏱️ 10.12.2021):
	...
	```
- [PyPi](https://pypi.org/project/ipyvue) (📥 57K / month · 📦 12 · ⏱️ 28.10.2021):
	```
	pip install ipyvue
	```
...
- [PyPi](https://pypi.org/project/ipytree) (📥 21K / month · 📦 5 · ⏱️ 03.03.2021):
	...
	pip install ipytree
	```
- [Conda](https://anaconda.org/conda-forge/ipytree) (📥 38K · ⏱️ 03.03.2021):
	```
	conda install -c conda-forge ipytree
	```
- [npm](https://www.npmjs.com/package/ipytree) (📥 140 / month · ⏱️ 03.03.2021):
	```
	npm install ipytree
	```
</details>
<details><summary><b><a href="https://github.com/medialab/ipysigma">ipysigma</a></b> (🥉17 ·  ⭐ 36) - A Jupyter widget using sigma.js to render interactive networks. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/medialab/ipysigma) (👨‍💻 3 · 🔀 4 · 📋 99 - 42% open · ⏱️ 10.06.2022):

	```
	git clone https://github.com/Yomguithereal/ipysigma
	```
- [PyPi](https://pypi.org/project/ipysigma) (📥 390 / month · 📦 1 · ⏱️ 08.06.2022):
	```
	pip install ipysigma
	```
- [npm](https://www.npmjs.com/package/ipysigma) (📥 210 / month · ⏱️ 10.06.2022):
	```
...
- <b><a href="https://github.com/nipy/niwidgets">niwidgets</a></b> (🥉16 ·  ⭐ 75 · 💀) - Neuroimaging widgets for jupyter notebooks. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code>
...
- [GitHub](https://github.com/jupyter/nbgrader) (👨‍💻 95 · 🔀 300 · 📋 800 - 25% open · ⏱️ 16.06.2022):

	```
	git clone https://github.com/jupyter/nbgrader
	```
- [PyPi](https://pypi.org/project/nbgrader) (📥 1.8K / month · 📦 17 · ⏱️ 07.05.2022):
	```
...
- [GitHub](https://github.com/jupyterhub/nbgitpuller) (👨‍💻 25 · 🔀 60 · 📦 470 · 📋 140 - 41% open · ⏱️ 15.06.2022):

	```
	git clone https://github.com/jupyterhub/nbgitpuller
	```
- [PyPi](https://pypi.org/project/nbgitpuller) (📥 9.7K / month · 📦 18 · ⏱️ 19.03.2022):
	```
...
<details><summary><b><a href="https://github.com/jupyterhub/jupyter-server-proxy">jupyter-server-proxy</a></b> (🥈25 ·  ⭐ 230) - Jupyter notebook server extension to proxy web services. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
- [GitHub](https://github.com/jupyterhub/jupyter-server-proxy) (👨‍💻 62 · 🔀 110 · 📦 4 · 📋 160 - 41% open · ⏱️ 29.03.2022):
	...
	```
- [PyPi](https://pypi.org/project/jupyter-server-proxy) (📥 2.4M / month · 📦 89 · ⏱️ 24.01.2022):
	```
	pip install jupyter-server-proxy
	```
- [Conda](https://anaconda.org/conda-forge/jupyter-server-proxy) (📥 700K · ⏱️ 25.01.2022):
	```
...
- [PyPi](https://pypi.org/project/jupyter_http_over_ws) (📥 53K / month · 📦 15 · ⏱️ 12.03.2020):
	...
	```
- [Conda](https://anaconda.org/conda-forge/jupyter_http_over_ws) (📥 8.4K · ⏱️ 13.08.2020):
	```
...
- [GitHub](https://github.com/jupyterhub/jupyter-rsession-proxy) (👨‍💻 19 · 🔀 66 · 📦 37 · 📋 71 - 38% open · ⏱️ 22.12.2021):
...
- [PyPi](https://pypi.org/project/jupyter-rsession-proxy) (📥 2.1K / month · ⏱️ 01.12.2021):
	...
	```
- [Conda](https://anaconda.org/conda-forge/jupyter-rsession-proxy) (📥 9.8K · ⏱️ 01.12.2021):
	```
...
- [GitHub](https://github.com/mamba-org/gator) (👨‍💻 24 · 🔀 23 · 📥 2 · 📦 1 · 📋 54 - 29% open · ⏱️ 09.04.2022):
	...
	```
- [PyPi](https://pypi.org/project/mamba-gator) (📥 63 / month · ⏱️ 03.09.2021):
	```
...
- [PyPi](https://pypi.org/project/jupyter-archive) (📥 1.6K / month · ⏱️ 08.04.2022):
	...
	```
- [Conda](https://anaconda.org/conda-forge/jupyter-archive) (📥 23K · ⏱️ 08.04.2022):
	```
	conda install -c conda-forge jupyter-archive
	```
- [npm](https://www.npmjs.com/package/@hadim/jupyter-archive) (📥 7.6K / month · ⏱️ 08.04.2022):
	```
...
- [PyPi](https://pypi.org/project/sparkmagic) (📥 37K / month · 📦 20 · ⏱️ 02.05.2022):
	...
	```
- [Conda](https://anaconda.org/conda-forge/sparkmagic) (📥 45K · ⏱️ 09.05.2022):
	```
...
- [GitHub](https://github.com/rossant/ipycache) (👨‍💻 10 · 🔀 24 · 📦 22 · 📋 38 - 44% open · ⏱️ 03.04.2022):
	...
	```
- [PyPi](https://pypi.org/project/ipycache) (📥 3.8K / month · 📦 6 · ⏱️ 13.10.2013):
	```
...
- [GitHub](https://github.com/csurfer/blackcellmagic) (👨‍💻 3 · 🔀 12 · 📦 150 · 📋 10 - 50% open · ⏱️ 18.09.2021):
	...
	```
- [PyPi](https://pypi.org/project/blackcellmagic) (📥 3.9K / month · 📦 3 · ⏱️ 18.09.2021):
	```
...
- [GitHub](https://github.com/ipython/ipykernel) (👨‍💻 150 · 🔀 310 · 📥 430 · 📋 430 - 53% open · ⏱️ 15.06.2022):
...
- [PyPi](https://pypi.org/project/ipykernel) (📥 13M / month · 📦 9.6K · ⏱️ 15.06.2022):
	...
	```
- [Conda](https://anaconda.org/anaconda/ipykernel) (📥 310K · 📦 30 · ⏱️ 02.05.2022):
	```
...
- [GitHub](https://github.com/Calysto/metakernel) (👨‍💻 30 · 🔀 77 · 📥 29 · 📋 140 - 19% open · ⏱️ 27.05.2022):
	...
	```
- [PyPi](https://pypi.org/project/metakernel) (📥 470K / month · 📦 77 · ⏱️ 29.03.2022):
	```
...
<details><summary><b><a href="https://github.com/jupyter-server/enterprise_gateway">Enterprise Gateway</a></b> (🥇26 ·  ⭐ 510) - A lightweight, multi-tenant, scalable and secure gateway.. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/jupyter-server/enterprise_gateway) (👨‍💻 100 · 🔀 170 · 📥 18K · 📋 530 - 13% open · ⏱️ 14.06.2022):
...
- [PyPi](https://pypi.org/project/jupyter_enterprise_gateway) (📥 1.1K / month · 📦 1 · ⏱️ 27.04.2020):
	...
	```
- [Conda](https://anaconda.org/conda-forge/jupyter_enterprise_gateway) (📥 93K · ⏱️ 18.04.2022):
	```
...
- [GitHub](https://github.com/IRkernel/IRkernel) (👨‍💻 40 · 🔀 290 · 📋 560 - 9% open · ⏱️ 04.01.2022):
	...
	```
- [Conda](https://anaconda.org/r/r-irkernel) (📥 72K · ⏱️ 31.05.2022):
	```
	conda install -c r r-irkernel
	```
- [Docker Hub](https://hub.docker.com/r/jupyter/r-notebook) (📥 1.3M · ⭐ 44 · ⏱️ 13.06.2022):
	```
...
- [GitHub](https://github.com/jupyter-xeus/xeus-python) (👨‍💻 19 · 🔀 61 · 📋 170 - 30% open · ⏱️ 15.06.2022):

	```
	git clone https://github.com/jupyter-xeus/xeus-python
	```
- [PyPi](https://pypi.org/project/xeus-python) (📥 7.8K / month · 📦 3 · ⏱️ 15.06.2022):
	```
	pip install xeus-python
	```
- [Conda](https://anaconda.org/conda-forge/xeus-python) (📥 1M · ⏱️ 16.06.2022):
	```
...
- [GitHub](https://github.com/lfortran/lfortran) (👨‍💻 25 · 🔀 20 · ⏱️ 15.06.2022):
...
- [PyPi](https://pypi.org/project/lfortran) (📥 110 / month · ⏱️ 31.07.2020):
	...
	```
- [Conda](https://anaconda.org/conda-forge/lfortran) (📥 36K · ⏱️ 23.09.2021):
	```
...
- [PyPi](https://pypi.org/project/matlab_kernel) (📥 1.7K / month · 📦 1 · ⏱️ 30.11.2018):
	...
	```
- [Conda](https://anaconda.org/conda-forge/matlab_kernel) (📥 16K · ⏱️ 09.05.2022):
	```
...
- [GitHub](https://github.com/ansible/ansible-jupyter-kernel) (👨‍💻 10 · 🔀 53 · 📦 8 · 📋 44 - 34% open · ⏱️ 11.02.2022):
	...
	```
- [PyPi](https://pypi.org/project/ansible-kernel) (📥 81 / month · ⏱️ 11.02.2022):
	```
	pip install ansible-kernel
	```
- [Conda](https://anaconda.org/conda-forge/ansible-kernel) (📥 9.9K · ⏱️ 12.02.2022):
	```
...
- [GitHub](https://github.com/sassoftware/sas_kernel) (👨‍💻 7 · 🔀 71 · 📋 56 - 5% open · ⏱️ 01.06.2022):
	...
	```
- [PyPi](https://pypi.org/project/sas_kernel) (📥 1.5K / month · 📦 2 · ⏱️ 13.09.2017):
	```
...
- [GitHub](https://github.com/scijava/scijava-jupyter-kernel) (👨‍💻 9 · 🔀 42 · 📥 85 · 📋 94 - 14% open · ⏱️ 03.02.2022):
	...
	```
- [Conda](https://anaconda.org/conda-forge/scijava-jupyter-kernel) (📥 78K · ⏱️ 03.03.2018):
	```
...
- [GitHub](https://github.com/jorgehpo/notebookJS) (👨‍💻 2 · 🔀 43 · 📦 3 · ⏱️ 26.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/notebookjs) (📥 78 / month · ⏱️ 17.04.2021):
	```
	pip install notebookjs
	```
- [npm](https://www.npmjs.com/package/notebookjs) (📥 950 / month · 📦 13 · ⏱️ 03.03.2022):
	```
...
- [GitHub](https://github.com/NII-cloud-operation/sshkernel) (👨‍💻 4 · 🔀 11 · 📦 6 · 📋 8 - 25% open · ⏱️ 04.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/sshkernel) (📥 85 / month · ⏱️ 04.11.2021):
	```
...
- [GitHub](https://github.com/deathbeds/pidgy) (👨‍💻 3 · 🔀 6 · 📥 1 · 📋 20 - 40% open · ⏱️ 14.12.2021):
	...
	```
- [PyPi](https://pypi.org/project/pidgy) (📥 31 / month · ⏱️ 27.11.2021):
	```
	pip install pidgy
	```
</details>
...
<details><summary><b><a href="https://github.com/jupyter/nbconvert">nbconvert</a></b> (🥇37 ·  ⭐ 1.3K · 📈) - Jupyter Notebook Conversion. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/jupyter/nbconvert) (👨‍💻 250 · 🔀 490 · 📋 1K - 42% open · ⏱️ 15.06.2022):

	```
	git clone https://github.com/jupyter/nbconvert
	```
- [PyPi](https://pypi.org/project/nbconvert) (📥 13M / month · 📦 8.3K · ⏱️ 15.06.2022):
	```
	pip install nbconvert
	```
- [Conda](https://anaconda.org/conda-forge/nbconvert) (📥 7M · ⏱️ 11.04.2022):
	```
...
- [GitHub](https://github.com/mwouts/jupytext) (👨‍💻 70 · 🔀 340 · 📦 2.9K · 📋 520 - 13% open · ⏱️ 04.04.2022):
...
- [PyPi](https://pypi.org/project/jupytext) (📥 220K / month · 📦 150 · ⏱️ 09.02.2022):
	...
	```
- [Conda](https://anaconda.org/conda-forge/jupytext) (📥 330K · ⏱️ 06.04.2022):
	```
	conda install -c conda-forge jupytext
	```
- [npm](https://www.npmjs.com/package/jupyterlab-jupytext) (📥 8.8K / month · ⏱️ 04.12.2021):
	```
...
- [GitHub](https://github.com/executablebooks/jupyter-book) (👨‍💻 110 · 🔀 510 · 📋 1.1K - 39% open · ⏱️ 14.06.2022):
...
<details><summary><b><a href="https://github.com/damianavila/RISE">RISE</a></b> (🥈28 ·  ⭐ 3.3K · 📉) - RISE: Live Reveal.js Jupyter/IPython Slideshow Extension. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
- [PyPi](https://pypi.org/project/nbdime) (📥 230K / month · 📦 140 · ⏱️ 25.10.2021):
	...
	pip install nbdime
	```
- [Conda](https://anaconda.org/conda-forge/nbdime) (📥 540K · ⏱️ 26.10.2021):
	```
	conda install -c conda-forge nbdime
	```
- [npm](https://www.npmjs.com/package/nbdime-jupyterlab) (📥 67K / month · ⏱️ 26.10.2021):
	```
...
- [GitHub](https://github.com/stencila/stencila) (👨‍💻 32 · 🔀 39 · 📥 3.2K · 📦 17 · 📋 570 - 13% open · ⏱️ 16.06.2022):

	```
	git clone https://github.com/stencila/stencila
	```
- [npm](https://www.npmjs.com/package/stencila) (📥 26 / month · 📦 8 · ⏱️ 06.11.2020):
	```
...
- [GitHub](https://github.com/airbnb/knowledge-repo) (👨‍💻 67 · 🔀 690 · 📋 290 - 42% open · ⏱️ 13.06.2022):
	...
	```
- [PyPi](https://pypi.org/project/knowledge-repo) (📥 470 / month · 📦 1 · ⏱️ 20.04.2022):
	```
...
- [GitHub](https://github.com/jupyterhub/binderhub) (👨‍💻 83 · 🔀 320 · 📦 6 · 📋 720 - 37% open · ⏱️ 13.06.2022):
...
- [GitHub](https://github.com/greenape/mknotebooks) (👨‍💻 13 · 🔀 19 · 📦 190 · 📋 35 - 28% open · ⏱️ 16.06.2022):

	```
	git clone https://github.com/greenape/mknotebooks
	```
- [PyPi](https://pypi.org/project/mknotebooks) (📥 17K / month · 📦 26 · ⏱️ 16.06.2022):
	```
...
- [GitHub](https://github.com/nteract/scrapbook) (👨‍💻 11 · 🔀 24 · 📦 140 · 📋 49 - 48% open · ⏱️ 13.04.2022):
...
- [PyPi](https://pypi.org/project/nteract-scrapbook) (📥 65K / month · 📦 17 · ⏱️ 06.01.2021):
	...
	```
- [Conda](https://anaconda.org/conda-forge/nteract-scrapbook) (📥 8.5K · ⏱️ 27.02.2021):
	```
...
- [GitHub](https://github.com/nteract/commuter) (👨‍💻 27 · 🔀 560 · 📦 3 · 📋 91 - 57% open · ⏱️ 28.04.2022):
	...
	```
- [npm](https://www.npmjs.com/package/@nteract/commuter) (📥 160 / month · ⏱️ 27.10.2020):
	```
...
- [GitHub](https://github.com/executablebooks/thebe) (👨‍💻 26 · 🔀 56 · 📦 5 · 📋 150 - 42% open · ⏱️ 19.11.2021):
	...
	```
- [npm](https://www.npmjs.com/package/thebe) (📥 6.4K / month · ⏱️ 26.10.2021):
	```
	npm install thebe
	```
</details>
...
- [GitHub](https://github.com/danielfrg/mkdocs-jupyter) (👨‍💻 13 · 🔀 16 · 📋 45 - 6% open · ⏱️ 04.05.2022):
...
- [GitHub](https://github.com/ideonate/cdsdashboards) (👨‍💻 13 · 🔀 32 · 📋 88 - 35% open · ⏱️ 29.04.2022):
...
- [PyPi](https://pypi.org/project/cdsdashboards) (📥 560 / month · ⏱️ 29.04.2022):
	...
	```
- [Conda](https://anaconda.org/conda-forge/cdsdashboards) (📥 25K · ⏱️ 29.04.2022):
	```
...
<details><summary><b><a href="https://github.com/danielfrg/jupyter-flex">jupyter-flex</a></b> (🥉16 ·  ⭐ 240) - Build dashboards using Jupyter Notebooks. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>
...
- [GitHub](https://github.com/danielfrg/jupyter-flex) (👨‍💻 4 · 🔀 44 · 📦 1 · 📋 55 - 20% open · ⏱️ 11.04.2022):
	...
	```
- [PyPi](https://pypi.org/project/jupyter-flex) (📥 780 / month · ⏱️ 29.09.2021):
	```
	pip install jupyter-flex
	```
- [Conda](https://anaconda.org/conda-forge/jupyter-flex) (📥 6.1K · ⏱️ 01.10.2021):
	```
...
- [GitHub](https://github.com/jupyter/jupyter_client) (👨‍💻 120 · 🔀 230 · 📥 280 · 📋 330 - 45% open · ⏱️ 14.06.2022):
...
- [PyPi](https://pypi.org/project/jupyter-client) (📥 15M / month · 📦 2.2K · ⏱️ 08.06.2022):
	...
	```
- [Conda](https://anaconda.org/conda-forge/jupyter_client) (📥 8.1M · ⏱️ 08.06.2022):
	```
...
- [GitHub](https://github.com/fastai/nbdev) (👨‍💻 69 · 🔀 340 · 📦 1K · 📋 380 - 18% open · ⏱️ 16.06.2022):

	```
	git clone https://github.com/fastai/nbdev
	```
- [PyPi](https://pypi.org/project/nbdev) (📥 100K / month · 📦 76 · ⏱️ 09.06.2022):
	```
	pip install nbdev
	```
</details>
...
- [GitHub](https://github.com/jupyter/nbformat) (👨‍💻 65 · 🔀 130 · 📋 120 - 40% open · ⏱️ 09.06.2022):
...
- [PyPi](https://pypi.org/project/nbformat) (📥 12M / month · 📦 8.6K · ⏱️ 03.05.2022):
	...
	```
- [Conda](https://anaconda.org/conda-forge/nbformat) (📥 8.7M · ⏱️ 03.05.2022):
	```
	conda install -c conda-forge nbformat
	```
- [npm](https://www.npmjs.com/package/nbformat-schema) (📥 24 / month · ⏱️ 03.05.2022):
	```
	npm install nbformat-schema
	```
</details>
<details><summary><b><a href="https://github.com/jupyter/nbclient">nbclient</a></b> (🥈31 ·  ⭐ 96) - A client library for executing notebooks. Formally nbconverts.. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/jupyter/nbclient) (👨‍💻 33 · 🔀 44 · 📥 70 · 📦 58K · 📋 94 - 35% open · ⏱️ 31.05.2022):
...
- [PyPi](https://pypi.org/project/nbclient) (📥 12M / month · 📦 82 · ⏱️ 31.05.2022):
	...
	```
- [Conda](https://anaconda.org/conda-forge/nbclient) (📥 4.2M · ⏱️ 01.06.2022):
	```
...
- [GitHub](https://github.com/jupyterhub/repo2docker) (👨‍💻 110 · 🔀 300 · 📦 150 · 📋 490 - 34% open · ⏱️ 08.06.2022):
	...
	```
- [PyPi](https://pypi.org/project/jupyter-repo2docker) (📥 2.1K / month · 📦 25 · ⏱️ 06.02.2022):
	```
...
- [GitHub](https://github.com/chmp/ipytest) (👨‍💻 4 · 🔀 20 · 📦 190 · 📋 47 - 4% open · ⏱️ 20.02.2022):
	...
	```
- [PyPi](https://pypi.org/project/ipytest) (📥 33K / month · 📦 12 · ⏱️ 12.02.2022):
	```
	pip install ipytest
	```
</details>
<details><summary><b><a href="https://github.com/jupyter/jupyter-sphinx">Jupyter Sphinx</a></b> (🥉23 ·  ⭐ 150) - Sphinx extension for rendering of Jupyter interactive widgets. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
- [GitHub](https://github.com/nbQA-dev/nbQA) (👨‍💻 24 · 🔀 31 · 📋 250 - 1% open · ⏱️ 10.06.2022):
...
- [PyPi](https://pypi.org/project/nbqa) (📥 28K / month · 📦 2 · ⏱️ 09.03.2022):
	...
	pip install nbqa
	```
- [Conda](https://anaconda.org/conda-forge/nbqa) (📥 28K · ⏱️ 28.05.2022):
	```
...
- [GitHub](https://github.com/jupyter-naas/naas) (👨‍💻 17 · 🔀 18 · 📦 3 · 📋 130 - 16% open · ⏱️ 16.06.2022):

	```
	git clone https://github.com/jupyter-naas/naas
	```
- [PyPi](https://pypi.org/project/naas) (📥 9.9K / month · ⏱️ 16.06.2022):
	```
	pip install naas
	```
</details>
...
- [PyPi](https://pypi.org/project/nteract-testbook) (📥 10 / month · ⏱️ 11.08.2020):
	...
	```
- [Conda](https://anaconda.org/conda-forge/testbook) (📥 22K · ⏱️ 02.06.2021):
	```
...
- [GitHub](https://github.com/ReviewNB/treon) (👨‍💻 4 · 🔀 22 · 📦 53 · 📋 12 - 25% open · ⏱️ 04.04.2022):

	```
	git clone https://github.com/ReviewNB/treon
	```
- [PyPi](https://pypi.org/project/treon) (📥 6.5K / month · 📦 3 · ⏱️ 28.11.2019):
	```
	pip install treon
	```
- [Conda](https://anaconda.org/conda-forge/treon) (📥 460 · ⏱️ 27.06.2021):
	```
...
- <b><a href="https://github.com/mljar/mercury">mercury</a></b> (🥈24 ·  ⭐ 1.6K · 🐣) - Convert Python notebook to web app and share with others. <code>❗Unlicensed</code>
...
- [GitHub](https://github.com/QuantStack/jupyterlab-drawio) (👨‍💻 16 · 🔀 62 · 📦 360 · 📋 65 - 61% open · ⏱️ 29.06.2021):
...
- [PyPi](https://pypi.org/project/jupyterlab-drawio) (📥 1.8K / month · ⏱️ 29.04.2021):
	...
	```
- [Conda](https://anaconda.org/conda-forge/jupyterlab-drawio) (📥 4.4K · ⏱️ 05.05.2021):
	```
...
- [GitHub](https://github.com/jupyterlab/jupyter-renderers) (👨‍💻 27 · 🔀 66 · 📦 1 · 📋 100 - 31% open · ⏱️ 09.04.2022):
...
- [PyPi](https://pypi.org/project/jupyterlab-katex) (📥 140 / month · ⏱️ 17.01.2022):
	...
	```
- [Conda](https://anaconda.org/conda-forge/jupyterlab-vega3) (📥 950 · ⏱️ 18.01.2022):
	```
...
- [GitHub](https://github.com/jupyterlab/jupyterlab-latex) (👨‍💻 21 · 🔀 60 · 📦 2 · 📋 100 - 47% open · ⏱️ 12.04.2022):
	...
	```
- [PyPi](https://pypi.org/project/jupyterlab_latex) (📥 3K / month · 📦 1 · ⏱️ 15.09.2021):
	```
	pip install jupyterlab_latex
	```
- [Conda](https://anaconda.org/conda-forge/jupyterlab-latex) (📥 3.6K · ⏱️ 15.09.2021):
	```
...
- [GitHub](https://github.com/telamonian/theme-darcula) (👨‍💻 7 · 🔀 24 · 📦 330 · 📋 23 - 30% open · ⏱️ 26.08.2021):
...
- [PyPi](https://pypi.org/project/theme-darcula) (📥 950 / month · ⏱️ 26.08.2021):
	...
	```
- [Conda](https://anaconda.org/conda-forge/theme-darcula) (📥 3.8K · ⏱️ 20.09.2021):
	```
	conda install -c conda-forge theme-darcula
	```
- [npm](https://www.npmjs.com/package/@telamonian/theme-darcula) (📥 1.2K / month · ⏱️ 26.08.2021):
	```
...
- [GitHub](https://github.com/dunovank/jupyterlab_darkside_ui) (👨‍💻 5 · 🔀 6 · 📋 5 - 20% open · ⏱️ 18.03.2022):
	...
	```
- [PyPi](https://pypi.org/project/jupyterlab_darkside_ui) (📥 430 / month · ⏱️ 18.03.2022):
	```
...
- [GitHub](https://github.com/AllanChain/jupyterlab-theme-solarized-dark) (👨‍💻 2 · 🔀 8 · 📋 2 - 50% open · ⏱️ 09.04.2022):
	...
	```
- [PyPi](https://pypi.org/project/jupyterlab_theme_solarized_dark) (📥 620 / month · ⏱️ 20.09.2021):
	```
	pip install jupyterlab_theme_solarized_dark
	```
- [npm](https://www.npmjs.com/package/jupyterlab-theme-solarized-dark) (📥 3.3K / month · ⏱️ 20.09.2021):
	```
...
- [GitHub](https://github.com/finos/perspective) (👨‍💻 70 · 🔀 480 · 📦 260 · 📋 530 - 17% open · ⏱️ 14.06.2022):

	```
	git clone https://github.com/finos/perspective
	```
- [PyPi](https://pypi.org/project/perspective-python) (📥 3K / month · 📦 9 · ⏱️ 06.06.2022):
	```
	pip install perspective-python
	```
- [Conda](https://anaconda.org/conda-forge/perspective) (📥 81K · ⏱️ 07.06.2022):
	```
...
- [GitHub](https://github.com/elyra-ai/elyra) (👨‍💻 50 · 🔀 240 · 📦 32 · 📋 1.4K - 14% open · ⏱️ 14.06.2022):

	```
	git clone https://github.com/elyra-ai/elyra
	```
- [PyPi](https://pypi.org/project/elyra) (📥 3.1K / month · 📦 3 · ⏱️ 10.06.2022):
	```
	pip install elyra
	```
- [Conda](https://anaconda.org/conda-forge/elyra) (📥 12K · ⏱️ 13.06.2022):
	```
	conda install -c conda-forge elyra
	```
- [npm](https://www.npmjs.com/package/@elyra/services) (📥 1.7K / month · 📦 4 · ⏱️ 10.06.2022):
	```
...
- [GitHub](https://github.com/jupyterlab/jupyterlab-git) (👨‍💻 73 · 🔀 230 · 📦 14 · 📋 520 - 17% open · ⏱️ 13.06.2022):
...
- [Conda](https://anaconda.org/conda-forge/jupyterlab-git) (📥 170K · ⏱️ 26.04.2022):
	...
	```
- [npm](https://www.npmjs.com/package/@jupyterlab/git) (📥 34K / month · 📦 4 · ⏱️ 26.04.2022):
	```
...
- [GitHub](https://github.com/jupyter-lsp/jupyterlab-lsp) (👨‍💻 39 · 🔀 100 · 📦 170 · 📋 420 - 37% open · ⏱️ 08.05.2022):
...
- [PyPi](https://pypi.org/project/jupyterlab-lsp) (📥 17K / month · 📦 5 · ⏱️ 21.03.2022):
	...
	```
- [Conda](https://anaconda.org/conda-forge/jupyter-lsp) (📥 42K · ⏱️ 12.12.2021):
	```
	conda install -c conda-forge jupyter-lsp
	```
- [npm](https://www.npmjs.com/package/@krassowski/jupyterlab-lsp) (📥 4.3K / month · 📦 2 · ⏱️ 21.03.2022):
	```
...
- [Conda](https://anaconda.org/conda-forge/jupyterlab_code_formatter) (📥 530K · ⏱️ 01.05.2022):
	...
	```
- [npm](https://www.npmjs.com/package/@ryantam626/jupyterlab_code_formatter) (📥 5.5K / month · ⏱️ 01.05.2022):
	```
...
- [GitHub](https://github.com/dask/dask-labextension) (👨‍💻 19 · 🔀 49 · 📋 130 - 28% open · ⏱️ 14.06.2022):
...
- [GitHub](https://github.com/lckr/jupyterlab-variableInspector) (👨‍💻 17 · 🔀 83 · 📦 3 · 📋 160 - 26% open · ⏱️ 19.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/lckr-jupyterlab-variableinspector) (📥 8.6K / month · ⏱️ 10.04.2021):
	```
	pip install lckr-jupyterlab-variableinspector
	```
- [Conda](https://anaconda.org/conda-forge/jupyterlab-variableinspector) (📥 4.9K · ⏱️ 10.04.2021):
	```
	conda install -c conda-forge jupyterlab-variableinspector
	```
- [npm](https://www.npmjs.com/package/@lckr/jupyterlab_variableinspector) (📥 6.5K / month · ⏱️ 10.04.2021):
	```
...
- [GitHub](https://github.com/timkpaine/jupyterlab_iframe) (👨‍💻 5 · 🔀 16 · 📦 3 · 📋 68 - 8% open · ⏱️ 14.06.2022):
	...
	```
- [PyPi](https://pypi.org/project/jupyterlab_iframe) (📥 860 / month · 📦 8 · ⏱️ 29.06.2019):
	```
	pip install jupyterlab_iframe
	```
- [Conda](https://anaconda.org/conda-forge/jupyterlab_iframe) (📥 7.1K · ⏱️ 12.04.2022):
	```
	conda install -c conda-forge jupyterlab_iframe
	```
- [npm](https://www.npmjs.com/package/jupyterlab_iframe) (📥 870 / month · ⏱️ 11.04.2022):
	```
...
- [GitHub](https://github.com/rapidsai/jupyterlab-nvdashboard) (👨‍💻 16 · 🔀 55 · 📋 53 - 43% open · ⏱️ 07.06.2022):
	...
	```
- [PyPi](https://pypi.org/project/jupyterlab-nvdashboard) (📥 2.9K / month · ⏱️ 07.06.2022):
	```
...
- [GitHub](https://github.com/jupyterlab/jupyterlab-github) (👨‍💻 15 · 🔀 87 · 📦 2 · 📋 60 - 40% open · ⏱️ 10.12.2021):
	...
	```
- [PyPi](https://pypi.org/project/jupyterlab-github) (📥 1K / month · 📦 2 · ⏱️ 27.11.2021):
	```
...
<details><summary><b><a href="https://github.com/timkpaine/lantern">Lantern</a></b> (🥈20 ·  ⭐ 310) - Data exploration glue. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/timkpaine/lantern) (👨‍💻 3 · 🔀 20 · 📦 15 · 📋 200 - 5% open · ⏱️ 13.06.2022):
...
- [GitHub](https://github.com/jpmorganchase/jupyterlab_templates) (👨‍💻 14 · 🔀 50 · 📦 4 · 📋 78 - 10% open · ⏱️ 09.04.2022):
	...
	```
- [PyPi](https://pypi.org/project/jupyterlab_templates) (📥 9.1K / month · ⏱️ 30.06.2019):
	```
	pip install jupyterlab_templates
	```
- [Conda](https://anaconda.org/conda-forge/jupyterlab_templates) (📥 5.8K · ⏱️ 28.03.2021):
	```
...
- [GitHub](https://github.com/jtpio/jupyterlab-system-monitor) (👨‍💻 7 · 🔀 29 · 📦 41 · 📋 40 - 50% open · ⏱️ 15.02.2022):

	```
	git clone https://github.com/jtpio/jupyterlab-system-monitor
	```
- [PyPi](https://pypi.org/project/jupyterlab-system-monitor) (📥 9.4K / month · 📦 1 · ⏱️ 04.02.2021):
	```
	pip install jupyterlab-system-monitor
	```
- [Conda](https://anaconda.org/conda-forge/jupyterlab-system-monitor) (📥 9.5K · ⏱️ 25.02.2021):
	```
	conda install -c conda-forge jupyterlab-system-monitor
	```
- [npm](https://www.npmjs.com/package/jupyterlab-system-monitor) (📥 6.2K / month · ⏱️ 23.11.2020):
	```
...
- [GitHub](https://github.com/bokeh/jupyter_bokeh) (👨‍💻 16 · 🔀 39 · 📋 86 - 9% open · ⏱️ 13.06.2022):
...
- [Conda](https://anaconda.org/conda-forge/jupyter_bokeh) (📥 23K · ⏱️ 30.11.2021):
	...
	```
- [npm](https://www.npmjs.com/package/@bokeh/jupyter_bokeh) (📥 10K / month · ⏱️ 30.09.2021):
	```
...
- [PyPi](https://pypi.org/project/jupyterlab_autoversion) (📥 140 / month · ⏱️ 29.06.2019):
	...
	```
- [Conda](https://anaconda.org/conda-forge/jupyterlab_autoversion) (📥 4.2K · ⏱️ 11.04.2022):
	```
	conda install -c conda-forge jupyterlab_autoversion
	```
- [npm](https://www.npmjs.com/package/jupyterlab_autoversion) (📥 57 / month · ⏱️ 11.04.2022):
	```
...
- [GitHub](https://github.com/jupyterlab/jupyterlab-google-drive) (👨‍💻 16 · 🔀 71 · 📦 2 · 📋 100 - 38% open · ⏱️ 28.04.2022):
	...
	```
- [npm](https://www.npmjs.com/package/@jupyterlab/google-drive) (📥 800 / month · ⏱️ 27.05.2020):
	```
...
- [GitHub](https://github.com/deshaw/jupyterlab-execute-time) (👨‍💻 11 · 🔀 30 · 📋 33 - 9% open · ⏱️ 05.03.2022):

	```
	git clone https://github.com/deshaw/jupyterlab-execute-time
	```
- [PyPi](https://pypi.org/project/jupyterlab-execute-time) (📥 8.3K / month · ⏱️ 01.10.2021):
	```
...
- [GitHub](https://github.com/jupyter-widgets/jupyterlab-sidecar) (👨‍💻 13 · 🔀 36 · 📦 3 · 📋 30 - 66% open · ⏱️ 04.07.2021):
	...
	```
- [PyPi](https://pypi.org/project/sidecar) (📥 3.4K / month · 📦 6 · ⏱️ 15.01.2021):
	```
	pip install sidecar
	```
- [Conda](https://anaconda.org/conda-forge/sidecar) (📥 9.3K · ⏱️ 18.03.2021):
	```
...
- [PyPi](https://pypi.org/project/jupyterlab-spellchecker) (📥 1.1K / month · ⏱️ 08.10.2021):
	...
	```
- [Conda](https://anaconda.org/conda-forge/jupyterlab-spellchecker) (📥 33K · ⏱️ 08.10.2021):
	```
...
- [PyPi](https://pypi.org/project/jupyter-fs) (📥 180 / month · ⏱️ 04.06.2021):
	...
	```
- [Conda](https://anaconda.org/conda-forge/jupyter-fs) (📥 3.2K · ⏱️ 04.06.2021):
	```
	conda install -c conda-forge jupyter-fs
	```
</details>
<details><summary><b><a href="https://github.com/jupyterlab/jupyterlab-hdf5">JupyterLab HDF5</a></b> (🥈17 ·  ⭐ 90) - Open and explore HDF5 files in JupyterLab. Can handle very.. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
- [GitHub](https://github.com/jupyterlab/jupyterlab-hdf5) (👨‍💻 6 · 🔀 18 · 📋 43 - 23% open · ⏱️ 21.02.2022):
	...
	```
- [PyPi](https://pypi.org/project/jupyterlab_hdf) (📥 570 / month · 📦 1 · ⏱️ 21.02.2022):
	```
	pip install jupyterlab_hdf
	```
- [npm](https://www.npmjs.com/package/@jupyterlab/hdf5) (📥 600 / month · ⏱️ 21.02.2022):
	```
...
- [GitHub](https://github.com/timkpaine/jupyterlab_commands) (👨‍💻 2 · 🔀 6 · 📦 3 · 📋 23 - 4% open · ⏱️ 07.06.2022):
	...
	```
- [PyPi](https://pypi.org/project/jupyterlab-commands) (📥 130 / month · ⏱️ 11.04.2022):
	```
	pip install jupyterlab-commands
	```
- [Conda](https://anaconda.org/conda-forge/jupyterlab_commands) (📥 5.3K · ⏱️ 11.04.2022):
	```
...
- [GitHub](https://github.com/mlshapiro/jupyterlab-flake8) (👨‍💻 5 · 🔀 10 · 📋 39 - 15% open · ⏱️ 16.09.2021):
	...
	```
- [PyPi](https://pypi.org/project/jupyterlab-flake8) (📥 64K / month · ⏱️ 16.09.2021):
	```
...
- [GitHub](https://github.com/vatlab/jupyterlab-sos) (👨‍💻 4 · 🔀 3 · 📋 58 - 17% open · ⏱️ 15.02.2022):
	...
	```
- [PyPi](https://pypi.org/project/jupyterlab-sos) (📥 88 / month · ⏱️ 15.02.2022):
	```
...
- [Conda](https://anaconda.org/conda-forge/jupyterlab-sos) (📥 15K · ⏱️ 08.04.2022):
	...
	```
- [npm](https://www.npmjs.com/package/jupyterlab-sos) (📥 98 / month · ⏱️ 14.01.2021):
	```
...
- [GitHub](https://github.com/xiaohk/stickyland) (👨‍💻 2 · 🔀 14 · 📥 5 · ⏱️ 30.05.2022):
	...
	```
- [PyPi](https://pypi.org/project/jupyterlab-stickyland) (📥 290 / month · 📦 1 · ⏱️ 30.05.2022):
	```
	pip install jupyterlab-stickyland
	```
- [npm](https://www.npmjs.com/package/jupyterlab-stickyland) (📥 17 / month · ⏱️ 23.11.2021):
	```
...
- [Conda](https://anaconda.org/conda-forge/ipylab) (📥 11K · ⏱️ 13.11.2021):
	...
	```
- [npm](https://www.npmjs.com/package/ipylab) (📥 95 / month · ⏱️ 13.11.2021):
	```
	npm install ipylab
	```
</details>
...
- [GitHub](https://github.com/timkpaine/jupyterlab_email) (👨‍💻 2 · 🔀 9 · 📋 36 - 11% open · ⏱️ 14.06.2022):
	...
	```
- [PyPi](https://pypi.org/project/jupyterlab-email) (📥 88 / month · ⏱️ 15.03.2022):
	```
...
- [GitHub](https://github.com/jupyterlab-contrib/jupyterlab-kernelspy) (👨‍💻 4 · 🔀 9 · 📦 3 · 📋 13 - 15% open · ⏱️ 19.04.2022):
	...
	```
- [PyPi](https://pypi.org/project/jupyterlab-kernelspy) (📥 92 / month · ⏱️ 19.04.2022):
	```
	pip install jupyterlab-kernelspy
	```
- [Conda](https://anaconda.org/conda-forge/jupyterlab-kernelspy) (📥 2.5K · ⏱️ 19.04.2022):
	```
...
- [PyPi](https://pypi.org/project/nbcelltests) (📥 17 / month · ⏱️ 05.10.2020):
	...
	```
- [Conda](https://anaconda.org/conda-forge/nbcelltests) (📥 4.9K · ⏱️ 05.10.2020):
	```
	conda install -c conda-forge nbcelltests
	```
- [npm](https://www.npmjs.com/package/jupyterlab_celltests) (📥 35 / month · ⏱️ 05.10.2020):
	```
...
- [PyPi](https://pypi.org/project/jupyterlab-interactive-dashboard-editor) (📥 40 / month · ⏱️ 01.04.2021):
	...
	```
- [Conda](https://anaconda.org/conda-forge/jupyterlab-interactive-dashboard-editor) (📥 630 · ⏱️ 13.05.2021):
	```
	conda install -c conda-forge jupyterlab-interactive-dashboard-editor
	```
- [npm](https://www.npmjs.com/package/jupyterlab-interactive-dashboard-editor) (📥 59 / month · ⏱️ 27.01.2021):
	```
...
- [GitHub](https://github.com/jtpio/jupyterlab-topbar) (👨‍💻 4 · 🔀 10 · ⏱️ 07.12.2021):
	...
	```
- [npm](https://www.npmjs.com/package/jupyterlab-topbar-extension) (📥 6.9K / month · ⏱️ 30.10.2020):
	```
...
- [PyPi](https://pypi.org/project/jupyterlab-sparkmonitor) (📥 310 / month · ⏱️ 04.08.2021):
	...
	```
- [npm](https://www.npmjs.com/package/jupyterlab_sparkmonitor) (📥 66 / month · ⏱️ 29.07.2020):
	```
...
- [PyPi](https://pypi.org/project/jupyterlab_email) (📥 88 / month · ⏱️ 30.06.2019):
	...
	```
- [npm](https://www.npmjs.com/package/jupyterlab_email) (📥 57 / month · ⏱️ 15.03.2022):
	```
...
- [PyPi](https://pypi.org/project/jupyterlab-quickopen) (📥 360 / month · 📦 1 · ⏱️ 12.12.2021):
	...
	```
- [npm](https://www.npmjs.com/package/@parente/jupyterlab-quickopen) (📥 27 / month · ⏱️ 20.03.2020):
	```
...
- [GitHub](https://github.com/jtpio/jupyterlab-python-file) (👨‍💻 4 · 🔀 10 · 📥 77 · 📋 11 - 27% open · ⏱️ 27.08.2021):
	...
	```
- [PyPi](https://pypi.org/project/jupyterlab-python-file) (📥 350 / month · ⏱️ 23.06.2021):
	```
	pip install jupyterlab-python-file
	```
- [Conda](https://anaconda.org/conda-forge/jupyterlab-python-file) (📥 5K · ⏱️ 24.06.2021):
	```
	conda install -c conda-forge jupyterlab-python-file
	```
- [npm](https://www.npmjs.com/package/jupyterlab-python-file) (📥 780 / month · ⏱️ 23.06.2021):
	```
...
- [GitHub](https://github.com/jupyterhub/oauthenticator) (👨‍💻 110 · 🔀 330 · 📦 270 · 📋 240 - 18% open · ⏱️ 13.06.2022):
...
- [PyPi](https://pypi.org/project/oauthenticator) (📥 36K / month · 📦 43 · ⏱️ 09.06.2022):
	...
	```
- [Conda](https://anaconda.org/conda-forge/oauthenticator) (📥 23K · ⏱️ 09.06.2022):
	```
...
- [GitHub](https://github.com/jupyterhub/ldapauthenticator) (👨‍💻 31 · 🔀 150 · 📦 93 · 📋 140 - 42% open · ⏱️ 27.06.2021):
...
- [GitHub](https://github.com/jupyterhub/ltiauthenticator) (👨‍💻 15 · 🔀 41 · 📦 76 · 📋 38 - 13% open · ⏱️ 09.06.2022):
...
- [GitHub](https://github.com/jupyterhub/nativeauthenticator) (👨‍💻 21 · 🔀 52 · 📦 38 · 📋 92 - 25% open · ⏱️ 17.05.2022):

	```
	git clone https://github.com/jupyterhub/nativeauthenticator
	```
- [PyPi](https://pypi.org/project/jupyterhub-nativeauthenticator) (📥 6.1K / month · ⏱️ 19.10.2021):
	```
...
- [GitHub](https://github.com/jupyterhub/firstuseauthenticator) (👨‍💻 12 · 🔀 21 · 📦 62 · 📋 23 - 26% open · ⏱️ 28.10.2021):
...
- [GitHub](https://github.com/jupyterhub/kubespawner) (👨‍💻 70 · 🔀 260 · 📦 110 · 📋 290 - 18% open · ⏱️ 13.06.2022):

	```
	git clone https://github.com/jupyterhub/kubespawner
	```
- [PyPi](https://pypi.org/project/jupyterhub-kubespawner) (📥 2.4M / month · 📦 14 · ⏱️ 19.05.2022):
	```
	pip install jupyterhub-kubespawner
	```
- [Conda](https://anaconda.org/conda-forge/jupyterhub-kubespawner) (📥 4K · ⏱️ 20.05.2022):
	```
...
- [GitHub](https://github.com/jupyterhub/dockerspawner) (👨‍💻 63 · 🔀 280 · 📦 120 · 📋 250 - 5% open · ⏱️ 06.04.2022):
...
- <b><a href="https://github.com/uktrade/fargatespawner">FargateSpawner</a></b> (🥉12 ·  ⭐ 35 · 💀) - Spawns JupyterHub single user servers in Docker containers.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code>
...
- [GitHub](https://github.com/ipython/ipython) (👨‍💻 890 · 🔀 4.3K · 📥 320K · 📦 280K · 📋 7K - 22% open · ⏱️ 10.06.2022):
...
<details><summary><b><a href="https://github.com/jupyter-server/jupyter_server">jupyter_server</a></b> (🥉32 ·  ⭐ 320) - The backendi.e. core services, APIs, and REST endpointsto.. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/jupyter-server/jupyter_server) (👨‍💻 470 · 🔀 180 · 📥 380 · 📋 290 - 36% open · ⏱️ 16.06.2022):

	```
	git clone https://github.com/jupyter-server/jupyter_server
	```
- [PyPi](https://pypi.org/project/jupyter_server) (📥 3.9M / month · ⏱️ 31.07.2018):
	```
...
- [GitHub](https://github.com/jupyter/jupyter-packaging) (👨‍💻 28 · 🔀 46 · 📥 18 · 📋 40 - 30% open · ⏱️ 14.06.2022):

	```
	git clone https://github.com/jupyter/jupyter-packaging
	```
- [PyPi](https://pypi.org/project/jupyter-packaging) (📥 330K / month · 📦 49 · ⏱️ 31.05.2022):
	```
	pip install jupyter-packaging
	```
- [Conda](https://anaconda.org/conda-forge/jupyter-packaging) (📥 260K · ⏱️ 25.03.2022):
	```
...
- [GitHub](https://github.com/jupyter/jupyter_console) (👨‍💻 58 · 🔀 130 · 📥 40 · 📋 140 - 39% open · ⏱️ 07.03.2022):

	```
	git clone https://github.com/jupyter/jupyter_console
	```
- [PyPi](https://pypi.org/project/jupyter-console) (📥 5.4M / month · 📦 71 · ⏱️ 07.03.2022):
	```
...
- [GitHub](https://github.com/abhishekkrthakur/colabcode) (👨‍💻 8 · 🔀 240 · 📦 74 · 📋 74 - 56% open · ⏱️ 11.06.2021):

	```
	git clone https://github.com/abhishekkrthakur/colabcode
	```
- [PyPi](https://pypi.org/project/colabcode) (📥 18K / month · ⏱️ 11.06.2021):
	```
	pip install colabcode
	```
</details>
<details><summary><b><a href="https://github.com/datapane/datapane">datapane</a></b> (🥉22 ·  ⭐ 550) - Datapane is the easiest way to create data science reports from.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/datapane/datapane) (👨‍💻 11 · 🔀 46 · 📋 77 - 11% open · ⏱️ 15.06.2022):

	```
	git clone https://github.com/datapane/datapane
	```
- [PyPi](https://pypi.org/project/datapane) (📥 13K / month · 📦 4 · ⏱️ 09.04.2022):
	```
